 ...
 *     &lt;enumeration value="Preschooler with a Disability"/>
 *     &lt;enumeration value="Significant Limited Intellectual Capacity"/>
...
public enum DisabilityType {
    ...
    @XmlEnumValue("Preschooler with a Disability")
    PRESCHOOLER_WITH_A_DISABILITY("Preschooler with a Disability"),
    @XmlEnumValue("Significant Limited Intellectual Capacity")
    SIGNIFICANT_LIMITED_INTELLECTUAL_CAPACITY("Significant Limited Intellectual Capacity"),
