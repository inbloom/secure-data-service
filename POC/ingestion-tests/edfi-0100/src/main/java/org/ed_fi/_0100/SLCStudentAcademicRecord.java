...
/**
 * StudentAcademicRecord record with key fields: StudentReference (StudentUniqueStateId) and SessionReference (SessionName, StateOrganizationId). Changed types of StudentReference, SessionReference, ReportCardReference and DiplomaReference to SLC reference types.
 * 
