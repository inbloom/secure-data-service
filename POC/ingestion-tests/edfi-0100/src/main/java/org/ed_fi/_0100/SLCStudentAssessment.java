...
/**
 * StudentAssessment record with key fields: AdministrationDate, StudentReference (StudentUniqueStateId) and AssessmentReference (AssessmentTitle, AcademicSubject, GradeLevelAssessed, Version). Changed types of StudentReference and AssessmentReference to SLC reference types.
 * 
 * <p>Java class for SLC-StudentAssessment complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SLC-StudentAssessment">
 *   &lt;complexContent>
...
@XmlType(name = "SLC-StudentAssessment", propOrder = {
    "administrationDate",
...
public class SLCStudentAssessment
