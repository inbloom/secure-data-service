...
public class MongoAggFormatterTest {
    ...
    /**
     * Test method for
     * {@link MongoAggFormatter#getRecordWriter(org.apache.hadoop.mapreduce.TaskAttemptContext)}
     * .
     * 
     * @throws Exception
     */
    ...
    public void testGetRecordWriter() throws Exception {
        ...
        assertTrue(f.getRecordWriter(new MockTaskAttemptContext()) instanceof org.slc.sli.stamper.mapreduce.io.MongoAggWriter);
    }
}
