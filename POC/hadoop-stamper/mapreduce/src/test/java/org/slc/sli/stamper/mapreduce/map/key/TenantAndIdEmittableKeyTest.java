...
public class TenantAndIdEmittableKeyTest {
    ...
    public void testToBSON() {
        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey key =
            new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey("meta.data.tenantId", "test.id.key.field");
    ...
    public void testHash() {
        ...
        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey key2 =
            new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey("meta.data.tenantId", "test.id.key.field");
    ...
    public void testCompareAndEqual() {
        ...
        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey key2 =
            new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey("meta.data.tenantId", "test.id.key.field2");
        key2.setTenantId(new Text("tenant1"));
        key2.setId(new Text("1234"));

        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey key3 =
            new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey("meta.data.tenantId", "test.id.key.field2");
    ...
    public void testReadWrite() throws IOException {
        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey control =
            new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey("meta.data.tenantId", "test.id.key.field");
        control.setTenantId(new Text("tenant1"));
        control.setId(new Text("abcd"));

        org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey key = new org.slc.sli.stamper.mapreduce.map.key.TenantAndIdEmittableKey();
