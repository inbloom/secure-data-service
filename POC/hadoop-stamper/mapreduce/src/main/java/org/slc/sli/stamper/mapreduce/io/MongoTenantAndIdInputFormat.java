...
/**
 * MongoTenantIdInputFormat
 */
public class MongoTenantAndIdInputFormat extends InputFormat<TenantAndIdEmittableKey, BSONWritable> {

    protected MongoInputFormat privateFormat = new MongoInputFormat();

    @Override
    public MongoTenantAndIdRecordReader createRecordReader(InputSplit split, TaskAttemptContext context) {
