 ...
 *         &lt;element name="StudentProgramAssociation" type="{http://ed-fi.org/0100}StudentProgramAssociation"/>
...
public class InterchangeStudentProgram {
    ...
    @XmlElements({
        @XmlElement(name = "StudentProgramAssociation", type = StudentProgramAssociation.class),
