    ...
    extends ComplexObjectType
{
    ...
    @XmlElement(name = "DateCourseAdopted", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "date")
    protected Calendar dateCourseAdopted;
     ...
     *     
     */
    public Calendar getDateCourseAdopted() {
     ...
     *     
     */
    public void setDateCourseAdopted(Calendar value) {
