...
## Builds a header for the given interchange XML file.

def build_header( interchange_name )
...
## Builds a footer for the given interchange XML file.

def build_footer (interchange_name)
