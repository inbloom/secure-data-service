...
bundle exec rake FORCE_COLOR=true apiJMeterTests jmeter_jmx_path=../../tools/jmeter/ jmeter_bin=/opt/apache-jmeter-2.7/bin/jmeter jmeter_properties=ci.properties jmeter_regression_threshold=0.25 jmeter_jtl_archive=/storage/logs/jmeter/$WORKSPACE/archive jmeter_failed_jtl_archive=/storage/logs/jmeter/$WORKSPACE/failed
