...
bundle exec rake FORCE_COLOR=true admintools_server_url=https://${NODE_NAME}.slidev.org:2001 ldap_hostname=ldapelb.slidev.org ldap_port=443 ldap_use_ssl=true ldap_base=ou=DevTest,dc=slidev,dc=org adminToolsTests TOGGLE_TABLESCANS=1
