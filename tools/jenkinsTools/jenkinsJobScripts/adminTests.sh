...
bundle exec rake FORCE_COLOR=true admintools_server_url=https://${NODE_NAME}.slidev.org:2001 ldap_hostname=ldap.slidev.org ldap_base=ou=SLIAdmin,dc=slidev,dc=org adminToolsTests TOGGLE_TABLESCANS=1
