 ...
 *         &lt;element name="sessionId" type="{}reference" minOccurs="0"/>
 *         &lt;element name="programReference" type="{}reference" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="courseId" type="{}reference"/>
 *         &lt;element name="assessmentReferences" type="{}reference" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="gradeBookEntries" type="{}gradebookEntry" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="studentAssociations" type="{}studentSectionAssociation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="teacherAssociations" type="{}teacherSectionAssociation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Section {
    ...
    protected List<String> assessmentReferences;
    protected List<GradebookEntry> gradeBookEntries;
    protected List<StudentSectionAssociation> studentAssociations;
    ...
    /**
     * Gets the value of the assessmentReferences property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the assessmentReferences property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAssessmentReferences().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getAssessmentReferences() {
        if (assessmentReferences == null) {
            assessmentReferences = new ArrayList<String>();
        }
     ...
     * 
     */
    public List<StudentSectionAssociation> getStudentAssociations() {
        if (studentAssociations == null) {
            studentAssociations = new ArrayList<StudentSectionAssociation>();
        }
