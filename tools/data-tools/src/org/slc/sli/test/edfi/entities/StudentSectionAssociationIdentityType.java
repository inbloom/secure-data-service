...
/**
 * Encapsulates the possible attributes that can be used to lookup the student-section association -
 * a composite of the student reference type and the section reference type.
 * 
 * <p>
 * Java class for StudentSectionAssociationIdentityType complex type.
 * 
 * <p>
...
@XmlType(name = "StudentSectionAssociationIdentityType", propOrder = {
 "studentReference", "sectionReference",
        "beginDate"
})
public class StudentSectionAssociationIdentityType {
     ...
     * 
     * @return
     *         possible object is {@link SectionReferenceType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link SectionReferenceType }
     * 
     */
