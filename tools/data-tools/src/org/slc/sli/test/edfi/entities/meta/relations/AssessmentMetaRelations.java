...
public class AssessmentMetaRelations {
    ...
    public static final double INV_PROBABILITY_STUDENTASSESSMENT_HAS_OBJECTIVEASSESSMENT = 1;
    public static final double INV_PROBABILITY_STUDENTASSESSMENT_HAS_STUDENTASSESSMENTITEM = 1;
