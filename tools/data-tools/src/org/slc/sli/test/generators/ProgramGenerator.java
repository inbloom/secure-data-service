...
public class ProgramGenerator {
    ...
    public enum ServiceDescriptor {
        REMEDIAL("Service 1", "Remedial Service", "Remedial service for students with learning disabilities.",
                "Remedial"), ARTANDMUSIC("Service 2", "Art and Music", "Service for arts and music education.", "Art"), SPORTS(
                "Service 3", "Sports", "Sport programs", "Sports"), EXTRACURRICULAR("Service 4",
                "Extra-Curricular Activites", "Extra-curricular activity service.", "Extra");
    ...
    public static Program generateLowFi(String programId) {
        ...
        program.setProgramType(ProgramType.values()[programTypeIndx]);// edfi schema and sli schema
                                                                      // has two set vale of
                                                                      // programType, donot use
                                                                      // value not in sli schema
        ...
        for (ServiceDescriptor serviceDescriptor : ServiceDescriptor.values()) {
            if (rand.nextDouble() < probForServiceInAProgram) {
                ...
                // JAXBElement<String> serviceDescriptorCode =
                // factory.createServiceDescriptorTypeCodeValue(serviceDescriptor.codeValue);
