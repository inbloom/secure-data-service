...
public class TeacherSectionAssociationGenerator {
    ...
    public static TeacherSectionAssociation generateMediumFi(TeacherMeta teacherMeta, String sectionId) {
        // TODO update this if midfi requirements are higher than what is generated by lowfi currently
        return generateLowFi(teacherMeta, sectionId);
    }
