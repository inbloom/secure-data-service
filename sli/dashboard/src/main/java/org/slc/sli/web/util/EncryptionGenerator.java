...
public class EncryptionGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("If this client_id and secret is for a single environment, copy and paste this to sli.properties.");
        System.out.println("If this client_id and secret is for the overall dashboard app, copy and paste this to canonical_config.yml.");
