...
public final class ContactSorter {
    ...
    public enum AddressType {
        Home(1), Physical(2), Billing(4), Mailing(3), Other(7), Temporary(6), Work(5), UNKOWN(999);
    ...
    public enum TelephoneNumberType {
        Home(1), Work(2), Mobile(3), Emergency_1(4), Emergency_2(5), Fax(6), Other(7), Unlisted(8), UNKNOWN(999);
        private int priority;
    ...
    public enum ElectronicMailAddressType {
        Home_Personal(1), Work(2), Organization(3), Other(4), UNKNOWN(999);
        private int priority;
        ...
        public Telephone(LinkedHashMap<String, Object> map) {
            ...
            if (otelephoneNumberType != null) {
                ...
                if (oprimaryTelephoneNumberIndicator != null)
                    this.primaryTelephoneNumberIndicator = oprimaryTelephoneNumberIndicator.toString().toLowerCase()
                            .equals("true");
