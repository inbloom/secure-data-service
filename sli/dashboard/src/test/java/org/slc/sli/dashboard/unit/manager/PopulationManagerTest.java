...
public class PopulationManagerTest {
    ...
    public void testGetAttendanceForOneStudent() throws Exception {
        ...
        when(mockAPI.getEnrollmentForStudent(null, "0")).thenReturn(gson.fromJson(enrollmentsJson, new ArrayList<Map>().getClass()));
        when(mockEntity.getAttendance(null, "0", null, null)).thenReturn(gson.fromJson(attendanceJson, new ArrayList<Map>().getClass()));
