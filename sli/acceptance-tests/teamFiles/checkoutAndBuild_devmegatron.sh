...
git checkout -- /opt/megatron/sli/sli/acceptance-tests/teamFiles/devmegatron.properties
set -e
git fetch
git checkout $branch
git pull
...
#sed -i.bk3 's#local.slidev.org#devmegatron.slidev.org#g' application_fixture.json
#sed -i.bk 's#\:8[0-9][0-9][0-9]/#/#g' realm_fixture.json
#sed -i.bk2 's#local.slidev.org#devmegatron.slidev.org#g' realm_fixture.json
#sed -i.bk 's#\:8[0-9][0-9][0-9]/#/#g' securityEvent_fixture.json
#sed -i.bk2 's#local.slidev.org#devmegatron.slidev.org#g' securityEvent_fixture.json
...
#sed -i.bk3 's#local.slidev.org#devmegatron.slidev.org#g' config.yml
#cd /opt/megatron/sli/sli/admin-tools/admin-rails/config/
#sed -i.bk 's#:8080/#/#g' config.yml
#sed -i.bk2 's#local.slidev.org#devmegatron.slidev.org#g' config.yml
...
#sed -i.bk9 's#sli.dev.subdomain = ci#sli.dev.subdomain = devmegatron#g' sli.properties
...
#sed -i.bk14 's#local.slidev.org#devmegatron.slidev.org#g' sli.properties
#sed -i.bk15 's#bootstrap.app.sif.url = http://devmegatron.slidev.org:1338/#bootstrap.app.sif.url = http://devmegatron.slidev.org/sif-agent#g' sli.properties
#sed -i.bk16 's#bootstrap.app.sif.apiUrl = http://devmegatron.slidev.org/#bootstrap.app.sif.apiUrl = http://devmegatron.slidev.org/api#g' sli.properties
...
#sed -i.bk5 's#local.slidev.org#devmegatron.slidev.org#g' properties.yml
cd /opt/megatron/sli/sli/config/scripts/
sh resetAllDbs.sh
