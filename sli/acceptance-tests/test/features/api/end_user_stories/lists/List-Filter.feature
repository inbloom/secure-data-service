...
Scenario: As a teacher I want to see all my students in 3rd period Algebra II class and view ISAT Math 2011 assessment scores
	...
	Then I should receive a collection of 3 section links 
	...
	Then I should receive a collection of 1 section links
		And after resolution, I should receive a link named "getStudents" with URI "/student-section-associations/<'ImportantSection' ID>/targets"
	...
	Then I should receive a link named "getStudentAssessmentAssociations" with URI "/student-assessment-associations/<'Suzy Queue' ID>"
		And I should receive a link named "getAssessments" with URI "/student-assessment-associations/<'Suzy Queue' ID>/targets"
	...
	When I navigate to "getAssessments" with URI "/student-assessment-associations/<'Suzy Queue' ID>/targets" and filter by assessmentTitle is "ISAT MATH"
	    Then I should receive a collection of 1 assessment links
	    When I navigate to "getStudentAssessmentAssociations" with URI "/student-assessment-associations/<'ISAT MATH' ID>" to filter
	    ...
	    Then I should find a ScoreResult is 89
		  And I should find a PerformanceLevels is 3
