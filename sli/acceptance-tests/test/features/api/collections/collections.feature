...
# @wip
Scenario: When using a application/vnd.slc.full+json media type, I get student objects instead of student links
...
# @wip
Scenario: When using a application/vnd.slc.full+json media type, I get association objects for the school instead of association links
	Given format "application/vnd.slc.full+json"
...
# @wip
Scenario: When using a application/vnd.slc.full+json media type, I get school objects instead of school links
	Given format "application/vnd.slc.full+json"
...
# @wip	
Scenario: When using a application/vnd.slc.full+json media type, I get association objects for the student instead of association links
	Given format "application/vnd.slc.full+json"
