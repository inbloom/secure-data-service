...
Scenario: Add an EmploymentRecord for a teacher and school
Given the following collections are clean and bootstrapped in datastore:
     | collectionName                        |
     | educationOrganization                 |
     | staff                                 |
...
And the fixture data "sif_teacher_fixture" has been imported into collection "staff"
And the fixture data "sif_bootstrap_custom_entity_fixture" has been imported into collection "custom_entities"
And I want to POST a(n) "sifEvent_EmploymentRecord_add_teacher_school" SIF message
When I POST the message to the ZIS
And I wait for "3" seconds
Then I should see following map of entry counts in the corresponding collections:
     | collectionName                        | count |
   ...
   And I check that the record contains all of the expected values:
     | collectionName           | searchParameter | searchValue                                 | searchType | expectedValuesFile                           |
     | teacherSchoolAssociation | body.teacherId  | 2012vm-e2efce80-eb85-11e1-b59f-406c8f06bd30 | string     | expected_EmploymentRecord_add_teacher_school |

Scenario: Update an EmploymentRecord for a teacher and school
Given I want to POST a(n) "sifEvent_EmploymentRecord_change_teacher_school" SIF message
When I POST the message to the ZIS
And I wait for "3" seconds
Then I should see following map of entry counts in the corresponding collections:
     | collectionName                        | count |
   ...
   And I check that the record contains all of the expected values:
     | collectionName           | searchParameter | searchValue                                 | searchType | expectedValuesFile                              |
     | teacherSchoolAssociation | body.teacherId  | 2012vm-e2efce80-eb85-11e1-b59f-406c8f06bd30 | string     | expected_EmploymentRecord_change_teacher_school |
...
And the fixture data "sif_teacher_fixture" has been imported into collection "staff"
And the fixture data "sif_bootstrap_custom_entity_fixture" has been imported into collection "custom_entities"
And I want to POST a(n) "sifEvent_EmploymentRecord_add_staff_educationOrganization_missing_field" SIF message
When I POST the message to the ZIS
And I wait for "3" seconds
Then I should see following map of entry counts in the corresponding collections:
     | collectionName                        | count |
