...
Scenario: Test access to the api
 ...
 | securityEvent  | 1                   | body.targetEdOrgList | IL-HIGHWIND | string |
  ...
  And "2" security event with field "body.actionUri" matching "http.*/api/rest/v1.3/bulk/extract/99d527622dcb51c465c515c0636d17e085302d5e_id/delta/.*" should be in the sli db
