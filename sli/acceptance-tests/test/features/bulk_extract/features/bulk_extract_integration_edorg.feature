  ...
  Scenario: Trigger a bulk extract on ingested data and retrieve the lea extract through the api
    Given I trigger a bulk extract
      ...
      When I make lea bulk extract API call for edorg "a13489364c2eb015c219172d561c62350f0453f3_id"
      ...
      #|  studentSchoolAssociation              | 166 | 849a010012a384e4ba33c6bb5014a4707e7072c9_id |
