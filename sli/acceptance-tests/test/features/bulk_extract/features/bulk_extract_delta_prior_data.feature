...
#  897755cae2f689c2d565a35a48ea69d5dd3928d6_id - Sunset Central High (SCH)
  ...
  Scenario: The extract for an edorg should contain data for a student or staff from a previously enrolled school
    ...
    And I check that the "student" extract for "Sunset Central High" has "2" records
    And I verify this "student" file should contain:
      | id                                          | condition            |
      | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id | entityType = student |
    And I check that the "studentAcademicRecord" extract for "Sunset Central High" has "4" records
    ...
    And I check that the "studentAssessment" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "studentParentAssociation" extract for "Sunset Central High" has "2" records
    ...
    And I check that the "studentProgramAssociation" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "studentCohortAssociation" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "studentDisciplineIncidentAssociation" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "studentGradebookEntry" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "studentSchoolAssociation" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "studentSectionAssociation" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "attendance" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "grade" extract for "Sunset Central High" has "7" records
    ...
    And I check that the "reportCard" extract for "Sunset Central High" has "5" records
    ...
    And I check that the "courseTranscript" extract for "Sunset Central High" has "8" records
    ...
    And I check that the "gradebookEntry" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "disciplineIncident" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "disciplineAction" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "parent" extract for "Sunset Central High" has "3" records
    And I verify this "parent" file should contain:
      | id                                          | condition           |
      | 2d6638adf22232b9af30b03ce9e84e707f4cf501_id | entityType = parent |
    And I check that the "studentCompetency" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "staffProgramAssociation" extract for "Sunset Central High" has "5" records
    ...
    And I check that the "staffCohortAssociation" extract for "Sunset Central High" has "6" records
    ...
    And I check that the "staffEducationOrganizationAssociation" extract for "Sunset Central High" has "6" records
  ...
  Scenario: The extract for an edorg should not contain data for a former student or staff that's dated after the person has left
    ...
    Then the extract contains a file for each of the following entities:
      ...
      | teacherSectionAssociation             |
      | teacherSchoolAssociation              |
    And I check that the "student" extract for "Daybreak Central High" has "2" records
    And I verify this "student" file should contain:
      | id                                          | condition            |
      | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id | entityType = student |
    And I check that the "studentAcademicRecord" extract for "Daybreak Central High" has "2" records
    ...
    And I check that the "studentAssessment" extract for "Daybreak Central High" has "4" records
    And I verify this "studentAssessment" file should not contain:
      | id                                          |
      | b2542b105c09130bc7d3f81b471d1f0f0e481fd8_id |
    And I check that the "studentParentAssociation" extract for "Daybreak Central High" has "2" records
    And I verify this "studentParentAssociation" file should contain:
      | id                                                                                     | condition                             |
      | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id3382e80b35990e1ea89cdde30339fb0c4b79793d_id | entityType = studentParentAssociation |
    And I check that the "studentProgramAssociation" extract for "Daybreak Central High" has "5" records
    ...
    And I check that the "studentCohortAssociation" extract for "Daybreak Central High" has "5" records
    ...
    And I check that the "studentDisciplineIncidentAssociation" extract for "Daybreak Central High" has "5" records
    ...
    And I check that the "studentGradebookEntry" extract for "Daybreak Central High" has "4" records
    And I verify this "studentGradebookEntry" file should not contain:
      | id                                          |
      | 28e83915fb2ed72fd074efdcb24f6b1a778a5f57_id |
    And I check that the "studentSchoolAssociation" extract for "Daybreak Central High" has "5" records
    And I verify this "studentSchoolAssociation" file should not contain:
      | id                                          |
      | c5a10351b0957620192a7b1c0e3e6fd686173579_id |
    And I check that the "studentSectionAssociation" extract for "Daybreak Central High" has "4" records
    ...
    And I check that the "attendance" extract for "Daybreak Central High" has "4" records
    And I verify this "attendance" file should not contain:
      | id                                          |
      | 49e65583c8c5f3e97db81807d5beeb028433053d_id |
    And I check that the "grade" extract for "Daybreak Central High" has "4" records
    ...
    And I check that the "reportCard" extract for "Daybreak Central High" has "2" records
    ...
    And I check that the "courseTranscript" extract for "Daybreak Central High" has "5" records
    And I verify this "courseTranscript" file should not contain:
      | id                                          |
      | 0bc385d7a20aa1a9df92627cd841d545d3052b3b_id |
    And I check that the "gradebookEntry" extract for "Daybreak Central High" has "4" records
    ...
    And I check that the "disciplineIncident" extract for "Daybreak Central High" has "4" records
    ...
    And I verify this "parent" file should contain:
      | id                                          | condition           |
      | 2d6638adf22232b9af30b03ce9e84e707f4cf501_id | entityType = parent |
    And I check that the "disciplineAction" extract for "Daybreak Central High" has "4" records
    And I verify this "disciplineAction" file should not contain:
      | id                                          |
      | e3d4fe2fdb6af50c87446e9050b74e0d7903f5cb_id |
    And I check that the "studentCompetency" extract for "Daybreak Central High" has "4" records
    ...
    And I verify this "teacher" file should contain:
      | id                                          | condition            |
      | 589a7e8634d7d284a2ec9fd76d7e1ee64a0f63b5_id | entityType = teacher |
    And I check that the "staffProgramAssociation" extract for "Sunset Central High" has "3" records
    ...
    And I check that the "staffEducationOrganizationAssociation" extract for "Daybreak Central High" has "4" records
...
#  b78524194f38795a5c2e422cb7fc8becece062d0_id - West Side High (WSH)
  ...
  Scenario: Each Delta extract file contains a delete file with the whole tenants past deleted data
    ...
    Then the extract contains a file for each of the following entities:
      | entityType                            |
      | deleted                               |
    And I check that the "deleted" extract for "Sunset Central High" has "12" records
  ...
  Scenario: Each Delta extract file contains a delete file with the whole tenants past deleted data
    ...
    Then the extract contains a file for each of the following entities:
      | entityType                            |
      | deleted                               |
    And I check that the "deleted" extract for "Daybreak Central High" has "12" records
    And I verify this "deleted" file should contain:
      | id                                          | condition            |
      | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id3382e80b35990e1ea89cdde30339fb0c4b79793d_id | entityType = studentParentAssociation |
      | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id92709ce1b529f9825bd4ab623f292c12c083df8e_id | entityType = studentDisciplineIncidentAssociation |
