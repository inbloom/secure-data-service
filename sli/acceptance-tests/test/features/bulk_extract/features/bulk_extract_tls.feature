...
Scenario: Validate only associated Cert for a given app is allowed
  ...
  When I make a call to the bulk extract end point "/bulk/extract/SEA_IL_ID" using the certificate for app "pavedz00ua"
  Then I get back a response code of "403"
  When I make a call to the bulk extract end point "/bulk/extract/SEA_IL_ID" using the certificate for app "vavedra9ub"
