...
Scenario Outline: Verify educationOrganization, school, staff, and teacher entities were correctly extracted
   When I retrieve the path to and decrypt the extract file for the tenant "<tenant>" and application with id "<appId>"
   ...
   Then a "<entity>" was extracted in the same format as the api
	...
	| educationOrganization                 | jstevenson | IT Administrator | IL-Daybreak | Midgar | 19cca28d-7357-4044-8df9-caad4b1c8ee4 |
	| school                                | jstevenson | IT Administrator | IL-Daybreak | Midgar | 19cca28d-7357-4044-8df9-caad4b1c8ee4 |
	| staff                                 | jstevenson | IT Administrator | IL-Daybreak | Midgar | 19cca28d-7357-4044-8df9-caad4b1c8ee4 |
	| teacher                               | jstevenson | IT Administrator | IL-Daybreak | Midgar | 19cca28d-7357-4044-8df9-caad4b1c8ee4 |