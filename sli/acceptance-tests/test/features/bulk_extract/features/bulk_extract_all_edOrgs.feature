...
Feature: After Small Sample DS is ingested and BE is run, I want to ensure that extracts are created for all edOrgs(Not only LEA/SEA).
  ...
  Scenario: Validate that BEs are created for all edOrgs
    ...
    When I check that the teacherSchoolAssociation extract for "772a61c687ee7ecd8e6d9ad3369f7883409f803b_id" has the correct number of records
    ...
    When I check that the teacherSchoolAssociation extract for "a13489364c2eb015c219172d561c62350f0453f3_id" has the correct number of records
    When I check that the studentGradebookEntry extract for "a13489364c2eb015c219172d561c62350f0453f3_id" has the correct number of records
    #When I check that the studentSchoolAssociation extract for "a13489364c2eb015c219172d561c62350f0453f3_id" has the correct number of records
    ...
    When I check that the teacherSchoolAssociation extract for "352e8570bd1116d11a72755b987902440045d346_id" has the correct number of records
    When I check that the studentGradebookEntry extract for "352e8570bd1116d11a72755b987902440045d346_id" has the correct number of records
    When I check that the staffProgramAssociation extract for "352e8570bd1116d11a72755b987902440045d346_id" has the correct number of records
