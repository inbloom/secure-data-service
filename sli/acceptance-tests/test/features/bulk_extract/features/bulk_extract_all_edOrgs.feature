...
Feature: After Small Sample DS is ingested and BE is run, I want to ensure that extracts are created for all edOrgs(Not only LEA/SEA).
  ...
  Scenario: Validate that BEs are created for all edOrgs
    ...
    And I fetch the path to and decrypt the edorg data extract file for the tenant "Midgar" and application with id "19cca28d-7357-4044-8df9-caad4b1c8ee4" and edorg with id "772a61c687ee7ecd8e6d9ad3369f7883409f803b_id"
    ...
    And I fetch the path to and decrypt the edorg data extract file for the tenant "Midgar" and application with id "19cca28d-7357-4044-8df9-caad4b1c8ee4" and edorg with id "a13489364c2eb015c219172d561c62350f0453f3_id"
    And I verify that an extract tar file was created for the tenant "Midgar"
    ...
    And I check that the studentAssessment extract for "a13489364c2eb015c219172d561c62350f0453f3_id" has the correct number of records
    ...
    And I fetch the path to and decrypt the edorg data extract file for the tenant "Midgar" and application with id "19cca28d-7357-4044-8df9-caad4b1c8ee4" and edorg with id "352e8570bd1116d11a72755b987902440045d346_id"
    And I verify that an extract tar file was created for the tenant "Midgar"
