...
Scenario Outline: Deny access to users not using SLI Adminstrator credentials
	...
	When I try to access the URI "/provision" with operation <Operation> and <StateOrganizationId>
	Then I should be denied access
	Examples:
	| Username        | Password            | Operation | StateOrganizationId 
	| "leader"        | "leader1234"        | "POST"    | "Test"              
...
Scenario Outline: Deny access to users using non-allowed methods
	...
	Examples:
	| Username        | Password            | Operation | StateOrganizationId 
	| "leader"        | "leader1234"        | "PUT"     | "Test"              
	| "administrator" | "administrator1234" | "DELETE"  | "Test"              
	| "administrator" | "administrator1234" | "GET"     | "Test"              
...
Scenario Outline: Deny access to users using SLI Administrator credentials from non-SLI realms
	...
	Examples:
	| Username        | Password            | Operation | StateOrganizationId 
	| "badadmin"      | "badadmin1234"      | "POST"    | "Test"              
...
Scenario Outline: Provision a new landing zone
	...
	Examples:
	| Username         | Password             | Operation | StateOrganizationId
	| "fakerealmadmin" | "fakerealmadmin1234" | "POST"    | "Test"             
...
Scenario Outline: Provision a new landing zone twice should fail
	...
	Examples:
	| Username         | Password             | Operation | StateOrganizationId
	| "fakerealmadmin" | "fakerealmadmin1234" | "POST"    | "Test1"            
