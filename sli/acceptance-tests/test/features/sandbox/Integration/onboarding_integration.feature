...
And the developer first name "Loraine" and last name "Plyler"  submits an account registration request
...
And an approval email is sent to the "devldapuser@slidev.org"
...
Then the user has to authenticate against ldap using "devldapuser@slidev.org" and <PSWD>
...
And a <ED-ORG_SAMPLE_DS1> is added in the application table for <DASHBOARD_APP>, <ADMIN_APP>, <DATABROWSER_APP>
...
Then SLC operator authenticates against <SLI_realm> with <SLC_OPERATOR_USER> and <SLC_OPERATOR_PASS>
