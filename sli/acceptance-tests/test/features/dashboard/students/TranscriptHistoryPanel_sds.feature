Feature: Student Transcript History Panel
  ...
  Scenario: View student's transcript history - Matt Sollars
    ...
    And I should see the row "2008-2009;Fall Semester; ;Fifth grade; ;"
    And I should see the row "2010-2011;Fall Semester;East Daybreak Junior High;Seventh grade; ;"
    And I should see the row "2010-2011;Spring Semester;East Daybreak Junior High;Seventh grade; ;"
    And I should see the row "2009-2010;Fall Semester;East Daybreak Junior High;Sixth grade; ;"
    And I should see the row "2007-2008;Fall Semester; ;Fourth grade; ;"
    And I should see the row "2007-2008;Spring Semester; ;Fourth grade; ;"
    And I should see the row "2009-2010;Spring Semester;East Daybreak Junior High;Sixth grade; ;"
    And I should see the row "2008-2009;Spring Semester; ;Fifth grade; ;"
    And I should find 0 expanded rows

    When I click the expand button of the row "2008-2009;Fall Semester; ;Fifth grade; ;"
    ...
    When I click the expand button of the row "2010-2011;Fall Semester;East Daybreak Junior High;Seventh grade; ;"
    ...
    When I click the expand button of the row "2010-2011;Spring Semester;East Daybreak Junior High;Seventh grade; ;"
    And I should see the sub table headers "Subject;Course;Grade;"
    Then I should find 6 sub rows
    ...
    When I click the expand button of the row "2009-2010;Fall Semester;East Daybreak Junior High;Sixth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2007-2008;Fall Semester; ;Fourth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2007-2008;Spring Semester; ;Fourth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2009-2010;Spring Semester;East Daybreak Junior High;Sixth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2008-2009;Spring Semester; ;Fifth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
  ...
  Scenario: View student's transcript history - Carmen Ortiz
    ...
    And I should see the table headers "Year;Term;School;Grade Level;Cumulative GPA;"
    And I should see the row "2008-2009;Spring Semester; ;Eighth grade; ;"
    And I should see the row "2009-2010;Fall Semester;Daybreak Central High;Ninth grade; ;"
    And I should see the row "2010-2011;Fall Semester;Daybreak Central High;Tenth grade; ;"
    And I should see the row "2008-2009;Fall Semester; ;Eighth grade; ;"
    And I should see the row "2010-2011;Spring Semester;Daybreak Central High;Tenth grade; ;"
    And I should see the row "2009-2010;Spring Semester;Daybreak Central High;Ninth grade; ;"
    And I should find 0 expanded rows

    When I click the expand button of the row "2008-2009;Spring Semester; ;Eighth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2009-2010;Fall Semester;Daybreak Central High;Ninth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    Then I should find 6 sub rows
    ...
    When I click the expand button of the row "2010-2011;Fall Semester;Daybreak Central High;Tenth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2008-2009;Fall Semester; ;Eighth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2010-2011;Spring Semester;Daybreak Central High;Tenth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
    ...
    When I click the expand button of the row "2009-2010;Spring Semester;Daybreak Central High;Ninth grade; ;"
    Then I should see the sub table headers "Subject;Course;Grade;"
    And I should find 6 sub rows
