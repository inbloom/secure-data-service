...
And the following students have "FRE" lozenges: "Alton Ausiello;Alton Maultsby;Matt Joseph Sollars;Lashawn Aldama;Mayme A Borc;Lashawn Aldama" 
...
And the "current" grade for "Matt Joseph Sollars" is "B+"
And the "last semester" grade for "Matt Joseph Sollars" is "B+"
And the "2 semesters ago" grade for "Matt Joseph Sollars" is "A-"
