...
Scenario: Monster test until LOS is faster
    ...
    Then the table includes header "Attendance"
      ...
      And the count for id "attendances.attendanceRate" for student "Lashawn Aldama" is "97"
      And the class for id "attendances.attendanceRate" for student "Lashawn Aldama" is "color-widget-green"
      And the count for id "attendances.attendanceRate" for student "Karrie Rudesill" is "97"
      And the class for id "attendances.attendanceRate" for student "Karrie Rudesill" is "color-widget-green"
      ...
      And the class for id "attendances.absenceCount" for student "Felipe Cianciolo" is "color-widget-red"
       And the count for id "attendances.absenceCount" for student "Merry Mccanse" is "10"
      And the class for id "attendances.absenceCount" for student "Merry Mccanse" is "color-widget-yellow"     
