...
Scenario: Monster test until LOS is faster
    ...
    Then the table includes header "Attendance"
      And I should see a table heading "Tardy Count"
      And the count for id "attendances.tardyCount" for student "Johnathan Zenz" is "0"
      And the class for id "attendances.tardyCount" for student "Johnathan Zenz" is "color-widget-darkgreen"
      And I should see a table heading "Tardy Rate %"
      And the count for id "attendances.tardyRate" for student "Johnathan Zenz" is "0"
      And the class for id "attendances.tardyRate" for student "Johnathan Zenz" is "color-widget-darkgreen"
      And I should see a table heading "Attendance Rate %"
      And the count for id "attendances.attendanceRate" for student "Pilar Moench" is "99"
      And the class for id "attendances.attendanceRate" for student "Pilar Moench" is "color-widget-darkgreen"
      And the count for id "attendances.attendanceRate" for student "Lucretia Nagai" is "97"
      And the class for id "attendances.attendanceRate" for student "Lucretia Nagai" is "color-widget-green"
      And the count for id "attendances.attendanceRate" for student "Randolph Vanhooser" is "97"
      And the class for id "attendances.attendanceRate" for student "Randolph Vanhooser" is "color-widget-green"
      ...
      And I should see a table heading "Absence Count"
      And the count for id "attendances.absenceCount" for student "Samatha Twining" is "1"
