...
Then I should see following map of entry counts in the corresponding collections:
  ...
  And I should see "Processed 15252 records." in the resulting batch job file for "IL-Daybreak"
  And I should not see an error log file created for "IL-Daybreak"
  ...
  And I should see "InterchangeStudentEnrollment.xml records considered: 491" in the resulting batch job file for "IL-Daybreak"
  And I should see "InterchangeStudentEnrollment.xml records ingested successfully: 491" in the resulting batch job file for "IL-Daybreak"
  ...
  And I should see "InterchangeAssessmentMetadata-Learning.xml records considered: 0" in the resulting batch job file for "IL-Daybreak"
  And I should see "InterchangeAssessmentMetadata-Learning.xml records ingested successfully: 0" in the resulting batch job file for "IL-Daybreak"
