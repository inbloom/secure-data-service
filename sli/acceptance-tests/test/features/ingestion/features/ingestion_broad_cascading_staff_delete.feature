...
Scenario: Delete Staff with cascade
 ...
 @wip    
Scenario: Delete Staff with cascade = false
    Given I am using preconfigured Ingestion Landing Zone for "Midgar-Daybreak"
    And the "Midgar" tenant db is empty
    When the data from "test/features/ingestion/test_data/delete_fixture_data/" is imported
    Then there exist "1" "staff" records like below in "Midgar" tenant. And I save this query as "StaffQ"
    ...
    And I re-execute saved query "DisciplineIncidentQ" to get "21" records
    And I re-execute saved query "StaffCohortAssociationQ" to get "13" records
    And I re-execute saved query "StaffProgramAssociationQ" to get "1" records
    And I re-execute saved query "StaffEducationOrganizationAssociationQ" to get "1" records
  #staff
  #disciplineAction                       maxOccurs="unbounded" minOccurs="0"
  #disciplineIncident                     minOccurs="0"
  #staffCohortAssociation                 maxOccurs="unbounded"
