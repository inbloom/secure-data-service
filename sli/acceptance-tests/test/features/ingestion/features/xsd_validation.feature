...
Scenario: Student Ed-Fi XSD Validation
    ...
    And I should see "InterchangeStudent.xml, Line 56, Column 28:" in the resulting batch job file
    ...
    And I should see "InterchangeStudent.xml, Line 87, Column 60:" in the resulting batch job file
