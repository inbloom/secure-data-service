...
#Scenario: Post a zip file containing XML file of 2 schools as a payload of the ingestion job
Given I post "validSchoolsXML2.zip" as the payload of the ingestion job
