...
Scenario: Post a zip file containing XML file of 100 courses as a payload of the ingestion job
Given I post "validCoursesXML100.zip" as the payload of the ingestion job
    And the payload contains entities of type "course"
...
Given I post "validCoursesCSV100.zip" as the payload of the ingestion job
    And the payload contains entities of type "course"
    And there are none of this type of entity in the DS
When zip file is scp to ingestion landing zone
    And "3" seconds have elapsed
