...
Scenario: Delete Assessment with cascade
    ...
    Then there exist "1" "staffProgramAssociation" records like below in "Midgar" tenant. And I save this query as "staffProgramAssociation"
    	...
    	|_id                                                             |b968978b829eb02e385bcd7fc586597de8bf1701_id         |
    And I save the collection counts in "Midgar" tenant
    And I post "ForceStaffProgramAssociationDelete" file as the payload of the ingestion job
    When zip file is scp to ingestion landing zone
    And a batch job for file "ForceStaffProgramAssociationDelete" is completed in database
    And I should see "Processed 1 records." in the resulting batch job file
    And I should see "records deleted successfully: 1" in the resulting batch job file
    And I should see "records failed processing: 0" in the resulting batch job file
   	And I should not see a warning log file created
