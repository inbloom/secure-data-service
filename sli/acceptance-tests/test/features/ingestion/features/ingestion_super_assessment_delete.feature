...
Scenario: Ingest Assessment and Sub Docs, delete Assessment, An empty body of Assessment and all Sub Docs should still be there
	...
	And I post "SuperAssessment_all.zip" file as the payload of the ingestion job
  	When zip file is scp to ingestion landing zone
    And a batch job for file "SuperAssessment_all.zip" is completed in database		
	...
	#Delete Super Doc   
    And I post "SuperAssessment_parent.zip" file as the payload of the ingestion job
  	When zip file is scp to ingestion landing zone
    And a batch job for file "SuperAssessment_parent.zip" is completed in database
