...
#        | studentSectionGradebookEntry| 60    |
    ...
    And I should see "Processed 818 records." in the resulting batch job file
    ...
    And I should see "InterchangeStudentEnrollment.xml records considered: 285" in the resulting batch job file
    And I should see "InterchangeStudentEnrollment.xml records ingested successfully: 285" in the resulting batch job file
