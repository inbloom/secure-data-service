...
#       | studentSchoolAssociation    | 156   | bug: this entity is currently identified with just studentId+schoolId so it is overwritten for records having different grade
    ...
    And I should see "Processed 14844 records." in the resulting batch job file
    ...
    And I should see "InterchangeAttendance.xml records considered: 13832" in the resulting batch job file
    And I should see "InterchangeAttendance.xml records ingested successfully: 13832" in the resulting batch job file
...
# vmcglaughlin - commented out as duplicate
#Scenario: Post a zip file containing all configured interchanges as a payload of the ingestion job: Clean Database
#Given I post "AcceptanceCanonicalData.zip" file as the payload of the ingestion job
#    And the following collections are empty in datastore:
#        | collectionName              |
