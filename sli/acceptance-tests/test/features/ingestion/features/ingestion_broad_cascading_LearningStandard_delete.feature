...
Scenario: Delete Assessment with cascade
    ...
    And I should not see any entity mandatorily referring to "b0e0b7466429d5d994f18da6982c3af25d1496c3_id" in the "Midgar" database
	And I should see entities optionally referring to "b0e0b7466429d5d994f18da6982c3af25d1496c3_id" be updated in the "Midgar" database
