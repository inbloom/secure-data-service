...
Then I should see following map of entry counts in the corresponding collections:
  ...
  #   | disciplineAction                      | 0                   | body.disciplineIncidentId        | f96dbcb9c71d4b738c3f5d5200f199c45b00bf8c_id  | string       |         
    ...
    And I should not see an error log file created
	And I should not see a warning log file created
	#And I should not see "0d430e252dd56a6a3e9c855d336601d4eaa09842_id" in the "Midgar" database
	#And I should not see "0a7994b6ca3cb7bf46c9015373a9d29d003999db_id" in the "Midgar" database
