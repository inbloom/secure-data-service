Feature: Student-Section Association Ingestion Test
...
Scenario: Post a zip file containing XML file of 100 sections as a payload of the ingestion job
Given I post "validStudentSectionAssocXML100.zip" as the payload of the ingestion job
...
Given I post "validStudentSectionAssocCSV100.zip" as the payload of the ingestion job
    And the payload contains entities of type "section"
    And there are none of this type of entity in the DS
When zip file is scp to ingestion landing zone
    And "3" seconds have elapsed
