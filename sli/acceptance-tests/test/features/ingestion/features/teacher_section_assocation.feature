...
Scenario: Post a zip file containing a XML of 2 sections as a payload of the ingestion job
Given I post "validTeacherSectionAssocXML2.zip" as the payload of the ingestion job
