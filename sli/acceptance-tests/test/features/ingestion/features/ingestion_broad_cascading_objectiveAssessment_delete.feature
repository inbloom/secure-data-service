...
Scenario: Delete Program with cascade
    ...
    And I post "BroadObjectiveAssessmentDelete.zip" file as the payload of the ingestion job
  	When zip file is scp to ingestion landing zone
    And a batch job for file "BroadObjectiveAssessmentDelete.zip" is completed in database
    And a batch job log has been created
