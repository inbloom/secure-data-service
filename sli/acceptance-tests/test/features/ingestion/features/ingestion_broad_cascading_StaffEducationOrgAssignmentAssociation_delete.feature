...
@wip
Scenario: Delete staffEducationOrganizationAssociation with cascade
...
@wip    
 Scenario: Delete Orphan staffEducationOrganizationAssociation Reference with cascade = false
    Given I am using preconfigured Ingestion Landing Zone for "Midgar-Daybreak"
    And the "Midgar" tenant db is empty
    When the data from "test/features/ingestion/test_data/delete_fixture_data/" is imported
    And there exist "1" "staffEducationOrganizationAssociation" records like below in "Midgar" tenant. And I save this query as "staffEducationOrganizationAssociation"
