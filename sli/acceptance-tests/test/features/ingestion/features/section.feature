...
Scenario: Post a zip file containing XML file of 4 sections as a payload of the ingestion job
Given I post "validSectionsXML4.zip" as the payload of the ingestion job
...
Then I should see "4" entries in the corresponding collection
