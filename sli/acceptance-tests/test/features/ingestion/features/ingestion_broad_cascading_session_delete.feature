...
Scenario: Delete Session with cascade
    ...
    And I re-execute saved query "sections" to get "0" records
    And I re-execute saved query "courseOfferings" to get "0" records
    And I re-execute saved query "studentAcademicRecords" to get "0" records
    And I re-execute saved query "courseTranscript1" to get "0" records
    And I re-execute saved query "courseTranscript2" to get "0" records
    And I re-execute saved query "courseTranscript3" to get "0" records
    And I re-execute saved query "courseTranscript4" to get "0" records
    And I re-execute saved query "courseTranscript5" to get "0" records
    And I re-execute saved query "courseTranscript6" to get "0" records
