...
Scenario: Verify deterministic ids generated: Clean Database
  And I check that ids were generated properly:
    ...
    | reportCard                           | a881aaf9e039377444538e76273c1ee27ed38713_id8c3ad0e37652bd73755b21b5290ef75876d25890_id | body.studentId | 067198fd6da91e1aa8d67e28e850f224d6851713_id                       |
    | reportCard                           | a881aaf9e039377444538e76273c1ee27ed38713_id8c3ad0e37652bd73755b21b5290ef75876d25890_id | body.gradingPeriodId | 5b68a0b672e485892f496987c05e9c32d95f7067_id                       |
# disciplineAction
...
# studentAcademicRecord
    | studentAcademicRecord                | 9f872bf23bc7efa1611bf76fd6e775b2e84605f1_id2c10dec5f74762e0fcdd0ba8d547d9b9f4f34b57_id | body.studentId                       | 2474c3b2906eab72c1ee4b06a5c4ebf02d02aace_id |
    | studentAcademicRecord                | 9f872bf23bc7efa1611bf76fd6e775b2e84605f1_id2c10dec5f74762e0fcdd0ba8d547d9b9f4f34b57_id | body.sessionId                       | a2f899c4b31e2dc11a5a5ab202d4590bb0a33c8b_id |
# staffEducationOrganizationAssociation
...
# courseOffering
   ...
   | courseTranscript                     | 4524ed501c1d45a47f3f8b3dfe346b848c5216f3_id | body.courseAttemptResult          | Pass                                 |
...
And I check that multiple educationOrganization ids were generated properly:
     | collectionName                      | deterministicId                             | field                                                  | value                                       |
     | courseTranscript                    | 4524ed501c1d45a47f3f8b3dfe346b848c5216f3_id | body.educationOrganizationReference                    | 772a61c687ee7ecd8e6d9ad3369f7883409f803b_id,352e8570bd1116d11a72755b987902440045d346_id,a13489364c2eb015c219172d561c62350f0453f3_id |
...
Scenario: Verify references were resolved correctly
  And I check that references were resolved correctly:
	...
	| courseTranscript                      | 4524ed501c1d45a47f3f8b3dfe346b848c5216f3_id 											 | body.courseId                				 | course                                     |
	#disciplineIncident
	...
	#grade
	| reportCard							| 709b2eefd3006c8cc7653f40d0e1d9482913f053_id25a038f1108526afc18cc2351de481388b84878c_id											 | body.grades									 | grade									  |
	#gradebookEntry
	...
	#reportCard
	| studentAcademicRecord					| 709b2eefd3006c8cc7653f40d0e1d9482913f053_id31b7513b764bed826297307baa560d88e211e687_id											 | body.reportCards								| reportCard								  |
	#section
	...
	| studentAcademicRecord                 | 9f872bf23bc7efa1611bf76fd6e775b2e84605f1_id2c10dec5f74762e0fcdd0ba8d547d9b9f4f34b57_id 											 | body.sessionId                       		| session									  |
	| section								| b11d9f8e0790f441c72a15a3c2deba5ffa1a5c4a_id											 | body.sessionId								| session									  |
	#studentAcademicRecord
	| courseTranscript                      | 4524ed501c1d45a47f3f8b3dfe346b848c5216f3_id 											 | body.studentAcademicRecordId                 | studentAcademicRecord	                      |
	#staff
	...
	#studentCompetency
	| reportCard							| 709b2eefd3006c8cc7653f40d0e1d9482913f053_id25a038f1108526afc18cc2351de481388b84878c_id											 | body.studentCompetencyId						| studentCompetency							  |
	#studentCompetencyObjective
	...
	| reportCard                            | 709b2eefd3006c8cc7653f40d0e1d9482913f053_id25a038f1108526afc18cc2351de481388b84878c_id 											 | body.studentId 								| student                       			  |
    | studentAcademicRecord                 | 9f872bf23bc7efa1611bf76fd6e775b2e84605f1_id2c10dec5f74762e0fcdd0ba8d547d9b9f4f34b57_id 											 | body.studentId                       		| student									  |
