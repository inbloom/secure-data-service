...
Feature: Student access to system
  ...
  Scenario: Student cannot traverse to protected data through public entities security event
    ...
    And "1" security event matching "Access Denied:url http.*/api/rest/v1.4/schools/888b2e17-0edb-4251-958b-8ac65093c9d3/studentSchoolAssociations/students is not accessible." should be in the sli db
    And "1" security event with field "body.actionUri" matching "http.*/api/rest/v1.4/schools/888b2e17-0edb-4251-958b-8ac65093c9d3/studentSchoolAssociations/students" should be in the sli db
  ...
  Scenario: Student cannot traverse to protected data through public entities security event checking
    ...
    Then I should receive a return code of 403
     ...
     And "1" security event with field "body.actionUri" matching "http.*/api/rest/v1.4/learningObjectives/dd9165f2-65fe-6d27-a8ec-bdc5f47757b7/studentCompetencies" should be in the sli db
