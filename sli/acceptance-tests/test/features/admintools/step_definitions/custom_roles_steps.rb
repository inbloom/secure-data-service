...
Transform /rights "(.*?)"/ do |arg1|
  ...
  rights = ["READ_GENERAL", "WRITE_GENERAL", "WRITE_PUBLIC", "READ_RESTRICTED", "WRITE_RESTRICTED", "AGGREGATE_READ", "READ_PUBLIC", "STAFF_CONTEXT","APP_AUTHORIZE","SECURITY_EVENT_VIEW"] if arg1 == "IT Administrator"
  ...
  rights = ["READ_GENERAL", "WRITE_GENERAL", "READ_RESTRICTED", "WRITE_RESTRICTED", "AGGREGATE_READ", "READ_PUBLIC", "WRITE_PUBLIC", "AGGREGATE_WRITE", "STAFF_CONTEXT", "APP_AUTHORIZE","SECURITY_EVENT_VIEW"] if arg1 == "all defaults"
