...
Transform /rights "(.*?)"/ do |arg1|
  ...
  rights = ["READ_GENERAL", "WRITE_GENERAL", "WRITE_PUBLIC", "READ_RESTRICTED", "WRITE_RESTRICTED", "AGGREGATE_READ", "READ_PUBLIC", "STAFF_CONTEXT", "APP_AUTHORIZE"] if arg1 == "IT Administrator"
