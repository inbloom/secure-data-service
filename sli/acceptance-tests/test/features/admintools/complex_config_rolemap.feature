...
Given I have an open web browser
And I am authenticated to SLI IDP as user "sunsetrealmadmin2" with pass "sunsetrealmadmin21234"
...
And I am user "sunsetrealmadmin2"
And "sunsetrealmadmin2" is valid "SLI IDP" user
And I have a Role attribute equal to "SLI IT Administrator"
When I enter "sunsetrealmadmin2" in the username text field
And I enter "sunsetrealmadmin21234" in the password text field
