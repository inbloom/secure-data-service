...
And I am user "realmadmin"
And "realmadmin" is valid "SLI IDP" user
And I have a Role attribute equal to "SLI IT Administrator"
When I enter "realmadmin" in the username text field
And I enter "realmadmin1234" in the password text field
