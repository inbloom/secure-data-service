...
#  id = ""   if human_readable_id = "ENDPOINT1 ID - MULTIPLE"
  id = ["ab9561f3-471b-44cf-b447-864644048aa1", "21e57d58-f775-4cc8-b759-d8d9d811b5b4"] if human_readable_id == "ENDPOINT1 FIELD - MULTIPLE - EXPECTED VALUE"
...
#  id = ""   if human_readable_id = "ENDPOINT2 ID - MULTIPLE"
