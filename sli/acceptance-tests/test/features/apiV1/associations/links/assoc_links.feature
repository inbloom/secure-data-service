...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | staffCohortAssociation   				 | staffCohortAssociations                  | b4e31b1a-8e55-8803-722c-14d8087c0712 | getStaffCohortAssociations  				| getStaff           | getCohort          		| getStaff               | getCohorts             	 | staff             | cohorts           	  | 85585b27-5368-4f10-a331-3abcaf3a3f4c | b40926af-8fd5-11e1-86ec-0021701f543f | staffId            | cohortId           			  | 3       | 2       |
