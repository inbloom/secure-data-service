...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | studentProgramAssociation              | studentProgramAssociations               | 9b8cafdc-8fd5-11e1-86ec-0021701f543f_idb3f68907-8fd5-11e1-86ec-0021701f543f_id | getStudentProgramAssociations              | getStudent         | getProgram               | getStudents            | getPrograms               | students          | programs               | 0f0d9bac-0081-4900-af7c-d17915e02378_id | 9b8cafdc-8fd5-11e1-86ec-0021701f543f_id    | studentId          | programId                      | 1       | 4       |
