...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | studentParentAssociation               | studentParentAssociations                | 74cf790e-84c4-4322-84b8-fca7206f1085_id_iddd69083f-a053-4819-a3cd-a162cdc627d7_id | getStudentParentAssociations               | getStudent         | getParent                | getStudents            | getParents                | students          | parents                | 74cf790e-84c4-4322-84b8-fca7206f1085_id | eb4d7e1b-7bed-890a-cddf-cdb25a29fc2d | studentId          | parentId                       | 1       | 1       |
