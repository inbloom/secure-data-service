...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | studentSchoolAssociation               | studentSchoolAssociations                | e7e0e926-874e-4d05-9177-9776d44c5fb5 | getStudentSchoolAssociations               | getStudent         | getSchool                | getStudents            | getSchools                | students          | schools                | 11d13fde-371c-4b58-b0b0-a6e2d955a947_id | a189b6f2-cc17-4d66-8b0d-0478dcf0cdfb    | studentId          | schoolId                       | 2       | 59      |
