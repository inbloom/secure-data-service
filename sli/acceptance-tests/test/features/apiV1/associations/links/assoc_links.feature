...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | studentAssessmentAssociation           | studentAssessments                       | 74cf790e-84c4-4322-84b8-fca7206f1085_ide85b5aa7-465a-6dd3-8ffb-d02461ed79f8_id | getStudentAssessments                      | getStudent         | getAssessment            | getStudents            | getAssessments            | students          | assessments            | 74cf790e-84c4-4322-84b8-fca7206f1085_id | dd916592-7d7e-5d27-a87d-dfc7fcb757f6 | studentId          | assessmentId                   | 1       | 0       |
    ...
    | studentParentAssociation               | studentParentAssociations                | dd69083f-a053-4819-a3cd-a162cdc627d7 | getStudentParentAssociations               | getStudent         | getParent                | getStudents            | getParents                | students          | parents                | 74cf790e-84c4-4322-84b8-fca7206f1085_id | eb4d7e1b-7bed-890a-cddf-cdb25a29fc2d | studentId          | parentId                       | 1       | 1       |
...
# vmcglaughlin - 20120927 - after removing lists of references from staffCohortAssociation and staffProgramAssociation, there are no remaining examples
@wip
