...
Feature: As an SLI application, I want to present links between an association and its end points.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    | staffCohortAssociation                 | staffCohortAssociations                  | 8fef446f-fc63-15f9-8606-0b85086c07d6 | getStaffCohortAssociations                 | getStaff           | getCohort                | getStaff               | getCohorts                | staff             | cohorts                | 85585b27-5368-4f10-a331-3abcaf3a3f4c | b408d88e-8fd5-11e1-86ec-0021701f543f    | staffId            | cohortId                       | 2       | 3       |
