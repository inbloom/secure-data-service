...
Transform /^<([^"]*)>$/ do |human_readable_id|
  ...
  id = ["b408635d-8fd5-11e1-86ec-0021701f543f", "b408d88e-8fd5-11e1-86ec-0021701f543f"] if human_readable_id == "STAFF COHORT ASSOC EP2 MULTIPLE"
  ...
  id = ["9b8c3aab-8fd5-11e1-86ec-0021701f543f", "9b8cafdc-8fd5-11e1-86ec-0021701f543f"] if human_readable_id == "STAFF PROGRAM ASSOC EP2 MULTIPLE"
  id
end