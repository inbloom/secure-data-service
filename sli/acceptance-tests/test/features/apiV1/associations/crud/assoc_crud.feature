...
Feature: As an SLI application, I want to be able to perform CRUD operations on association resources.
  ...
  Background: Logged in as IT Admin Rick Rogers
    ...
    Examples:
      ...
      | teacherSectionAssociation              | teacherSectionAssociations               | <15ab6363-5509-470c-8b59-4f289c224107_id32b86a2a-e55c-4689-aedf-4b676f3da3fc_id> | classroomPosition        | Assistant Teacher      | teacherId             | sectionId                      | <04f708bc-928b-420d-a440-f1592a5d1073> | <a47eb9aa-1c97-4c8e-9d0a-45689a66d4f8> |
