...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json;charset=utf-8"
    ...
    Examples:
        ...
        | "section"                               | "sections"                               | "programReference"               | "program"               | "programs"               | "getProgram"               | "getSections"                               | "706ee3be-0dae-4e98-9525-f564e05aa388_id" | ["9b8cafdc-8fd5-11e1-86ec-0021701f543f"] | ["9b8cafdc-8fd5-11e1-86ec-0021701f543f", "f24e5725-c1e4-48db-9f62-381ab434c0ec"] |
