...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json;charset=utf-8"
    ...
    Examples:
        ...
        | "reportCard"                            | "reportCards"                            | "studentCompetencyId"            | "studentCompetency"     | "studentCompetencies"    | "getStudentCompetency"     | "getReportCards"                            | "3cebe871565fe8c45414d8487eaca3d1534d3177_idcf0ca1c6-a9db-4180-bf23-8276c4e2624c" | ["b57643e4-9acf-11e1-89a7-68a86d21d918"] | ["b57643e4-9acf-11e1-89a7-68a86d21d918", "3a2ea9f8-9acf-11e1-add5-68a86d21d918"] |
        | "section"                               | "sections"                               | "programReference"               | "program"               | "programs"               | "getProgram"               | "getSections"                               | "706ee3be-0dae-4e98-9525-f564e05aa388_id" | ["9b8cafdc-8fd5-11e1-86ec-0021701f543f_id"] | ["9b8cafdc-8fd5-11e1-86ec-0021701f543f_id", "9b8c3aab-8fd5-11e1-86ec-0021701f543f_id"] |
        | "cohort"                                | "cohorts"                                | "programId"                      | "program"               | "programs"               | "getProgram"               | "getCohorts"                                | "b40926af-8fd5-11e1-86ec-0021701f543f_id" | ["9b8c3aab-8fd5-11e1-86ec-0021701f543f_id"] | ["9b8cafdc-8fd5-11e1-86ec-0021701f543f_id"] |
