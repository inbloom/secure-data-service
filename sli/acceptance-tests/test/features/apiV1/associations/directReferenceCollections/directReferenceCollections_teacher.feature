...
Feature: As an SLI application, I want entity references displayed as usable links with exlicit link names
  ...
  Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
    ...
    Examples:
      ...
      | "reportCard"         | "reportCards"       | "studentCompetencyId"    | "studentCompetency"   | "studentCompetencies"    | "getStudentCompetency"     | "getReportCards"     | "8770da5b-dca5-4ced-7919-201211120001" | ["b57643e4-9acf-11e1-7919-201211130002"] | ["b57643e4-9acf-11e1-7919-201211130003"] |
