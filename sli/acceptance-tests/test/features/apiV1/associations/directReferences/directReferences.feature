...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentGradebookEntries"                | "0f5e6f78-5434-f906-e51b-d63ef970ef8f" | "5738d251-dd0b-4734-9ea6-417ac9320a15_id" | "ae479bef-eb57-4c2e-8896-84983b1d4ed2" |
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getStudentGradebookEntries"                | "0f5e6f78-5434-f906-e51b-d63ef970ef8f" | "ceffbb26-1327-4313-9cfc-1c3afd38122e_id" | "8ed12459-eae5-49bc-8b6b-6ebe1a56384f" |
...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and the natural keys are not update-able
 ...
 Examples:
        | source entity type                      | source expose name                       | reference field                  | target entity type          | target expose name           | target link name                 | source link name             | testing ID                             | reference value                        | new valid value                        |
        | "reportCard"                            | "reportCards"                            | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getReportCards"             | "cf0ca1c6-a9db-4180-bf23-8276c4e2624c" | "74cf790e-84c4-4322-84b8-fca7206f1085_id" | "41df2791-b33c-4b10-8de6-a24963bbd3dd" |
