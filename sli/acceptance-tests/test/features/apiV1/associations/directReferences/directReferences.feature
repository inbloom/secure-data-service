...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentSectionGradebookEntry"          | "studentGradebookEntries"                | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentGradebookEntries"                | "0f5e6f78-5434-f906-e51b-d63ef970ef8f" | "5738d251-dd0b-4734-9ea6-417ac9320a15" | "ae479bef-eb57-4c2e-8896-84983b1d4ed2" |
        | "studentSectionGradebookEntry"          | "studentGradebookEntries"                | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getStudentGradebookEntries"                | "0f5e6f78-5434-f906-e51b-d63ef970ef8f" | "ceffbb26-1327-4313-9cfc-1c3afd38122e" | "8ed12459-eae5-49bc-8b6b-6ebe1a56384f" |
        | "studentSectionGradebookEntry"          | "studentGradebookEntries"                | "gradebookEntryId"               | "gradebookEntry"        | "gradebookEntries"       | "getGradebookEntry"        | "getStudentGradebookEntries"                | "0f5e6f78-5434-f906-e51b-d63ef970ef8f" | "0b980a49-56b6-4d17-847b-2997b7227686" | "e49dc00c-182d-4f22-98c5-3d35b5f6d993" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "courseOffering"                        | "courseOfferings"                        | "courseId"                       | "course"                | "courses"                | "getCourse"                | "getCourseOfferings"                        | "67bfb073-bd36-0771-8d5a-bba7ba03f8fb" | "ddf01d82-9293-49ba-b16e-0fe5b4f4804d" | "75de6e74-a2e0-47da-ad1e-df1c833af92c" |
        | "courseOffering"                        | "courseOfferings"                        | "sessionId"                      | "session"               | "sessions"               | "getSession"               | "getCourseOfferings"                        | "67bfb073-bd36-0771-8d5a-bba7ba03f8fb" | "fb0ac9e8-9e4e-48a0-95d2-ae07ee15ee92" | "c549e272-9a7b-4c02-aff7-b105ed76c904" |
