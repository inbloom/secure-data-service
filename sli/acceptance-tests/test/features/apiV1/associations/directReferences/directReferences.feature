...
Scenario Outline: Confirm all association generate one valid links that is implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "courseTranscript"                      | "courseTranscripts"                      | "studentId"                      | "student"               | "students"               | "getStudent"               | "getCourseTranscripts"                      | "36aeeabf-ee9b-46e6-8039-13320bf15226" | "5738d251-dd0b-4734-9ea6-417ac9320a15" | "ae479bef-eb57-4c2e-8896-84983b1d4ed2" |
