...
#        | "studentCompetency"                     | "studentCompetencies"                    | "objectiveId.learningObjectiveId"            | "learningObjective"         | "learningObjectives"         | "getLearningObjective"           | "getStudentCompetencies"     | "b57643e4-9acf-11e1-89a7-68a86d21d918" | "dd9165f2-65be-6d27-a8ac-bdc5f46757b6" | "dd9165f2-65fe-6d27-a8ec-bdc5f47757b7" |
        ...
        | "attendance"                            | "attendances"                            | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getAttendances"             | "530f0704-c240-4ed9-0a64-55c0308f91ee" | "74cf790e-84c4-4322-84b8-fca7206f1085_id" | "5738d251-dd0b-4734-9ea6-417ac9320a15" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and natural keys are not update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentSectionAssociation"             | "studentSectionAssociations"             | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentSectionAssociations"             | "706ee3be-0dae-4e98-9525-f564e05aa388_idbac890d6-b580-4d9d-a0d4-8bce4e8d351a_id" | "74cf790e-84c4-4322-84b8-fca7206f1085_id" | "5738d251-dd0b-4734-9ea6-417ac9320a15" |
