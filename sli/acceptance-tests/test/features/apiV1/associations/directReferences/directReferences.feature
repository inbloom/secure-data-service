...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "sectionAssessmentAssociation"          | "sectionAssessmentAssociations"          | "assessmentId"                   | "assessment"            | "assessments"            | "getAssessment"            | "getSectionAssessmentAssociations"          | "0cb7e99b-fc18-ecdb-830a-99abe8ee26be" | "dd916592-7d3e-4f27-a8ac-bec5f4b757f6" | "dd916592-7d7e-5d27-a87d-dfc7fcb757f6" |
#mark
