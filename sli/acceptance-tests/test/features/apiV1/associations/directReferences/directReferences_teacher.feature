...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and the natural keys are not update-able
 ...
 Examples:
        ...
        | "studentAcademicRecord"                 | "studentAcademicRecords"                 | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getStudentAcademicRecords"  | "56afc8d4-6c91-48f9-8a11-de527c1131b7" | "0c2756fd-6a30-4010-af79-488d6ef2735a_id" | "0f0d9bac-0081-4900-af7c-d17915e02378_id" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and natural keys are not update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentAssessment"          | "studentAssessments"                     | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentAssessments"                     | "0c2756fd-6a30-4010-af79-488d6ef2735a_ide5e13e61-01aa-066b-efe0-710f7a011115_id" | "0c2756fd-6a30-4010-af79-488d6ef2735a_id" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce_id" |
        | "studentAssessment"          | "studentAssessments"                     | "assessmentId"                   | "assessment"            | "assessments"            | "getAssessment"            | "getStudentAssessments"                     | "0c2756fd-6a30-4010-af79-488d6ef2735a_ide5e13e61-01aa-066b-efe0-710f7a011115_id" | "dd916592-7d7e-5d27-a87d-dfc7fcb12346" | "df897f7a-7ac4-42e4-bcbc-8cc6fd88b91a" |
