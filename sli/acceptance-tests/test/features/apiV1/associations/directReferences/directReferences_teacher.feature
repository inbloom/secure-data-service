...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentGradebookEntries"                | "20120613-5434-f906-e51b-d63ef970ef8f" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "0c2756fd-6a30-4010-af79-488d6ef2735a" |
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getStudentGradebookEntries"                | "20120613-5434-f906-e51b-d63ef970ef8f" | "0dbb262b-8a3e-4a7b-82f9-72de95903d91" | "15ab6363-5509-470c-8b59-4f289c224107_id" |
...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and the natural keys are not update-able
 ...
 Examples:
        | source entity type                      | source expose name                       | reference field                  | target entity type          | target expose name           | target link name                 | source link name             | testing ID                             | reference value                        | new valid value                        |
        | "reportCard"                            | "reportCards"                            | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getReportCards"             | "8770da5b-dca5-4ced-7919-201211120001" | "0f0d9bac-0081-4900-af7c-d17915e02378" | "0c2756fd-6a30-4010-af79-488d6ef2735a" |
        ...
        | "studentAcademicRecord"                 | "studentAcademicRecords"                 | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getStudentAcademicRecords"  | "56afc8d4-6c91-48f9-8a11-de527c1131b7" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "0f0d9bac-0081-4900-af7c-d17915e02378" |
        | "studentAcademicRecord"                 | "studentAcademicRecords"                 | "sessionId"                      | "session"                   | "sessions"                   | "getSession"                     | "getStudentAcademicRecords"  | "56afc8d4-6c91-48f9-8a11-de527c1131b7" | "0410354d-dbcb-0214-250a-404401060c93" | "d23ebfc4-5192-4e6c-a52b-81cee2319072" |
        | "attendance"                            | "attendances"                            | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getAttendances"             | "4beb72d4-0f76-4071-7919-201211130003" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "0f0d9bac-0081-4900-af7c-d17915e02378" |
        | "gradebookEntry"                        | "gradebookEntries"                       | "sectionId"                      | "section"                   | "sections"                   | "getSection"                     | "getGradebookEntries"        | "e49dc00c-182d-4f22-7919-201211130004" | "15ab6363-5509-470c-8b59-4f289c224107_id" | "47b5adbf-6fd0-4f07-ba5e-39612da2e234" |
        | "section"                               | "sections"                               | "schoolId"                       | "school"                    | "schools"                    | "getSchool"                      | "getSections"                | "47b5adbf-6fd0-4f07-ba5e-39612da2e234" | "6756e2b9-aba1-4336-80b8-4a5dde3c63fe" | "92d6d5a0-852c-45f4-907a-912752831772" |
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "gradebookEntryId"               | "gradebookEntry"            | "gradebookEntries"           | "getGradebookEntry"              | "getStudentGradebookEntries" | "20120613-5434-f906-e51b-d63ef970ef8f" | "20120613-56b6-4d17-847b-2997b7227686" | "e49dc00c-182d-4f22-7919-201211130004" |
        | "cohort"                                | "cohorts"                                | "educationOrgId"                 | "educationOrganization"     | "educationOrganizations"     | "getEducationOrganization"       | "getCohorts"                 | "f95269af-cb73-4694-7919-201211130010" | "6756e2b9-aba1-4336-80b8-4a5dde3c63fe" | "92d6d5a0-852c-45f4-907a-912752831772" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "courseTranscript"                      | "courseTranscripts"                      | "studentId"                      | "student"               | "students"               | "getStudent"               | "getCourseTranscripts"                      | "36aeeabf-ee9b-46e6-7919-201311130015" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "ae479bef-eb57-4c2e-8896-84983b1d4ed2" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and natural keys are not update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        | source entity type                      | source expose name                       | reference field                  | target entity type      | target expose name       | target link name           | source link name                            | testing ID                             | reference value                        | new valid value                        |
        | "studentDisciplineIncidentAssociation"  | "studentDisciplineIncidentAssociations"  | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentDisciplineIncidentAssociations"  | "20120613-8d5a-c796-76e3-d77d5d497e6c" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "0f0d9bac-0081-4900-af7c-d17915e02378" |
        | "studentDisciplineIncidentAssociation"  | "studentDisciplineIncidentAssociations"  | "disciplineIncidentId"           | "disciplineIncident"    | "disciplineIncidents"    | "getDisciplineIncident"    | "getStudentDisciplineIncidentAssociations"  | "20120613-8d5a-c796-76e3-d77d5d497e6c" | "0e26de79-7efa-5e67-9201-5113ad50a03b" | "0e26de79-7efa-5e67-7919-201211130050" |
...
#WIP Defect #????        | "staffEducationOrganizationAssociation" | "staffEducationOrgAssignmentAssociations"| "staffReference"                 | "staff"                 | "staff"                  | "getStaff"                 | "getStaffEducationOrgAssignmentAssociations"| "05e3de47-9e41-c048-a572-3eb4c7ee9095" | "8b549300-4265-42e8-9fa2-692ea287fcc8" | "32f4a6fe-54d6-4aaf-9418-8de61379b710" |
        | "studentAssessmentAssociation"          | "studentAssessments"                     | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentAssessments"                     | "e5e13e61-01aa-066b-efe0-710f7a011115" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce" |
        | "studentAssessmentAssociation"          | "studentAssessments"                     | "assessmentId"                   | "assessment"            | "assessments"            | "getAssessment"            | "getStudentAssessments"                     | "e5e13e61-01aa-066b-efe0-710f7a011115" | "dd916592-7d7e-5d27-a87d-dfc7fcb12346" | "df897f7a-7ac4-42e4-bcbc-8cc6fd88b91a" |
        | "studentSchoolAssociation"              | "studentSchoolAssociations"              | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentSchoolAssociations"              | "0950fa79-bad5-4085-a3c0-bc98ee122231" | "b8e346c8-025e-44ba-9ae1-f2fa4e832b08" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce" |
        ...
        | "studentSectionAssociation"             | "studentSectionAssociations"             | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentSectionAssociations"             | "15ab6363-5509-470c-8b59-4f289c224107_id066345e8-2633-474d-9088-7b3828bf873a_id" | "bf88acdb-71f9-4c19-8de8-2cdc698936fe" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce" |
#        | "studentSectionAssociation"             | "studentSectionAssociations"             | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getStudentSectionAssociations"             | "706ee3be-0dae-4e98-9525-f564e05aa388_idbac890d6-b580-4d9d-a0d4-8bce4e8d351a_id" | "706ee3be-0dae-4e98-9525-f564e05aa388_id" | "7295e51e-cd51-4901-ae67-fa33966478c7" |
        | "courseTranscript"                      | "courseTranscripts"                      | "courseId"                       | "course"                | "courses"                | "getCourse"                | "getCourseTranscripts"                      | "36aeeabf-ee9b-46e6-7919-201311130015" | "3748c09c-ac17-41f1-85a8-d20edd2edf3d" | "fabc4143-629b-4176-8dcf-2e01e33c9c25" |
        | "studentParentAssociation"              | "studentParentAssociations"              | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentParentAssociations"              | "c5aa1969-492a-5150-8479-71bfc4d87984" | "0c2756fd-6a30-4010-af79-488d6ef2735a" | "0f0d9bac-0081-4900-af7c-d17915e02378" |
        | "studentParentAssociation"              | "studentParentAssociations"              | "parentId"                       | "parent"                | "parents"                | "getParent"                | "getStudentParentAssociations"              | "c5aa1969-492a-5150-8479-71bfc4d87984" | "9b8f7237-ce8e-4dff-98cf-66535880987b" | "9b8f7237-ce8e-4dff-7919-201211130040" |
        ...
        | "teacherSectionAssociation"             | "teacherSectionAssociations"             | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getTeacherSectionAssociations"             | "15ab6363-5509-470c-8b59-4f289c224107_id32b86a2a-e55c-4689-aedf-4b676f3da3fc_id" | "15ab6363-5509-470c-8b59-4f289c224107_id" | "47b5adbf-6fd0-4f07-ba5e-39612da2e234" |
        | "studentCohortAssociation"              | "studentCohortAssociations"              | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentCohortAssociations"              | "cc87b3af-70f1-4141-7919-201311130011" | "e1dd7a73-5000-4293-9b6d-b5f02b7b3b34" | "0c2756fd-6a30-4010-af79-488d6ef2735a" |
        | "studentCohortAssociation"              | "studentCohortAssociations"              | "cohortId"                       | "cohort"                | "cohorts"                | "getCohort"                | "getStudentCohortAssociations"              | "cc87b3af-70f1-4141-7919-201311130011" | "f95269af-cb73-4694-7919-201211130010" | "f95269af-cb73-4694-7919-201211130030" |
        ...
        | "studentProgramAssociation"             | "studentProgramAssociations"             | "programId"                      | "program"               | "programs"               | "getProgram"               | "getStudentProgramAssociations"             | "b3f68907-8fd5-11e1-86ec-0021701f543f" | "9b8cafdc-8fd5-11e1-86ec-0021701f543f" | "f24e5725-c1e4-48db-9f62-381ab434c0ec" |
