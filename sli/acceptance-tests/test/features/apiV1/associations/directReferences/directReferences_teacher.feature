...
#WDS        | "gradebookEntry"                        | "gradebookEntries"                       | "sectionId"                      | "section"                   | "sections"                   | "getSection"                     | "getGradebookEntries"        | "e49dc00c-182d-4f22-7919-201211130004" | "15ab6363-5509-470c-8b59-4f289c224107_id" | "47b5adbf-6fd0-4f07-ba5e-39612da2e234" |
        ...
        | "studentGradebookEntry"                 | "studentGradebookEntries"                | "gradebookEntryId"               | "gradebookEntry"            | "gradebookEntries"           | "getGradebookEntry"              | "getStudentGradebookEntries" | "20120613-5434-f906-e51b-d63ef970ef8f" | "20120613-56b6-4d17-847b-2997b7227686" | "e49dc00c-182d-4f22-98c5-3d35b5f6d993" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "courseTranscript"                      | "courseTranscripts"                      | "studentId"                      | "student"               | "students"               | "getStudent"               | "getCourseTranscripts"                      | "36aeeabf-ee9b-46e6-8039-13320bf15226" | "5738d251-dd0b-4734-9ea6-417ac9320a15_id" | "ae479bef-eb57-4c2e-8896-84983b1d4ed2" |
