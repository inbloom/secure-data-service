...
Scenario Outline: Confirm all association generate one valid links that is implemented and natural keys are not update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentAssessment"          | "studentAssessments"                     | "assessmentId"                   | "assessment"            | "assessments"            | "getAssessment"            | "getStudentAssessments"                     | "e5e13e61-01aa-066b-efe0-710f7a011115_id" | "dd916592-7d7e-5d27-a87d-dfc7fcb12346" | "df897f7a-7ac4-42e4-bcbc-8cc6fd88b91a" |
