...
Scenario Outline: Confirm all known reference fields generate two valid links that are implemented and the natural keys are not update-able
 ...
 Examples:
        | source entity type                      | source expose name                       | reference field                  | target entity type          | target expose name           | target link name                 | source link name             | testing ID                             | reference value                        | new valid value                        |
        | "reportCard"                            | "reportCards"                            | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getReportCards"             | "648302f251c5a9b24753ddc45975720c939d7d73_id8770da5b-dca5-4ced-7919-201211120001" | "0f0d9bac-0081-4900-af7c-d17915e02378_id" | "0c2756fd-6a30-4010-af79-488d6ef2735a_id" |
        | "reportCard"                            | "reportCards"                            | "gradingPeriodId"                | "gradingPeriod"             | "gradingPeriods"             | "getGradingPeriod"               | "getReportCards"             | "648302f251c5a9b24753ddc45975720c939d7d73_id8770da5b-dca5-4ced-7919-201211120001" | "b40a7eb5-dd74-4666-a5b9-5c3f4425f130" | "ef72b883-90fa-40fa-afc2-4cb1ae17623b" |
        | "grade"                                 | "grades"                                 | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getGrades"                  | "d5adf50c7e7ac73db186761694f3f528648a4cdb_idef42e2a2-9942-11e1-7919-201211130001" | "bf88acdb-71f9-4c19-8de8-2cdc698936fe_id" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce_id" |
        | "grade"                                 | "grades"                                 | "gradingPeriodId"                | "gradingPeriod"             | "gradingPeriods"             | "getGradingPeriod"               | "getGrades"                  | "d5adf50c7e7ac73db186761694f3f528648a4cdb_idef42e2a2-9942-11e1-7919-201211130001" | "b40a7eb5-dd74-4666-a5b9-5c3f4425f130" | "ef72b883-90fa-40fa-afc2-4cb1ae17623b" |
        ...
        | "studentAcademicRecord"                 | "studentAcademicRecords"                 | "studentId"                      | "student"                   | "students"                   | "getStudent"                     | "getStudentAcademicRecords"  | "7a70c01bf8d93d9b1f53ab45080777b0b49794fa_id56afc8d4-6c91-48f9-8a11-de527c1131b7" | "0c2756fd-6a30-4010-af79-488d6ef2735a_id" | "f694c1f1-f06e-4059-9a9b-ff8700a4fbce_id" |
        | "studentAcademicRecord"                 | "studentAcademicRecords"                 | "sessionId"                      | "session"                   | "sessions"                   | "getSession"                     | "getStudentAcademicRecords"  | "7a70c01bf8d93d9b1f53ab45080777b0b49794fa_id56afc8d4-6c91-48f9-8a11-de527c1131b7" | "4d796afd-b1ac-4f16-9e0d-6db47d445b55" | "d23ebfc4-5192-4e6c-a52b-81cee2319072" |
        ...
        | "section"                               | "sections"                               | "schoolId"                       | "educationOrganization"     | "schools"                    | "getSchool"                      | "getSections"                | "47b5adbf-6fd0-4f07-ba5e-39612da2e234_id" | "6756e2b9-aba1-4336-80b8-4a5dde3c63fe" | "92d6d5a0-852c-45f4-907a-912752831772" |
...
Scenario Outline: Confirm all association generate one valid links that is implemented and natural keys are not update-able
   Given format "application/vnd.slc+json"
    ...
    Examples:
        ...
        | "studentSchoolAssociation"              | "studentSchoolAssociations"              | "schoolId"                       | "educationOrganization" | "schools"                | "getSchool"                | "getStudentSchoolAssociations"              | "0950fa79-bad5-4085-a3c0-bc98ee122231" | "92d6d5a0-852c-45f4-907a-912752831772" | "6756e2b9-aba1-4336-80b8-4a5dde3c63fe" |
...
#        | "studentSectionAssociation"             | "studentSectionAssociations"             | "sectionId"                      | "section"               | "sections"               | "getSection"               | "getStudentSectionAssociations"             | "706ee3be-0dae-4e98-9525-f564e05aa388_idbac890d6-b580-4d9d-a0d4-8bce4e8d351a_id" | "706ee3be-0dae-4e98-9525-f564e05aa388_id" | "7295e51e-cd51-4901-ae67-fa33966478c7_id" |
        ...
        | "teacherSchoolAssociation"              | "teacherSchoolAssociations"              | "schoolId"                       | "educationOrganization" | "schools"                | "getSchool"                | "getTeacherSchoolAssociations"              | "9d4e4031-3a5d-4965-98b9-257ff887a774" | "92d6d5a0-852c-45f4-907a-912752831772" | "6756e2b9-aba1-4336-80b8-4a5dde3c63fe" |
        ...
        | "studentCohortAssociation"              | "studentCohortAssociations"              | "studentId"                      | "student"               | "students"               | "getStudent"               | "getStudentCohortAssociations"              | "e1dd7a73-5000-4293-9b6d-b5f02b7b3b34_idcc87b3af-70f1-4141-7919-201311130011_id" | "e1dd7a73-5000-4293-9b6d-b5f02b7b3b34_id" | "0c2756fd-6a30-4010-af79-488d6ef2735a_id" |
        | "studentCohortAssociation"              | "studentCohortAssociations"              | "cohortId"                       | "cohort"                | "cohorts"                | "getCohort"                | "getStudentCohortAssociations"              | "e1dd7a73-5000-4293-9b6d-b5f02b7b3b34_idcc87b3af-70f1-4141-7919-201311130011_id" | "f95269af-cb73-4694-7919-201211130010_id" | "f95269af-cb73-4694-7919-201211130030_id" |
