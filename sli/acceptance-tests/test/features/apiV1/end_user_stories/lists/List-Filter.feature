...
Scenario Outline: As a teacher or leader I want to see all my students in 3rd period Algebra II class and view StateTest Math 2011 assessment scores
    ...
    Then I should receive a link named "getTeacherSectionAssociations" with URI "/v1.4/teachers/<'Linda Kim' ID>/teacherSectionAssociations"
    ...
    Then I should receive a link named "getStudentAssessments" with URI "/v1.4/students/<'Matt Sollars' ID>/studentAssessments"
        And I should receive a link named "getAssessments" with URI "/v1.4/students/<'Matt Sollars' ID>/studentAssessments/assessments"
