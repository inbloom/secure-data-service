...
Transform /^<(.*?)>$/ do |human_readable_id|
  ...
  id = "2013-Twelfth grade Assessment 2"                       if human_readable_id == "assessment 1"
  id = "2013-Twelfth grade Assessment 2#2"                     if human_readable_id == "assessment item 1"
  id = "2013-Twelfth grade Assessment 2.OA-1"                  if human_readable_id == "objective assessment"
  id = "2013-Twelfth grade Assessment 2.OA-1 Sub"              if human_readable_id == "sub objective assessment"
