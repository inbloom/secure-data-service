    ...
    And I am authenticated on "SLI"
     ...
     When I navigate to GET "/<ASSESSMENT URI>/<'Grade 2 MOY DIBELS' ID>"
      Then I should have a list of 1 "assessment" entities
        ...
        And the key "performanceLevelDescriptor.codeValue" has value "Level 1"
        And the key "performanceLevelDescriptor.description" has value "At or Above Benchmark"
        And for the level at position "1"
        And the key "minimumScore" has value "145"
        And the key "maximumScore" has value "189"
        And the key "assessmentReportingMethod" has value "Composite Score"
        And the key "performanceLevelDescriptor.codeValue" has value "Level 2"
        And the key "performanceLevelDescriptor.description" has value "Below Benchmark"
        And for the level at position "2"
        And the key "minimumScore" has value "13"
        And the key "maximumScore" has value "144"
        And the key "assessmentReportingMethod" has value "Composite Score"
        And the key "performanceLevelDescriptor.codeValue" has value "Level 3"
        And the key "performanceLevelDescriptor.description" has value "Well Below Benchmark"
     ...
     When I navigate to GET "/<STUDENT ASSESSMENT ASSOC URI>/<'Most Recent Student Assessment Association' ID>"
      Then I should have a list of 1 "studentAssessmentAssociation" entities
        ...
        And the field "performanceLevelDescriptors.description" should be "Below Benchmark"
        And the field "scoreResults.assessmentReportingMethod" should be "Scale score"
        And the field "scoreResults.result" should be "120"
