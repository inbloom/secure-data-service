...
Transform /^<(.+)>$/ do |template|
  ...
  id = "193b3d2e-bef0-467a-8bed-166f66f0517a" if template == "STUDENT SECTION ASSOCIATION ID 1"
  id = "11b75359-811d-4234-8ef2-ce14dd472a7c" if template == "STUDENT SECTION ASSOCIATION ID 2"
