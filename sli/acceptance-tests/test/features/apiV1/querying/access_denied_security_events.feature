...
Feature: As an SLI application, I want to ensure security events are created for unauthorized access
  ...
  Scenario : Confirm that Access Denied Exceptions are handled and SecurityEvents logged
    ...
    And I navigate to GET "/v1.5/disciplineIncidents/0e26de79-222a-5e67-9201-5113ad50a03b/studentDisciplineIncidentAssociations"
    ...
    And I navigate to GET "/v1.5/teachers/04f708bc-928b-420d-a440-f1592a5d1073/disciplineIncidents"
    Then I should receive a return code of 403
    ...
    And the sli securityEvent collection is empty
    And I navigate to GET "/v1.5/disciplineActions"
    Then I should receive a return code of 403
    And I should see a count of "1" in the security event collection
    ...
    When the sli securityEvent collection is empty
    And I navigate to GET "/v1.5/disciplineIncidents"
    Then I should receive a return code of 403
    And I should see a count of "1" in the security event collection
    ...
    When the sli securityEvent collection is empty
    And I navigate to GET "/v1.5/studentDisciplineIncidentAssociations"
    Then I should receive a return code of 403
    And I should see a count of "1" in the security event collection
    ...
    When I am logged in using "linda.kim" "linda.kim1234" to realm "IL"
    When the sli securityEvent collection is empty
    And I navigate to GET "/v1.5/students/6a98d5d3-d508-4b9c-aec2-59fce7e16825_id/attendances"
    Then I should receive a return code of 403
    And I should see a count of "1" in the security event collection
    And I check to find if record is in sli db collection:
      | collectionName  | expectedRecordCount | searchParameter               | searchValue                                         | searchType |
