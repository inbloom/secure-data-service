...
Scenario: Sorting a collection of student school association links by entryGradeLevel, ascending
	...
	Then I should receive a collection
		...
		And the link at index 1 should point to an entity with id "d19289b5-ca3f-4b4e-a33e-52cb3e133071"
		And the link at index 2 should point to an entity with id "fc4a8073-76d9-4e25-9342-27ecc71a032d"
		And the link at index 3 should point to an entity with id "ab88a783-7eb2-4141-854e-a09d5865fe59"
...
Scenario: Sorting a collection of full student school association entities
	...
	Then I should receive a collection
		...
		And the link at index 3 should have "entryGradeLevel" equal to "Ninth grade"
...
Scenario: Request the last and middle page of results from a API request
  Given I am logged in using "jpratt" "jpratt1234" to realm "NY"
	...
	When I navigate to GET "/v1/schools/<'Dawn Elementary School' ID>/studentSchoolAssociations"
	Then I should receive a collection with 2 elements
		And the link at index 0 should point to an entity with id "fc4a8073-76d9-4e25-9342-27ecc71a032d"
		And the link at index 1 should point to an entity with id "ab88a783-7eb2-4141-854e-a09d5865fe59"
		And the header "TotalCount" equals 8
	...
	When I navigate to GET "/v1/schools/<'Dawn Elementary School' ID>/studentSchoolAssociations"
	Then I should receive a collection with 2 elements
			And the link at index 0 should point to an entity with id "d19289b5-ca3f-4b4e-a33e-52cb3e133071"
			And the link at index 1 should point to an entity with id "fc4a8073-76d9-4e25-9342-27ecc71a032d"
			And the header "TotalCount" equals 8
			And the a previous link exists with offset equal to 0 and limit equal to 2
...
@DE1873 @DE1906 @DE1910
    Scenario: Paging's offset and limit don't do weird things
        ...
        And parameter "limit" is "10"
        When I navigate to GET "/v1/courses"
        Then I should receive a collection with 8 unique elements
        Given parameter "offset" is "88"
        And parameter "limit" is "10"
        When I navigate to GET "/v1/courses"
        Then I should receive a collection with 4 non-unique elements
...
Scenario: Confirm default limit of 50 entities and ability to override
  Given I am logged in using "rrogers" "rrogers1234" to realm "IL"
   ...
   Then I should receive a collection with 65 elements
