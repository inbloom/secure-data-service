Feature: Leader can see public entities

  Scenario: Leader can see public entities via direct id calls
    Given I log in to realm "Illinois Daybreak School District 4529" using simple-idp as "leader" "mgonzales" with password "mgonzales1234"
