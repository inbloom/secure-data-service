Feature: Educator can see public entities

  Scenario: Educator can see public entities via direct id calls
    Given I log in to realm "Illinois Daybreak School District 4529" using simple-idp as "educator" "linda.kim" with password "linda.kim1234"
