Feature: Aggregator can see public entities

  Scenario: Aggregator can see public entities via direct id calls
    Given I log in to realm "Illinois Daybreak School District 4529" using simple-idp as "aggregate viewer" "msmith" with password "msmith1234"
