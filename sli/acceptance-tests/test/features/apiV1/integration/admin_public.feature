Feature: Admin can see public entities

  Scenario: Admin can see public entities via direct id calls
    Given I log in to realm "Illinois Daybreak School District 4529" using simple-idp as "admin" "akopel" with password "akopel1234"
