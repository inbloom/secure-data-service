...
Given I log in to realm "Illinois Daybreak Students" using simple-idp as "student" "student.m.sollars" with password "student.m.sollars1234"
  ...
  When I validate there are "45" allowed association entities via API "/v1/programs/9cce6ea23864ee4870c8871e4c14ddecb6ab0fb0_id/studentProgramAssociations", some of them are:
    | id                                          |
    | 2a83c3be5091796b40601b1215c62af421da6f8d_ida08503f008608e3056a80b1b3998fe7624b56a14_id |
    | 4440ecc4484149919ad007ab8e0308a13a997912_id57652449e70c3f5a5fd2360b3d6f4fb0de6d1a2b_id |
    | 5c2fb984eb2d508e8323c022c0cbb0e7a36ecdc4_id10597bba0be315d29aaf7028a57e87d171ab0d07_id |
  When I validate there are "32" allowed association entities via API "/v1/programs/9cce6ea23864ee4870c8871e4c14ddecb6ab0fb0_id/studentProgramAssociations/students", some of them are:
    | id                                          |
    | 2a83c3be5091796b40601b1215c62af421da6f8d_id |
