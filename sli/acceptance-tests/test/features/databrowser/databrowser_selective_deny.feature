@wip
Feature: User sees information in databrowser for one district but not others

#Before running this scenario fixture data to grant access to daybreak but not to sunset should be imported
