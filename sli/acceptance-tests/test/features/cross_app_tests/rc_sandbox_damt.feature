...
Feature: RC Sandbox Integration - Developer Account Management Tool (DAMT)
  ...
  Background:
    ...
    Scenario: Newly created sandbox developer can login and check available admin links
      ...
      And I click on Admin
      Then I should be on the admin page
      And under System Tools, I see the following "Application Registration;Create Custom Roles;Create Landing Zone;Change Password;Developer Account Management"
    ...
    Scenario: Original developer change the role of new developer and confirm admin links
      ...
      #DE2242 causes this step to fail - And under System Tools, I shouldn't see the following "Create Landing Zone;Developer Account Management"
