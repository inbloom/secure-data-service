...
cp /opt/megatron/sli/sli/acceptance-tests/test/data/megtomcat01_application_fixture.json application_fixture.json
cp /opt/megatron/sli/sli/acceptance-tests/test/data/megtomcat01_realm_fixture.json realm_fixture.json
cp /opt/megatron/sli/sli/acceptance-tests/test/data/megtomcat01_securityEvent_fixture.json securityEvent_fixture.json
cp /opt/megatron/sli/sli/acceptance-tests/test/features/utils/megtomcat01_properties.yml properties.yml
cp /opt/megatron/sli/sli/admin-tools/admin-rails/config/megtomcat01_admin_config.yml config.yml
cp /opt/megatron/sli/sli/databrowser/config/megtomcat01_databrowser_config.yml config.yml
