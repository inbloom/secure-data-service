 ...
 *
 * Note: Not all fields of SIF SchoolInfo have SLI counterparts. Only those
 * fields which have a valid SLI counterpart have a getter defined here.
 *
 ...
 * <ol>
 * <li><code>SchoolFocusType</code></li>
 * <li><code>OperationalStatus</code></li>
 * <li><code>SchoolType</code></li>
 * </ol>
 * </li>
 *
...
public class SchoolInfoEntity extends SifEntity {
    ...
    */
    ...
    /**
    * Get SchoolFocusType in an SIF SchoolInfoEntity Using a value mapping
    * method.
    *
    */
    ...
    */
    ...
    /**
    * Get SchoolType in an SIF SchoolInfoEntity. Using a value mapping method.
    *
    */
    ...
    /**
    * Get GradeLevels in an SIF SchoolInfoEntity. Using a customized Dozer
    * converter.
    *
    */
    ...
    /**
    * Get PhoneNumberList in an SIF SchoolInfoEntity. Using a customized Dozer
    * converter.
    *
    */
    ...
    /**
    * Get AddressList in an SIF SchoolInfoEntity. Using a customized Dozer
    * converter.
    *
    */
