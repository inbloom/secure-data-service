...
/**
 * An SIF Entity corresponding to an SIF LEAInfo. Used by dozer to map LEAInfo into an SLI LEAEntity.
 *
 * Note: Not all fields of SIF LEAInfo have SLI counterparts. Only those fields which have a valid
...
public class LEAInfoEntity extends GenericEntity
{
    ...
    /**
     *  Get PhoneNumberList in an SIF LEAInfoEntity.
    ...
    /**
     *  Get AddressList in an SIF LEAInfoEntity.
     *  Using a customized Dozer converter.
     *
     */
