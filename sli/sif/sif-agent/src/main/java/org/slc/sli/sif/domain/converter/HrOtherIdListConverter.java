 ...
 */
@Component
public class HrOtherIdListConverter {
    ...
    /**
     * Converts the SIF HrOtherIdList into an SLI Institution Telephone list
     *
     * @param phoneNumberList
     * @return
     */
    public List<StaffIdentificationCode> convert(HrOtherIdList hrOtherIdList) {
        if (hrOtherIdList == null) {
            return null;
        }
