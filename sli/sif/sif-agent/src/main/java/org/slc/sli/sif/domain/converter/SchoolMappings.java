...
//    }
    ...
    public static String toSliSchoolCategory(String schoolType) {
        ...
        if (SchoolLevelType._0031_0789_PRE_KINDERGARTEN.getValue().equals(
                schoolType)) {
        ...
        if (SchoolLevelType._0031_2399_INTERMEDIATE.getValue().equals(
                schoolType)) {
        ...
        if (SchoolLevelType._0031_2402_HIGH_SCHOOL.getValue()
                .equals(schoolType)) {
            return "High School";
        }
