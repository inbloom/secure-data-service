...
public class ExitTypeConverter {
    ...
    static {
        ...
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._1921_GRADUATED_WITH_DEGREE,
                "Graduated with regular, advanced, International Baccalaureate, or other type of diploma");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._1922_COMPLETED_SCHOOL_WITH_OTHER,
        ...
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._1928_COMPLETED_GRADE_12_NOT_GRADUATED,
                "Completed grade 12, but did not meet all graduation requirements");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._1930_ENROLLED_IN_A_POSTSECONDARY,
        ...
        EXIT_TYPE_CODE_MAP
                .put(ExitTypeCode._3499_STUDENT_IS_IN_THE_SAME_LOCAL,
                        "Student is in the same local education agency and receiving education servi, but is not assigned to a particular school");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3500_ENROLLED_IN_AN_ADULT,
                "Enrolled in an adult education or training program");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3501_COMPLETED_A_STATE_RECOGNIZED,
        ...
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3503_ENROLLED_IN_A_FOREIGN,
                "Enrolled in a foreign exchange program, eligible to return");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3504_WITHDRAWN_FROM_SCHOOL_UNDER,
        ...
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3508_STUDENT_IS_IN_A_CHARTER,
                "Student is in a charter school managed by the same local education agency");
        EXIT_TYPE_CODE_MAP.put(ExitTypeCode._3509_COMPLETED_WITH_A_STATE,
