...
/**
 * OtherIdListConverter unit tests
 */
public class OtherIdListConverterTest extends AdkTest {

    private final OtherIdListConverter converter = new OtherIdListConverter();
    private int counter = 0;
    private Map<OtherIdType, String> map = new HashMap<OtherIdType, String>();

    @Test
    public void testNullObject() {
        List<StaffIdentificationCode> result = converter.convert((OtherIdList) null);
    ...
    public void testMappings() {
        ...
        OtherIdList list = getOtherIdList();
