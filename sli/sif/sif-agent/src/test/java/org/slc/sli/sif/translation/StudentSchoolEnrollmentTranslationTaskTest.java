...
public class StudentSchoolEnrollmentTranslationTaskTest {
    ...
    public void testNotNull() throws SifTranslationException {
        List<StudentSchoolAssociationEntity> result = translator.doTranslate(new StudentSchoolEnrollment(), null);
    ...
    public void testBasicFields() throws SifTranslationException {
        ...
        List<StudentSchoolAssociationEntity> result = translator.doTranslate(sse, null);
        Assert.assertEquals(1, result.size());
