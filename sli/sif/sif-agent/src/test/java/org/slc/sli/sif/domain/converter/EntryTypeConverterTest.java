...
public class EntryTypeConverterTest extends ADKTest {
    ...
    public void testMappings() {
        ...
        Assert.assertEquals(converter.convert(getEntryType(EntryTypeCode._0619_1835)),
                "Re-entry from the same school with no interruption of schooling");
        Assert.assertEquals(converter.convert(getEntryType(EntryTypeCode._0619_1836)),
                "Re-entry after a voluntary withdrawal");
        Assert.assertEquals(converter.convert(getEntryType(EntryTypeCode._0619_1837)),
        ...
        Assert.assertEquals(converter.convert(getEntryType(EntryTypeCode._0619_1839)),
                "Original entry into a United States school from a foreign country with no interruption in schooling");
        Assert.assertEquals(converter.convert(getEntryType(EntryTypeCode._0619_1840)),
