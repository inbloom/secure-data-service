defaultRights = ["READ_GENERAL", "WRITE_GENERAL", "READ_RESTRICTED", "WRITE_RESTRICTED", "READ_STUDENT_DATA", "WRITE_STUDENT_DATA", "READ_GENERIC", "WRITE_GENERIC", "READ_PROTECTED", "WRITE_PROTECTED", "AGGREGATE_READ", "AGGREGATE_WRITE", "READ_PUBLIC", "WRITE_PUBLIC", "BULK_EXTRACT"]
selfRights = ["READ_GENERAL", "WRITE_GENERAL", "READ_RESTRICTED", "WRITE_RESTRICTED", "READ_STUDENT_DATA", "WRITE_STUDENT_DATA", "READ_GENERIC", "WRITE_GENERIC", "READ_PROTECTED", "WRITE_PROTECTED"]
ROLE_COL = "td:eq(0)";
RIGHT_COL = "td:eq(1)";
