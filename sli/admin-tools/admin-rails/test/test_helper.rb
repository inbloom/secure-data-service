...
class ActiveSupport::TestCase
  ...
  setup do
    ...
    ActiveResource::HttpMock.respond_to do |mock|
      ...
      mock.get "/api/rest/realm?realm=dc%3Dslidev%2Cdc%3Dorg&sessionId=", {"Accept" => "application/json"}, [@realm_fixtures['one']].to_json
      mock.get "/api/rest/realm?realm=blah&sessionId=", {"Accept" => "application/json"}, [].to_json
