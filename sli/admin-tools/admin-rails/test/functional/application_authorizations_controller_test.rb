...
class ApplicationAuthorizationsControllerTest < ActionController::TestCase
  setup do
    @application_authorization = application_authorizations(:one)
  end
  ...
  test "should create application_authorization" do
    assert_difference('ApplicationAuthorization.count') do
      post :create, application_authorization: @application_authorization.attributes
    end
  ...
  test "should show application_authorization" do
    get :show, id: @application_authorization.to_param
    assert_response :success
  end
  ...
  test "should update application_authorization" do
    put :update, id: @application_authorization.to_param, application_authorization: @application_authorization.attributes
    assert_redirected_to application_authorization_path(assigns(:application_authorization))
  end
