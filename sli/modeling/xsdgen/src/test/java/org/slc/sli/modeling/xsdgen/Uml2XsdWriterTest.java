...
public class Uml2XsdWriterTest {
    ...
    public void before() {
        ...
        attributes.add(new Attribute(Identifier.random(), "myAttribute", Identifier.random(), MULTIPLICITY,
                new ArrayList<TaggedValue>()));
        
        ClassType myClassType = new ClassType(myClassTypeIdentifier, "name", false, attributes, lhs, rhs,
                new ArrayList<TaggedValue>());
        ...
        this.documents.add(new PsmDocument<Type>(mock(Type.class), new PsmResource("PsmResource"), new PsmCollection(
                "PsmCollection")));
        this.model = this.createModelIndex(enumTypes, tagDefinitionRepo, classTypes, allAssociationEnds,
                allGeneralizations);
    ...
    private Uml2XsdPlugin createUml2XsdPlugin() {
        return new Uml2XsdPlugin() {
            ...
            @Override
            public void writeAppInfo(TaggedValue taggedValue, ModelIndex lookup, Uml2XsdPluginWriter xsw) {
                // TODO Auto-generated method stub
                
            }
            
            @Override
            public void writeAssociation(ClassType complexType, AssociationEnd element, ModelIndex lookup,
    ...
    private void setupTag(String name, List<TaggedValue> enumTaggedValues,
            Map<Identifier, TagDefinition> tagDefinitionRepo) {
    ...
    private ModelIndex createModelIndex(final List<EnumType> enumTypes,
            final Map<Identifier, TagDefinition> tagDefinitionRepo, final Map<String, ClassType> classTypes,
