...
public class Xsd2UmlPluginForEdFiTest {
    ...
    public void testGetAssociationEndTypeName() throws Exception {
        ...
        assertEquals("EducationOrganizationNetwork",pluginForEdFi.getAssociationEndTypeName(classType,attribute,host));
    ...
    public void testNameAssociation() throws Exception {
        ...
        when(host.nameAssociation(Mockito.any(AssociationEnd.class),
                Mockito.any(AssociationEnd.class),Mockito.any(Xsd2UmlPluginHost.class))).thenReturn("test");
