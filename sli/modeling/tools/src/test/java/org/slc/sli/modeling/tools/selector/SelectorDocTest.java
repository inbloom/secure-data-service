...
public class SelectorDocTest {
    ...
    private static final String ATTRIBUTE_1_NAME = "attributeFoo";
    private static final String ATTRIBUTE_2_NAME = "attributeBar";

    private static final String ASSOCIATION_END_1_NAME = "associationFoo";
    private static final String ASSOCIATION_END_2_NAME = "associationBar";

    private static final String CLASS_TYPE_NAME = "classFoo";

    private static final AssociationEnd ASSOCIATION_END_1 = new AssociationEnd(MULTIPLICITY, ASSOCIATION_END_1_NAME, false, IDENTIFIER, "whatever");
    private static final AssociationEnd ASSOCIATION_END_2 = new AssociationEnd(MULTIPLICITY, ASSOCIATION_END_2_NAME, false, IDENTIFIER, "whatever");

    private static final List<AssociationEnd> ASSOCIATION_ENDS = new ArrayList<AssociationEnd>();

    static {
        ASSOCIATION_ENDS.add(ASSOCIATION_END_1);
        ASSOCIATION_ENDS.add(ASSOCIATION_END_2);
    }

    private static final Attribute ATTRIBUTE_1 = new Attribute(IDENTIFIER, ATTRIBUTE_1_NAME, IDENTIFIER, MULTIPLICITY, new ArrayList<TaggedValue>());
    private static final Attribute ATTRIBUTE_2 = new Attribute(IDENTIFIER, ATTRIBUTE_2_NAME, IDENTIFIER, MULTIPLICITY, new ArrayList<TaggedValue>());
    ...
    public void testAppendClassTypeAttributes() {
        ...
        String part1 = String.format(SelectorDoc.FEATURE, SelectorDoc.ATTRIBUTE, ATTRIBUTE_1_NAME);
        String part2 = String.format(SelectorDoc.FEATURE, SelectorDoc.ATTRIBUTE, ATTRIBUTE_2_NAME);
    ...
    public void testAppendClassTypeAssociations() {
        ...
        String part1 = String.format(SelectorDoc.FEATURE, SelectorDoc.ASSOCIATION, ASSOCIATION_END_1_NAME);
        String part2 = String.format(SelectorDoc.FEATURE, SelectorDoc.ASSOCIATION, ASSOCIATION_END_2_NAME);
        String expectedToString = part1 + part2;
        assertEquals(expectedToString, stringBuffer.toString());
    }
    ...
    public void testGetSelectorDocumentation() {
        ...
        String part2 = String.format(SelectorDoc.FEATURE, SelectorDoc.ATTRIBUTE, ATTRIBUTE_1_NAME);
        String part3 = String.format(SelectorDoc.FEATURE, SelectorDoc.ATTRIBUTE, ATTRIBUTE_2_NAME);
        String part4 = String.format(SelectorDoc.FEATURE, SelectorDoc.ASSOCIATION, ASSOCIATION_END_1_NAME);
        String part5 = String.format(SelectorDoc.FEATURE, SelectorDoc.ASSOCIATION, ASSOCIATION_END_2_NAME);
    ...
    public void testGetModelIndex() throws FileNotFoundException {
        ...
        assertNotNull("Expected non-null MODEL_INDEX", modelIndex);
    }
