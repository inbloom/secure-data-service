...
public interface Level0Client {
    String get(final String token, final URI uri, final String mediaType) throws IOException,
            StatusCodeException;

    void delete(final String token, final URI uri, final String mediaType) throws IOException,
            StatusCodeException;
