...
/**
 * String constants for test results
 *
 * @author chung
 */
public class SampleLiterals {
    ...
    public static final String ERROR_GENERIC = "Error - %s";
    public static final String EXCEPTION_GENERIC = "Exception - %s - see console for stack trace";
