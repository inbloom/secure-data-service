...
public final class NewEntityFromMappableExpr implements JavaSnippetExpr {
    ...
    public NewEntityFromMappableExpr(final JavaType type, final String name) {
        rhs = new NewInstanceExpr(type, new StringLiteralExpr(name), new MappableToMapExpr(new VarNameExpr(name)));
    }
