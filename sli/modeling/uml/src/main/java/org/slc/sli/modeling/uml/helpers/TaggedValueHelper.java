...
public final class TaggedValueHelper {
    ...
    public static final boolean getBooleanTag(final String name, final Taggable element, final Mapper lookup,
    ...
    public static final String getStringTag(final String name, final Taggable element, final Mapper lookup,
    ...
    public static final boolean hasTag(final String name, final Taggable element, final Mapper lookup) {
        for (final TaggedValue taggedValue : element.getTaggedValues()) {
            final TagDefinition tagDefinition = lookup.getTagDefinition(taggedValue.getTagDefinition());
            if (name.equals(tagDefinition.getName())) {
                return true;
