...
public final class ClassType extends NamespaceOwnedElement implements Type {
	...
	public ClassType(final Identifier id, final String name,
			final boolean isAbstract, final List<Attribute> attributes,
		...
		this.attributes = Collections
				.unmodifiableList(new ArrayList<Attribute>(attributes));
	}
