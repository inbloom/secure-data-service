...
module EntitiesHelper
  ...
  def display_edorg_table(entity = nil)
    html ||= ""
    logger.debug{"entity in display_edorg_table is #{entity}"}
    if (entity.nil?)
      html << "<table id=\"edorgcounts_home\" class=\"home_table\"><thead><tr><th>Entity/Role</th><th>Total</th><th>Current</th></tr></thead><tbody>"
    else
     html.append "<table id=\"edorgcounts_#{entity['id']}\" class=\"edOrg\"><thead><tr><th>Entity/Role</th><th>Total</th><th>Current</th></tr></thead><tbody>"
    end
