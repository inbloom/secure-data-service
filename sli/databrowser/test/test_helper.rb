...
class ActiveSupport::TestCase
  ...
  setup do
    ...
    ActiveResource::HttpMock.respond_to do |mock|
      ...
      mock.get "/api/rest/v1/teacher-school-associations/11111111-1111-1111-1111-111111111111/?limit=10&offset=0", {"Accept" => "application/vnd.slc+json"}, [@teacher_fixtures['one'], @teacher_fixtures['two']].to_json, 200, headers
