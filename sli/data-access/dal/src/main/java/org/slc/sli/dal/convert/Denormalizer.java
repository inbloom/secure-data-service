    ...
    public class Denormalization {
            ...
            for (Map.Entry<String, String> entry : denormalizationReferenceKeys.entrySet()) {
                ...
                if ((value == null) || value.isEmpty()) {
                    ...
                    if (cachedEntityRefKey != null) {
                        if ((denormalizationHelperCache != null) && (!denormalizationHelperCache.isEmpty())) {
        ...
        public boolean delete(Entity entity, String id) {
            ...
            return template.getCollection(denormalizeToEntity)
                    .update(parentQuery, buildPullObject(subEntities), true, true, WriteConcern.SAFE).getLastError()
                    .ok();
        }
        ...
        public boolean doUpdate(Entity parentEntity, Update update) {
            ...
            boolean result = template.getCollection(denormalizeToEntity)
                    .update(parentQuery, patchUpdate, false, true, WriteConcern.SAFE).getLastError().ok();
