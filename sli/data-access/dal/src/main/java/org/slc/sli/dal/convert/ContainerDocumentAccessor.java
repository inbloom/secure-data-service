...
public class ContainerDocumentAccessor {
    ...
    public String createParentKey(final ContainerDocument containerDocument) {
        final NaturalKeyDescriptor naturalKeyDescriptor = new NaturalKeyDescriptor(containerDocument.getParentNaturalKeyMap());
    }
}
