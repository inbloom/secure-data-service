...
public class MongoEntityTest {
    ...
    public void testCreateAggregate() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        ...
        CalculatedData data = MongoEntity.fromDBObject(dbObject).getAggregates();
        assertEquals(Arrays.asList(new CalculatedDatum("assessments", "HighestEver", "ACT", "ScaleScore", "28.0")), data.getAggregates());
    }
