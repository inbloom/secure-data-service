...
/**
 *
 * Tell Jackson how to marshal this type.
 *
 */
public class GenericEntitySerializer extends SerializerBase<GenericEntity>  {
	...
	@Override
	public void serialize(GenericEntity entity, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
