...
function generateDataModelSchema {
    cd autogenerated/
    java -jar `ls $SLI_HOME/sli/modeling/docgen/target/docgen-*-jar-with-dependencies.jar` -outFolder . -outFile schema.xml -xmiFile $SLI_HOME/sli/domain/src/main/resources/sliModel/SLI.xmi -domainFile $SLI_HOME/sli/domain/src/main/resources/sliModel/domains.xml
    cd ..
}
