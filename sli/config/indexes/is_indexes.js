...
db["studentAssessmentItem"].ensureIndex({"batchJobId" : 1, "localParentIds.studentAssessmentReference.studentReference.studentUniqueStateId":1, "localParentIds.studentAssessmentReference.administrationDate":1, "localParentIds.studentAssessmentReference.assessmentReference.identificationSystem":1, "localParentIds.studentAssessmentReference.assessmentReference.id":1});
db["studentObjectiveAssessment"].ensureIndex({"batchJobId" : 1, "body.studentAssessmentRef":1});
db["studentObjectiveAssessment"].ensureIndex({"batchJobId" : 1, "body.studentAssessmentReference.studentReference.studentUniqueStateId":1, "body.studentAssessmentReference.administrationDate":1, "body.studentAssessmentReference.assessmentReference.identificationSystem":1, "body.studentAssessmentReference.assessmentReference.id":1});
