...
//ingestion indexes to make up for parallel arrays
db["disciplineAction"].ensureIndex({"metaData.tenantId":1,"body.studentId":1,"body.disciplineDate":1,"body.disciplineActionIdentifier":1});
