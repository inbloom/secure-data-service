...
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"body.gradebookEntryId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"metaData.edOrgs":1,"body.gradebookEntryId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.sectionId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"body.sectionId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"metaData.edOrgs":1,"body.sectionId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.studentId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"body.studentId":1});
db["studentGradebookEntry"].ensureIndex({"metaData.tenantId":1,"metaData.edOrgs":1,"body.studentId":1});
