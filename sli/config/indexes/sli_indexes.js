...
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.metaData.edOrgs":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.metaData.isOrphaned":1,"studentSectionAssociation.metaData.createdBy":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation._id":1,"studentSectionAssociation.metaData.edOrgs":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation._id":1,"studentSectionAssociation.metaData.isOrphaned":1,"studentSectionAssociation.metaData.createdBy":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation._id":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.sectionId":1,"studentSectionAssociation.metaData.edOrgs":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.sectionId":1,"studentSectionAssociation.metaData.isOrphaned":1,"studentSectionAssociation.metaData.createdBy":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.sectionId":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.studentId":1,"studentSectionAssociation.metaData.edOrgs":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.studentId":1,"studentSectionAssociation.metaData.isOrphaned":1,"studentSectionAssociation.metaData.createdBy":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.studentId":1});
...
db["section"].ensureIndex({"studentSectionAssociation.body.sectionId":1});
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.studentId":1,"studentSectionAssociation.body.endDate":1});
...
db["course"].ensureIndex({"metaData.tenantId":1,"body.courseTitle":1,"body.schoolId":1});
...
db["learningStandard"].ensureIndex({"body.learningStandardId.identificationCode": 1, "metaData.tenantId": 1});
db["program"].ensureIndex({"metaData.tenantId":1,"body.programId":1});
...
db["section"].ensureIndex({"studentSectionAssociation.metaData.tenantId":1,"studentSectionAssociation.body.studentId":1,"studentSectionAssociation.body.sectionId":1});
