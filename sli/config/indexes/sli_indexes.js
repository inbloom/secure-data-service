...
db["studentTranscriptAssociation"].ensureIndex({"body.studentId":1, "metaData.tenantId":1, "body.courseId":1});
...
db["userSession"].ensureIndex({"body.appSession.code.expiration":1,"body.appSession.clientId":1,"body.appSession.verified":1,"body.appSession.code.value":1});
...
db["section"].ensureIndex({"body.courseId":1});
...
db["studentSectionAssociation"].ensureIndex({"body.studentId":1});
