...
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"metaData.teacherContext":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"metaData.edOrgs":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"metaData.isOrphaned":1,"metaData.createdBy":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"_id":1,"metaData.teacherContext":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.gradebookEntryId":1,"metaData.edOrgs":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.gradebookEntryId":1,"metaData.isOrphaned":1,"metaData.createdBy":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.gradebookEntryId":1,"metaData.teacherContext":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.sectionId":1,"metaData.edOrgs":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.sectionId":1,"metaData.isOrphaned":1,"metaData.createdBy":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.sectionId":1,"metaData.teacherContext":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.studentId":1,"metaData.edOrgs":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.studentId":1,"metaData.isOrphaned":1,"metaData.createdBy":1});
db["studentSectionGradebookEntry"].ensureIndex({"metaData.tenantId":1,"body.studentId":1,"metaData.teacherContext":1});
