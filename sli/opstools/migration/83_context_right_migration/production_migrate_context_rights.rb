...
@log.info '---------------------------------------------------'
@log.info ' Productions migration script for context rights   '
@log.info ' Default roles will be updated with context rights '
@log.info '---------------------------------------------------'
...
tenants.each do |tenant|
  ...
  @log.info "Adding context right for each default role in db: #{database}"
