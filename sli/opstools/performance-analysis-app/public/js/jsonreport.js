...
var cssText =
  ".jsonreport TABLE { border-collapse:collapse; border: solid 1px #ccc; clear: left; }\r\n" +
    ...
    ".jsonreport DT { margin: 10px 0 5px 0; font: bold 12px Helvetica, Verdana, Arial; width: 250px; clear: left; float: left; display:block; white-space:nowrap; }\r\n" +
    ".jsonreport DD { margin: 5px 10px; font: 12px Arial; padding: 2px; display: block; float: left; }\r\n" +
    ".jsonreport DL DL DT { font: bold 12px Arial; }\r\n" +
    ".jsonreport DL DL DD { font: 12px Arial; }\r\n" +
    ...
    ".jsonreport DL TD DL DT { padding: 2px; margin: 0 10px 0 0; font-weight: bold; font-size: 12px; width: 120px; overflow: hidden; clear: left; float: left; display:block; }\r\n" +
...
".jsonreport H3 { font-size: 12px; margin: 0 0 10px 0; }";
