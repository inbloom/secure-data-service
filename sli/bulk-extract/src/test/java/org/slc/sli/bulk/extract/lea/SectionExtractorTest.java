...
public class SectionExtractorTest {
    ...
    public void testEdorgBasedExtract() throws Exception {
        ...
        Mockito.verify(ex, Mockito.times(3)).extractEmbeddedEntity(Mockito.any(Entity.class), Mockito.any(ExtractFile.class), Mockito.any(String.class), Mockito.any(Predicate.class));
    }
    ...
    public void testMixedExtract() throws Exception {
        ...
        se.extractEntities(null);
        Mockito.verify(ex, Mockito.times(5)).extractEmbeddedEntity(Mockito.any(Entity.class), Mockito.any(ExtractFile.class), Mockito.any(String.class), Mockito.any(Predicate.class));
