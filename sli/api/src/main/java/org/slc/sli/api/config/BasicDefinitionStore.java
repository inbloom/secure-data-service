...
public class BasicDefinitionStore implements EntityDefinitionStore {
	private static final Logger LOG = LoggerFactory
			.getLogger(BasicDefinitionStore.class);
	...
	public void init() {
		...
		factory.makeEntity("aggregation", "aggregations")
				.buildAndRegister(this);
		factory.makeEntity("aggregationDefinition", "aggregationDefinitions")
				.buildAndRegister(this);
		EntityDefinition assessment = factory.makeEntity("assessment",
				"assessments").buildAndRegister(this);
		factory.makeEntity("assessmentFamily", "assessmentFamilies")
				.buildAndRegister(this);
		EntityDefinition course = factory.makeEntity("course", "courses")
				.buildAndRegister(this);
		EntityDefinition school = factory.makeEntity("school", "schools")
				.buildAndRegister(this);
		EntityDefinition section = factory.makeEntity("section", "sections")
				.buildAndRegister(this);
		EntityDefinition session = factory.makeEntity("session", "sessions")
				.buildAndRegister(this);
		EntityDefinition staff = factory.makeEntity("staff").buildAndRegister(
				this);
		EntityDefinition student = factory.makeEntity("student", "students")
				.buildAndRegister(this);
		EntityDefinition teacher = factory.makeEntity("teacher", "teachers")
				.buildAndRegister(this);
		EntityDefinition educationOrganization = factory.makeEntity(
		...
		AssociationDefinition studentSchoolAssociation = factory
				.makeAssoc("studentSchoolAssociation")
				.exposeAs("student-school-associations")
				.storeAs("studentSchoolAssociation")
				.from(student, "getStudent", "getStudents")
				.to(school, "getSchool", "getSchools")
				.calledFromSource("getStudentSchoolAssociations")
		...
		AssociationDefinition teacherSectionAssociation = factory
				.makeAssoc("teacherSectionAssociation")
				.exposeAs("teacher-section-associations")
				.storeAs("teacherSectionAssociation")
				.from(teacher, "getTeacher", "getTeachers")
				.to(section, "getSection", "getSections")
				.calledFromSource("getTeacherSectionAssociations")
				.calledFromTarget("getTeacherSectionAssociations").build();
		addAssocDefinition(teacherSectionAssociation);

		AssociationDefinition studentAssessmentAssociation = factory
				.makeAssoc("studentAssessmentAssociation")
				.exposeAs("student-assessment-associations")
				.storeAs("studentAssessmentAssociation")
				.from(student, "getStudent", "getStudents")
		...
		AssociationDefinition studentSectionAssociation = factory
				.makeAssoc("studentSectionAssociation")
				.exposeAs("student-section-associations")
				.storeAs("studentSectionAssociation")
				.from(student, "getStudent", "getStudents")
				.to(section, "getSection", "getSections")
				.calledFromSource("getStudentSectionAssociations")
		...
		AssociationDefinition teacherSchoolAssociation = factory
				.makeAssoc("teacherSchoolAssociation")
				.exposeAs("teacher-school-associations")
				.storeAs("teacherSchoolAssociation")
				.from(teacher, "getTeacher", "getTeachers")
				.to(school, "getSchool", "getSchools")
				.calledFromSource("getTeacherSchoolAssociations")
		...
		AssociationDefinition educationOrganizationSchoolAssociation = factory
				...
				.from(educationOrganization, "getEducationOrganization",
		...
		AssociationDefinition staffEducationOrganizationAssociation = factory
				...
				.to(educationOrganization, "getEducationOrganization",
						"getEducationOrganizations")
		...
		AssociationDefinition sectionAssessmentAssociation = factory
				.makeAssoc("sectionAssessmentAssociation")
				.exposeAs("section-assessment-associations")
				.storeAs("sectionAssessmentAssociation")
				.from(section, "getSection", "getSections")
				.to(assessment, "getAssessment", "getAssessments")
		...
		AssociationDefinition sectionSchoolAssociation = factory
				.makeAssoc("sectionSchoolAssociation")
				.exposeAs("section-school-associations")
				.storeAs("sectionSchoolAssociation")
				.from(section, "getSection", "getSections")
				.to(school, "getSchool", "getSchools")
				.calledFromSource("getSectionSchoolAssociations")
		...
		AssociationDefinition educationOrganizationAssociation = factory
				...
				.from(educationOrganization, "getEducationOrganizationParent",
						"getEducationOrganizationParents",
						"educationOrganizationParentId")
				.to(educationOrganization, "getEducationOrganizationChild",
						"getEducationOrganizationChilds",
						"educationOrganizationChildId")
				.calledFromSource("getEducationOrganizationAssociations")
				.calledFromTarget("getEducationOrganizationAssociations")
				.build();
		addAssocDefinition(educationOrganizationAssociation);

		AssociationDefinition schoolSessionAssociation = factory
				.makeAssoc("schoolSessionAssociation")
				.exposeAs("school-session-associations")
				.storeAs("schoolSessionAssociation")
				.from(school, "getSchool", "getSchools")
				.to(session, "getSession", "getSessions")
				.calledFromSource("getSchoolSessionAssociations")
				.calledFromTarget("getSchoolSessionAssociations").build();
		addAssocDefinition(schoolSessionAssociation);

		AssociationDefinition sessionCourseAssociation = factory
				.makeAssoc("sessionCourseAssociation")
				.exposeAs("session-course-associations")
				.storeAs("sessionCourseAssociation")
				.from(session, "getSession", "getSessions")
				.to(course, "getCourse", "getCourses")
				.calledFromSource("getSessionCourseAssociations")
				.calledFromTarget("getSessionCourseAssociations").build();
		addAssocDefinition(sessionCourseAssociation);

		// TODO: Known technical-debt to be replaced by internal reference
		// fields (such as
		// section.courseId)
		AssociationDefinition courseSectionAssociation = factory
				.makeAssoc("courseSectionAssociation")
				.exposeAs("course-section-associations")
				.storeAs("courseSectionAssociation")
				.from(course, "getCourse", "getCourses")
				.to(section, "getSection", "getSections")
				.calledFromSource("getCourseSectionAssociations")
				.calledFromTarget("getCourseSectionAssociations").build();
		addAssocDefinition(courseSectionAssociation);

		// Adding the security collection
		EntityDefinition roles = factory.makeEntity("roles").storeAs("roles")
				.build();
		addDefinition(roles);
		...
		addDefinition(factory.makeEntity("application").storeAs("application")
				.build());

		// Adding the OAuth 2.0 Authorized Session Manager (uses Token Manager)
		addDefinition(factory.makeEntity("oauthSession")
				.storeAs("oauthSession").build());
	}
