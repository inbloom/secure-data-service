...
public class TenantMetricsResource {
    ...
    class TenantMetrics extends HashMap<String, CollectionMetrics> {
        
        private static final long serialVersionUID = 5073869887820267156L;
        
        private CollectionMetric allTenants = new CollectionMetric(0, 0.0);
        
        TenantMetrics add(String tenantId, CollectionMetrics metrics) {
            put(tenantId, metrics);
            
            CollectionMetric c = metrics.getTotals();
            allTenants.add(c);
            
            return this;
        }
        
        CollectionMetric getTotals() {
            return allTenants;
        }
    }
