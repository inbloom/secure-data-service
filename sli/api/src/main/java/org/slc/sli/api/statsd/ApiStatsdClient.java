package org.slc.sli.api.statsd;
...
public class ApiStatsdClient {
    ...
    public ApiStatsdClient() {
    }
   
    public ApiStatsdClient(String host, int port) throws UnknownHostException {

        this(InetAddress.getByName(host), port);
    }
    
    private ApiStatsdClient(InetAddress host, int port) {
        try {
