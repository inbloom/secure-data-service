...
public final class EntityNames {
    ...
    public static final String STUDENT_PROGRAM_ASSOCIATION = "studentProgramAssociation";    public static final String STAFF_PROGRAM_ASSOCIATION = "staffProgramAssociation";    public static final String STUDENT_COHORT_ASSOCIATION = "studentCohortAssociation";
