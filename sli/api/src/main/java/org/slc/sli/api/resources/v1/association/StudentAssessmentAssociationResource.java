...
public class StudentAssessmentAssociationResource extends DefaultCrudEndpoint {
    ...
    public Response readAll(@QueryParam(ParameterConstants.OFFSET) @DefaultValue(ParameterConstants.DEFAULT_OFFSET) final int offset,
        ...
        return super.readAll(ResourceNames.STUDENT_ASSESSMENT_ASSOCIATIONS, headers, uriInfo);
    }
    ...
    public Response create(final EntityBody newEntityBody, 
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.create(ResourceNames.STUDENT_ASSESSMENT_ASSOCIATIONS, newEntityBody, headers, uriInfo);
    }
    ...
    public Response read(@PathParam(ParameterConstants.STUDENT_ASSESSMENT_ASSOCIATION_ID) final String studentAssessmentAssociationId,
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.read(ResourceNames.STUDENT_ASSESSMENT_ASSOCIATIONS, studentAssessmentAssociationId, headers, uriInfo);
    }
    ...
    public Response delete(@PathParam(ParameterConstants.STUDENT_ASSESSMENT_ASSOCIATION_ID) final String studentAssessmentAssociationId,
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.delete(ResourceNames.STUDENT_ASSESSMENT_ASSOCIATIONS, studentAssessmentAssociationId, headers, uriInfo);
    }
    ...
    public Response update(@PathParam(ParameterConstants.STUDENT_ASSESSMENT_ASSOCIATION_ID) final String studentAssessmentAssociationId,
            ...
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.update(ResourceNames.STUDENT_ASSESSMENT_ASSOCIATIONS, studentAssessmentAssociationId, newEntityBody, headers, uriInfo);
    }
