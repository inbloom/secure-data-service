...
public class AssociativeContextDefinitions {
     ...
     * <p/>
     * For an API request: the source is SLI Principal's entity type, The target is the type of
     * entity being requested.
     * <p/>
     * The association path will be traversed from from source to target to see if the context path
     * exists.
     */
    @PostConstruct
    public void init() {
