...
public class SearchResourceService {
    ...
    public ServiceResponse list(Resource resource, final String entity, URI queryUri, boolean routeToDefaultApp) {
        ...
        LOG.debug("   resource: {}", ToStringBuilder.reflectionToString(resource, ToStringStyle.MULTI_LINE_STYLE));
        LOG.debug("   entity: {}", entity);
        LOG.debug("   queryUri: {}", ToStringBuilder.reflectionToString(queryUri, ToStringStyle.MULTI_LINE_STYLE));
        LOG.debug("   routeToDefaultApp: {}", routeToDefaultApp);
        ...
        if (moreEntities) {
            ...
            serviceResponse = new ServiceResponse(finalEntities, finalEntities.size() + query.getLimit() + query.getOffset());
        } else {
            serviceResponse = new ServiceResponse(finalEntities, finalEntities.size());
        }

        LOG.debug("   serviceResponse: " + ToStringBuilder.reflectionToString(serviceResponse, ToStringStyle.MULTI_LINE_STYLE));
        LOG.debug("<<<SearchResourceService.list()");
    ...
    private Collection<String> getEntityTypes(Resource resource, String resourceNames) {
        LOG.debug(">>>SearchResourceService.getEntityTypes()");
        LOG.debug("   resource: {}", ToStringBuilder.reflectionToString(resource, ToStringStyle.MULTI_LINE_STYLE));
        LOG.debug("   resourceNames: {}", resourceNames);
