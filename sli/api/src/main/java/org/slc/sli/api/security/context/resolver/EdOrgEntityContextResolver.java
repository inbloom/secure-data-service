...
/**
 * Context resolver that allows all for ed orgs.
 */
@Component
public class EdOrgEntityContextResolver implements EntityContextResolver {
    /**
    ...
    public boolean canResolve(String fromEntityType, String toEntityType) {
        ...
        return EntityNames.EDUCATION_ORGANIZATION.equals(fromEntityType);
    }
}
