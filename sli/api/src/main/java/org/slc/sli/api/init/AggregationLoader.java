...
public class AggregationLoader {
    ...
    private static final String[] DEFINITIONS_FOLDERS = new String[] { "cleanupFunctions" + File.separator,
            "finalizeFunctions" + File.separator, "mapFunctions" + File.separator, "reduceFunctions" + File.separator,
