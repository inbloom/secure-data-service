...
public class TenantResourceImpl extends DefaultCrudEndpoint implements TenantResource {
    ...
    @Override
    public LandingZoneInfo createLandingZone(String tenantId, String edOrgId) throws TenantResourceCreationException {
    ...
    @SuppressWarnings({ "unchecked" })
    protected String createLandingZone(EntityBody newTenant) throws TenantResourceCreationException {
        List<Map<String, Object>> newLzs = (List<Map<String, Object>>) newTenant.get(LZ);
