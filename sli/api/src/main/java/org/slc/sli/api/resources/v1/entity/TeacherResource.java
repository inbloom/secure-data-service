...
public class TeacherResource extends DefaultCrudEndpoint {
    ...
    public Response readAll(@QueryParam(ParameterConstants.OFFSET) @DefaultValue(ParameterConstants.DEFAULT_OFFSET) final int offset,
        ...
        return super.readAll(ResourceNames.TEACHERS, headers, uriInfo);
    }
    ...
    public Response create(final EntityBody newEntityBody, 
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.create(ResourceNames.TEACHERS, newEntityBody, headers, uriInfo);
    }
    ...
    public Response read(@PathParam(ParameterConstants.TEACHER_ID) final String teacherId,
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.read(ResourceNames.TEACHERS, teacherId, headers, uriInfo);
    }
    ...
    public Response delete(@PathParam(ParameterConstants.TEACHER_ID) final String teacherId, 
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.delete(ResourceNames.TEACHERS, teacherId, headers, uriInfo);
    }
    ...
    public Response update(@PathParam(ParameterConstants.TEACHER_ID) final String teacherId,
            ...
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.update(ResourceNames.TEACHERS, teacherId, newEntityBody, headers, uriInfo);
    }
