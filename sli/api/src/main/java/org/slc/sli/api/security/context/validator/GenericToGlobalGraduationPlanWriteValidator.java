...
/**
 * Validates Write context to a global graduation plan.
 */
@Component
public class GenericToGlobalGraduationPlanWriteValidator extends AbstractContextValidator {
    ...
    public boolean validate(String entityType, Set<String> ids) throws IllegalStateException {
        ...
        query.addCriteria(new NeutralCriteria("educationOrganizationId", NeutralCriteria.CRITERIA_IN, edOrgLineage));
