...
//        groups.add(buildRoleGroup(RoleBuilder.makeRole("Student").addRights(new Right[]{Right.READ_PUBLIC, Right.READ_STUDENT_DATA})
//                .addSelfRights(new Right[]{Right.READ_GENERIC}).setAdmin(false).build()));
        return groups;
    }
