...
public class RoleInitializer {
    ...
    public List<Map<String, Object>> getDefaultRoles() {
        ...
        groups.add(buildRoleGroup(RoleBuilder.makeRole("Student").addRights(new Right[]{Right.READ_PUBLIC, Right.READ_STUDENT_GENERAL}).addSelfRights(new Right[]{Right.READ_STUDENT_OWNED}).setAdmin(false).build()));
        return groups;
    }
