...
public interface RoleRightAccess {
     ...
     *
     * @param name
     *            the name of the role you'd like to find (eg: Educator)
     ...
     *
     * @param name
     *            the name of the role (eg: Educator)
     ...
     *
     * @param springName
     *            the name that spring understands this role to have (eg ROLE_EDUCATOR)
     ...
     *
     * @param role
     *            A role that was previously retrieved from the db (Needs the ID)
     * @return a boolean to indicate success or failure.
     */
     ...
     *
     * @param role
     *            an updated role object that was previously retrieved from the db (Needs the id).
