...
public class APITrackingAspect {
    ...
    /** //@Around("call(* org.slc.sli.api..*.*(..)) && !this(APITrackingAspect) && !within(org..*Test) && !within(org..*MongoPerfRepository)")
    public Object trackCallTime(ProceedingJoinPoint pjp) throws Throwable {
        if (Boolean.valueOf(apiCallTracking)) {
