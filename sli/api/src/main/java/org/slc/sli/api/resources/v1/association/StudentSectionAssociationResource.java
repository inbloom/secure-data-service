...
public class StudentSectionAssociationResource extends DefaultCrudEndpoint {
    ...
    public Response readAll(@QueryParam(ParameterConstants.OFFSET) @DefaultValue(ParameterConstants.DEFAULT_OFFSET) final int offset,
        ...
        return super.readAll(ResourceNames.STUDENT_SECTION_ASSOCIATIONS, headers, uriInfo);
    }
    ...
    public Response create(final EntityBody newEntityBody, 
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.create(ResourceNames.STUDENT_SECTION_ASSOCIATIONS, newEntityBody, headers, uriInfo);
    }
    ...
    public Response read(@PathParam(ParameterConstants.STUDENT_SECTION_ASSOCIATION_ID) final String studentSectionAssociationId,
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.read(ResourceNames.STUDENT_SECTION_ASSOCIATIONS, studentSectionAssociationId, headers, uriInfo);
    }
    ...
    public Response delete(@PathParam(ParameterConstants.STUDENT_SECTION_ASSOCIATION_ID) final String studentSectionAssociationId, 
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.delete(ResourceNames.STUDENT_SECTION_ASSOCIATIONS, studentSectionAssociationId, headers, uriInfo);
    }
    ...
    public Response update(@PathParam(ParameterConstants.STUDENT_SECTION_ASSOCIATION_ID) final String studentSectionAssociationId,
            ...
            @Context HttpHeaders headers, @Context final UriInfo uriInfo) {
        return super.update(ResourceNames.STUDENT_SECTION_ASSOCIATIONS, studentSectionAssociationId, newEntityBody, headers, uriInfo);
    }
