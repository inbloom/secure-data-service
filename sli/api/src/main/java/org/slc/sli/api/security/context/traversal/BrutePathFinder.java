...
public class BrutePathFinder implements SecurityPathFinder {
    ...
    public void init() {
        ...
        nodeMap.put(
                EntityNames.TEACHER,
                SecurityNodeBuilder
                        .buildNode(EntityNames.TEACHER, EntityNames.STAFF)
                        ...
                        .addConnection(EntityNames.SCHOOL, "schoolId", ResourceNames.TEACHER_SCHOOL_ASSOCIATIONS,
                                edorgFilter).addConnection(EntityNames.TEACHER_SCHOOL_ASSOCIATION, "teacherId")
                        .construct());
        nodeMap.put(
                EntityNames.SCHOOL,
                SecurityNodeBuilder
                        .buildNode(EntityNames.SCHOOL, EntityNames.EDUCATION_ORGANIZATION)
                        ...
                        .addConnection(EntityNames.SESSION, "sessionId")
        ...
        nodeMap.put(
                ...
                SecurityNodeBuilder.buildNode(EntityNames.SECTION)
                        ...
                        .addConnection(EntityNames.SECTION_ASSESSMENT_ASSOCIATION, "sectionId").construct());
        
        nodeMap.put(
                EntityNames.STUDENT,
                SecurityNodeBuilder
                        .buildNode(EntityNames.STUDENT)
                        ...
                        .addConnection(EntityNames.ASSESSMENT, "assessmentId",
                        ...
                        .addConnection(EntityNames.STUDENT_COHORT_ASSOCIATION, "studentId").construct());
        
        nodeMap.put(
                EntityNames.STAFF,
                SecurityNodeBuilder
                        .buildNode(EntityNames.STAFF)
                        ...
                        .addConnection(EntityNames.STAFF_COHORT_ASSOCIATION, "staffId").construct());
        
        nodeMap.put(
                EntityNames.EDUCATION_ORGANIZATION,
                SecurityNodeBuilder
                        .buildNode(EntityNames.EDUCATION_ORGANIZATION)
                        .addConnection(EntityNames.STAFF, "staffReference",
                                ResourceNames.STAFF_EDUCATION_ORGANIZATION_ASSOCIATIONS)
                        .addConnection(EntityNames.STAFF_ED_ORG_ASSOCIATION, "educationOrganizationReference")
                        .addConnection(EntityNames.STUDENT, "studentId", ResourceNames.STUDENT_SCHOOL_ASSOCIATIONS,
                                studentGracePeriodNodeFilter)
        ...
        nodeMap.put(EntityNames.TEACHER_SECTION_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.TEACHER_SECTION_ASSOCIATION).construct());
        nodeMap.put(EntityNames.TEACHER_SCHOOL_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.TEACHER_SCHOOL_ASSOCIATION).construct());
        ...
        nodeMap.put(
                ...
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_SECTION_ASSOCIATION)
                        ...
                        .addConnection(EntityNames.GRADE, "studentSectionAssociationId", "").construct());
        
        nodeMap.put(EntityNames.STUDENT_ASSESSMENT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_ASSESSMENT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_DISCIPLINE_INCIDENT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_DISCIPLINE_INCIDENT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_PARENT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_PARENT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_SCHOOL_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_SCHOOL_ASSOCIATION).construct());
        ...
        nodeMap.put(EntityNames.REPORT_CARD, SecurityNodeBuilder.buildNode(EntityNames.REPORT_CARD).construct());
        
        nodeMap.put(EntityNames.GRADING_PERIOD, SecurityNodeBuilder.buildNode(EntityNames.GRADING_PERIOD).construct());
        ...
        nodeMap.put(EntityNames.DISCIPLINE_ACTION, SecurityNodeBuilder.buildNode(EntityNames.DISCIPLINE_ACTION)
                .construct());
        nodeMap.put(EntityNames.DISCIPLINE_INCIDENT, SecurityNodeBuilder.buildNode(EntityNames.DISCIPLINE_INCIDENT)
                .construct());
        ...
        nodeMap.put(EntityNames.STUDENT_SECTION_GRADEBOOK_ENTRY,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_SECTION_GRADEBOOK_ENTRY).construct());
        nodeMap.put(EntityNames.GRADEBOOK_ENTRY, SecurityNodeBuilder.buildNode(EntityNames.GRADEBOOK_ENTRY).construct());
        nodeMap.put(EntityNames.STUDENT_ACADEMIC_RECORD,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_ACADEMIC_RECORD).construct());
        nodeMap.put(EntityNames.STUDENT_COMPETENCY, SecurityNodeBuilder.buildNode(EntityNames.STUDENT_COMPETENCY)
                .construct());
        nodeMap.put(EntityNames.GRADE, SecurityNodeBuilder.buildNode(EntityNames.GRADE).construct());
        
        nodeMap.put(EntityNames.STAFF_COHORT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STAFF_COHORT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STAFF_PROGRAM_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STAFF_PROGRAM_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_COHORT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_COHORT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_PROGRAM_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_PROGRAM_ASSOCIATION).construct());
        nodeMap.put(EntityNames.STUDENT_TRANSCRIPT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.STUDENT_TRANSCRIPT_ASSOCIATION).construct());
        nodeMap.put(EntityNames.SECTION_ASSESSMENT_ASSOCIATION,
                SecurityNodeBuilder.buildNode(EntityNames.SECTION_ASSESSMENT_ASSOCIATION).construct());
        ...
        // Arrays.asList(nodeMap.get(EntityNames.STAFF),
        // nodeMap.get(EntityNames.EDUCATION_ORGANIZATION),
        // nodeMap.get(EntityNames.SECTION), nodeMap.get(EntityNames.SESSION),
        // nodeMap.get(EntityNames.SCHOOL_SESSION_ASSOCIATION)));
        
        prePath.put(EntityNames.TEACHER + EntityNames.SCHOOL,
                Arrays.asList(nodeMap.get(EntityNames.TEACHER), nodeMap.get(EntityNames.SCHOOL)));
