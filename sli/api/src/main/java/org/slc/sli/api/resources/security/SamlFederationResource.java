...
public class SamlFederationResource {
    ...
    public Response consume(@FormParam("SAMLResponse") String postData) throws Exception {
        ...
        Pair<String, URI> redirect = this.sessionManager.composeRedirect(inResponseTo, principal);
        
        return Response.temporaryRedirect(redirect.getValue()).cookie(new NewCookie("_tla", samlMessageId, "/", ".slidev.org", "", 300, false)).build();
    }
