...
public class DefaultSelectorStoreTest {
    ...
    public void testSuccessfulLoadOfData() {
        ...
        Map<String, Object> actualType1ResultsMap = defaultSelectorStore.getDefaultSelector("type1");
        Map<String, Object> actualType2ResultsMap = defaultSelectorStore.getDefaultSelector("type2");
        Map<String, Object> actualType3ResultsMap = defaultSelectorStore.getDefaultSelector("type3");
    ...
    public void assertGracefulHandlingOfMissingFile() {
        ...
        assertEquals(defaultSelectorStore.getDefaultSelector("type1"), null);
    }
    ...
    public void testSomewhatSuccessfulLoadOfData() {
        ...
        Map<String, Object> actualType2ResultsMap = defaultSelectorStore.getDefaultSelector("type2");
        Map<String, Object> actualType3ResultsMap = defaultSelectorStore.getDefaultSelector("type3");
        Map<String, Object> actualType4ResultsMap = defaultSelectorStore.getDefaultSelector("type4");
        Map<String, Object> actualType5ResultsMap = defaultSelectorStore.getDefaultSelector("type5");
