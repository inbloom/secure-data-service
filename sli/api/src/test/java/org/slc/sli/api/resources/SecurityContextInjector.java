...
public class SecurityContextInjector {
    ...
    public void setAdminContext() {
        ...
        List roles = Arrays.asList(DefaultRoleRightAccessImpl.IT_ADMINISTRATOR);


        Entity entity = Mockito.mock(Entity.class);
        SLIPrincipal principal = buildPrincipal(user, fullName, roles, entity);
    ...
    private SLIPrincipal buildPrincipal(String user, String fullName, List<String> roles, Entity principalEntity) {
