...
public class EntityServiceLayerTest {
    ...
    private EntityDefinition teacherDef;
    ...
    private EntityService teacherService;
    ...
    public void setUp() {
        ...
        teacherDef = defs.lookupByResourceName("teachers");
        ...
        teacherService = teacherDef.getService();
    ...
    public void testCrudEntity() {
        ...
        EntityBody teacher = new EntityBody();
        teacher.put("firstName", "Richard");
        teacher.put("lastName", "Vernon");
        String teacherId = teacherService.create(teacher);
        assertNotNull(teacherId);
        
        retrievedEntity = teacherService.get(teacherId);
        assertEquals(teacher.get("firstName"), retrievedEntity.get("firstName"));
        assertEquals(teacher.get("lastName"), retrievedEntity.get("lastName"));
        
        teacher = new EntityBody(teacher);
        teacher.put("Tags", "Saturday detention");
        assertTrue(teacherService.update(teacherId, teacher));
        
        retrievedEntity = teacherService.get(teacherId);
        assertEquals(teacher.get("firstName"), retrievedEntity.get("firstName"));
        assertEquals(teacher.get("lastName"), retrievedEntity.get("lastName"));
        assertEquals(teacher.get("Tags"), retrievedEntity.get("Tags"));
