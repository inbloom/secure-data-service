...
/**
 * Unit tests for staff --> student sub-entities context validator.
 *
 * @author shalka
 */
...
//    }
    ...
    @Test
    public void testCanValidateStaffToStudentParentAssociation() throws Exception {
        assertTrue(validator.canValidate(EntityNames.STUDENT_PARENT_ASSOCIATION, false));
    }
    ...
    public void testCanGetAccessToReportCard() {
        ...
        Mockito.when(mockRepo.findAll(Mockito.eq(EntityNames.REPORT_CARD), Mockito.eq(EntityNames.REPORT_CARD), 
    ...
    public void testCanGetAccessToAttendance() throws Exception {
        ...
        Mockito.when(mockRepo.findAll(Mockito.eq(EntityNames.ATTENDANCE), Mockito.eq(EntityNames.ATTENDANCE), Mockito.any(NeutralQuery.class))).thenReturn(
    ...
    public void testCanGetAccessToCurrentStudentSchoolAssociation() throws Exception {
        ...
        Mockito.when(
                mockRepo.findAll(Mockito.eq(EntityNames.STUDENT_SCHOOL_ASSOCIATION), Mockito.eq(EntityNames.STUDENT_SCHOOL_ASSOCIATION), Mockito.any(NeutralQuery.class)))
