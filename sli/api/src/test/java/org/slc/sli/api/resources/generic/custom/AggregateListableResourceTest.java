...
public class AggregateListableResourceTest {

    @Autowired
    private AggregateListableResource aggregateListableResource;
    ...
    public void testGetAggregateResource() throws URISyntaxException {
        ...
        CalculatedDataListingResource<Map<String, Integer>> resource = aggregateListableResource.getAggregateResource(id, uriInfo);
