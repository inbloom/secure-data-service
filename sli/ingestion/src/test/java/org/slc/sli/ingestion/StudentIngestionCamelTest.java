...
public class StudentIngestionCamelTest {
    ...
    public void testDirectRoute() throws Exception {
        ...
        // Set up input file
        String xmlRecords = StudentIngestionTest
                .createStudentInterchangeXml(numberOfStudents);
    ...
    protected RouteBuilder getRouteBuilder2() {
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from(
                        "file:/home/ingestion/lz/inbound?move=/home/ingestion/lz/inbound/.done&moveFailed=.error")
    ...
    private File createTestFile(String xmlRecords, String filePath)
            throws IOException {
