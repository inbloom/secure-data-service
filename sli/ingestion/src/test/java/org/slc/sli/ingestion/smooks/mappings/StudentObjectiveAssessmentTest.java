...
public class StudentObjectiveAssessmentTest {
    ...
    private void checkValidSectionNeutralRecord(NeutralRecord record) {
        ...
        Assert.assertEquals("STA-TAKS-Reading-8-2011-604844", entity.get("sTAReference"));
        Map<String, Object> oaId = (Map<String, Object>) entity.get("oAReference");
        Assert.assertEquals("TAKSReading8-1", oaId.get("oaIdCode"));
    }
}
