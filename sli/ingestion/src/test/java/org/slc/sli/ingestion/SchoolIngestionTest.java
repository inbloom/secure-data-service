...
public class SchoolIngestionTest {
    ...
    @Test
    public void testSchoolIngestionPersistence() throws IOException,
            SAXException {

        schoolRepository.deleteAll();

        int numberOfSchools = 2;
        List<NeutralRecord> neutralRecords = createSchoolIngestionNeutralRecords(
                persistenceProcessor, numberOfSchools);
    ...
    @Test
    public void testSchoolInterchangeXmlParsing() throws IOException,
            SAXException {
    ...
    public static String createSchoolIngestionJson(
            IngestionProcessor ingestionProcessor, int numberOfSchools)
    ...
    public static List<NeutralRecord> createSchoolIngestionNeutralRecords(
            IngestionProcessor ingestionProcessor, int numberOfSchools) {
    ...
    public static String createSchoolXml(School school) {
        ...
        schoolXml += "<StateOrganizationId>" + school.getStateOrganizationId()
                + "</StateOrganizationId>" + "\n";
        schoolXml += "<NameOfInstitution>" + school.getFullName()
                + "</NameOfInstitution>" + "\n";
        schoolXml += "</School>" + "\n";
    ...
    public static void verifySchools(PagingAndSortingRepository<?, Integer> repository,
            long numberOfSchools) {
