...
public class StudentIngestionTest {
    ...
    public static String createStudentXml(Student student) {
        ...
        studentXml += "<Name><FirstName>" + student.getFirstName() + "</FirstName><MiddleName>"
                + student.getMiddleName() + "</MiddleName><LastSurname>" + student.getLastSurname()
                + "</LastSurname></Name>" + "\n";
    ...
    public static void verifyStudents(PagingAndSortingRepository<?, Integer> repository, long numberOfStudents) {
