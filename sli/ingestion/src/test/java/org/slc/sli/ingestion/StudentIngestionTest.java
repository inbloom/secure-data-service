...
public class StudentIngestionTest {
    ...
    @Test
    public void testStudentIngestionPersistence() throws IOException,
            SAXException {

        studentRepository.deleteAll();

        int numberOfStudents = 2;
        List<NeutralRecord> neutralRecords = createStudentIngestionNeutralRecords(
                persistenceProcessor, numberOfStudents);
    ...
    @Test
    public void testStudentInterchangeXmlParsing() throws IOException,
            SAXException {
        ...
        File xmlRecordsFile = IngestionTest.createTestFile(
                IngestionTest.INGESTION_FILE_PREFIX,
    ...
    @Test
    public void testStudentInterchangeCsvParsing() throws IOException,
            SAXException {
        ...
        File csvRecordsFile = IngestionTest.createTestFile(
                IngestionTest.INGESTION_FILE_PREFIX,
                IngestionTest.INGESTION_CSV_FILE_SUFFIX, csvRecords);

        File ingestionEdFiProcessorOutputFile = IngestionTest.createTempFile();

        edFiProcessor.processIngestionStream(csvRecordsFile,
                ingestionEdFiProcessorOutputFile);
    ...
    @Test
    public void testStudentInterchangeCsvFileParsing() throws IOException,
            SAXException {

        studentRepository.deleteAll();

        File csvRecordsFile = IngestionTest
                .getFile("smooks/InterchangeStudent.csv");
    ...
    public static List<NeutralRecord> createStudentIngestionNeutralRecords(
            IngestionProcessor ingestionProcessor, int numberOfStudents) {
    ...
    public static String createStudentIngestionJson(
            IngestionProcessor ingestionProcessor, int numberOfStudents)
    ...
    public static String createStudentXml(Student student) {
        ...
        studentXml += "<StudentUniqueStateId>" + student.getStudentSchoolId()
                + "</StudentUniqueStateId>" + "\n";
        studentXml += "<Name><FirstName>" + student.getFirstName()
                + "</FirstName><MiddleName>" + student.getMiddleName()
                + "</MiddleName><LastSurname>" + student.getLastSurname()
                + "</LastSurname></Name>" + "\n";
        studentXml += "<Sex>" + student.getSex() + "</Sex>" + "\n";
        studentXml += "<BirthData><BirthDate>" + birthDateFormat
                + "</BirthDate></BirthData>" + "\n";
        studentXml += "</Student>" + "\n";
    ...
    public static void verifyStudents(PagingAndSortingRepository<?, Integer> repository,
