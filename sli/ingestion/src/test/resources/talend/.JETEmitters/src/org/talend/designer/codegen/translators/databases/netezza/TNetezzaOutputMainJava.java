...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_367 = NL + "        nb_line_";
  ...
  protected final String TEXT_384 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_385 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_386 = " += pstmt_";
  protected final String TEXT_387 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_388 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_389 = " += pstmt_";
  protected final String TEXT_390 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_391 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_392 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_393 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_394 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_395 = NL + "                }";
  protected final String TEXT_396 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  ...
  protected final String TEXT_401 = NL + "                try {" + NL + "                \t\tpstmt_";
  protected final String TEXT_402 = ".executeBatch();" + NL + "                \t\tpstmt_";
  protected final String TEXT_403 = ".clearBatch();" + NL + "            \t    \t";
  ...
  protected final String TEXT_409 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_410 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_411 = " += pstmt_";
  protected final String TEXT_412 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_413 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_415 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_416 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_417 = NL + "                \tconn_";
  protected final String TEXT_418 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_419 = "=0;" + NL + "                " + NL + "                }\t" + NL + "    " + NL + "    \t";
