...
public class TFTPTruncateBeginJava
{
  ...
  protected final String TEXT_57 = ".add(map";
  protected final String TEXT_58 = ");";
  protected final String TEXT_59 = NL + NL + "  for (java.util.Map<String, String> map";
  protected final String TEXT_60 = " : list";
  protected final String TEXT_61 = ") {" + NL;
  protected final String TEXT_62 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_63 = " = null;" + NL;
  protected final String TEXT_64 = NL + "    ftp_";
  protected final String TEXT_65 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_66 = "\");";
  protected final String TEXT_67 = "    " + NL + "    ftp_";
  protected final String TEXT_68 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_69 = ".setRemoteHost(";
  protected final String TEXT_70 = ");" + NL + "    ftp_";
  protected final String TEXT_71 = ".setRemotePort(";
  protected final String TEXT_72 = ");" + NL;
  protected final String TEXT_73 = NL + "      ftp_";
  protected final String TEXT_74 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_75 = NL + "      ftp_";
  protected final String TEXT_76 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_77 = NL + "    ftp_";
  protected final String TEXT_78 = ".setControlEncoding(";
  protected final String TEXT_79 = ");" + NL + "    ftp_";
  protected final String TEXT_80 = ".connect();" + NL + "    ftp_";
  protected final String TEXT_81 = ".login(";
  protected final String TEXT_82 = ", ";
  protected final String TEXT_83 = "); ";
  protected final String TEXT_84 = " " + NL + "  java.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_85 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL;
  protected final String TEXT_86 = "    " + NL + "    java.util.Map<String,String> map";
  protected final String TEXT_87 = " = new java.util.HashMap<String,String>();" + NL + "    map";
  protected final String TEXT_88 = ".put(";
  protected final String TEXT_89 = ",\"\");" + NL + "    list";
  protected final String TEXT_90 = ".add(map";
  protected final String TEXT_91 = ");       ";
  protected final String TEXT_92 = NL + "  String remotedir";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "  ftp_";
  protected final String TEXT_95 = ".chdir(remotedir";
  protected final String TEXT_96 = ");" + NL + "  String root";
  protected final String TEXT_97 = " = ftp_";
  protected final String TEXT_98 = ".pwd();" + NL + "" + NL + "  for (java.util.Map<String, String> map";
