...
public class TPostgresPlusSCDMainJava {
  ...
  protected final String TEXT_155 = NL + "                nb_line_update_";
  protected final String TEXT_156 = " += updateForType3_";
  protected final String TEXT_157 = ".executeUpdate();";
  protected final String TEXT_158 = NL + "                    System.out.println(\"[";
  protected final String TEXT_159 = "] l3 update done\");";
  protected final String TEXT_160 = NL + "            }";
  protected final String TEXT_161 = NL + "    }" + NL + "    " + NL + "\t} catch (Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_175 = NL + "\t}//end catch" + NL + "    ";
  protected final String TEXT_176 = NL + "                lookUpValue_";
  ...
  protected final String TEXT_191 = NL + "        cache_";
  protected final String TEXT_192 = ".put(lookUpKey_";
