...
public class TNetezzaSCDMainJava {
  ...
  protected final String TEXT_33 = NL + "                    dateStr_";
  protected final String TEXT_34 = " = searchingResult_";
  protected final String TEXT_35 = ".getString(";
  protected final String TEXT_36 = ");" + NL + "                    if(dateStr_";
  protected final String TEXT_37 = " != null) {" + NL + "                        if(!(\"0000-00-00\").equals(dateStr_";
  protected final String TEXT_38 = ") && !(\"0000-00-00 00:00:00\").equals(dateStr_";
  protected final String TEXT_39 = ")) {" + NL + "                            lookUpValue_";
  protected final String TEXT_40 = ".";
  protected final String TEXT_41 = " = new java.util.Date(searchingResult_";
  protected final String TEXT_42 = ".getTimestamp(";
  protected final String TEXT_43 = ").getTime());" + NL + "                        } else {" + NL + "                            lookUpValue_";
  protected final String TEXT_44 = ".";
  protected final String TEXT_45 = " = (java.util.Date) dateYear0_";
  protected final String TEXT_46 = ".clone();" + NL + "                        }" + NL + "                    } else {" + NL + "                        lookUpValue_";
  protected final String TEXT_47 = ".";
  protected final String TEXT_48 = " = null;" + NL + "                    }";
  protected final String TEXT_49 = NL + "                    if(searchingResult_";
  protected final String TEXT_50 = ".getObject(";
  protected final String TEXT_51 = ") != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_52 = ".";
  protected final String TEXT_53 = " = searchingResult_";
  protected final String TEXT_54 = ".get";
  protected final String TEXT_55 = "(";
  protected final String TEXT_56 = ");" + NL + "                    }";
  protected final String TEXT_57 = NL + "        }" + NL + "        searchingResult_";
  protected final String TEXT_58 = ".close();";
  protected final String TEXT_59 = NL + "\ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_60 = " = new SCDSK_";
  protected final String TEXT_61 = "();";
  protected final String TEXT_62 = NL + "            lookUpKey_";
  protected final String TEXT_63 = ".";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ".";
  protected final String TEXT_66 = ";";
  protected final String TEXT_67 = NL + "        lookUpKey_";
  protected final String TEXT_68 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_69 = " = cache_";
  protected final String TEXT_70 = ".get(lookUpKey_";
  protected final String TEXT_71 = ");";
  protected final String TEXT_72 = "    " + NL + "    if(lookUpValue_";
  protected final String TEXT_73 = " == null) {";
  protected final String TEXT_74 = NL + "            lookUpValue_";
  protected final String TEXT_75 = " = new SCDStruct_";
  protected final String TEXT_76 = "();";
  protected final String TEXT_77 = NL + "                lookUpValue_";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = " = 1;";
  protected final String TEXT_80 = NL + "        ";
  protected final String TEXT_81 = NL + "                    ";
  protected final String TEXT_82 = NL + "                    ";
  protected final String TEXT_83 = " skRoutine_";
  ...
  protected final String TEXT_118 = " += updateForType2_";
  protected final String TEXT_119 = ".executeUpdate();";
  protected final String TEXT_120 = NL + "                            ";
  protected final String TEXT_121 = NL + "                            ";
  protected final String TEXT_122 = " skRoutine_";
  protected final String TEXT_123 = " = ";
  protected final String TEXT_124 = ";";
  protected final String TEXT_125 = NL + "                            ";
  protected final String TEXT_126 = "                    ";
  protected final String TEXT_127 = NL + "                            ";
  protected final String TEXT_128 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_129 = "++;";
  protected final String TEXT_130 = NL + "                            ";
  protected final String TEXT_131 = NL + "                        ";
  protected final String TEXT_132 = " maxVersion_";
  protected final String TEXT_133 = " = lookUpValue_";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = " + 1;";
  protected final String TEXT_136 = NL + "                            lookUpValue_";
  ...
  protected final String TEXT_144 = " += insertionStatement_";
  protected final String TEXT_145 = ".executeUpdate();";
  protected final String TEXT_146 = NL + "                    System.out.println(\"[";
  protected final String TEXT_147 = "] new history line\");";
  ...
  protected final String TEXT_160 = NL + "                nb_line_update_";
  protected final String TEXT_161 = " += updateForType3_";
  protected final String TEXT_162 = ".executeUpdate();";
  protected final String TEXT_163 = NL + "                    System.out.println(\"[";
  protected final String TEXT_164 = "] l3 update done\");";
  protected final String TEXT_165 = NL + "            }";
  protected final String TEXT_166 = NL + "    }" + NL + "    " + NL + "\t} catch (Exception e) {//catch" + NL + "  \t\t";
