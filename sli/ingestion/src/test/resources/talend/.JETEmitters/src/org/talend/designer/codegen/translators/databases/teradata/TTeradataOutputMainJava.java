...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_439 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_440 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_441 = ".";
  protected final String TEXT_442 = ", pstmt_";
  ...
  protected final String TEXT_456 = NL + "                globalMap.put(\"";
  protected final String TEXT_457 = "_QUERY\", query_";
  protected final String TEXT_458 = ".toString().trim());";
  protected final String TEXT_459 = NL + "    \t\t";
  protected final String TEXT_460 = NL + "\t    \t\tpstmt_";
  protected final String TEXT_461 = ".addBatch();" + NL + "\t    \t\tnb_line_";
  protected final String TEXT_462 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_463 = NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_464 = "++;" + NL + "\t    \t\t";
  protected final String TEXT_465 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_466 = NL + "    \t\t//////////////////////////////////////" + NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_467 = " = updatedCount_";
  protected final String TEXT_468 = " + pstmt_";
  protected final String TEXT_469 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_470 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_481 = NL + "                        rejectedCount_";
  protected final String TEXT_482 = " = rejectedCount_";
  protected final String TEXT_483 = " + 1;";
  protected final String TEXT_484 = NL + "                        ";
  protected final String TEXT_485 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_486 = ";";
  protected final String TEXT_487 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_528 = " = true;" + NL + "    \t\t\t    ";
  ...
  protected final String TEXT_541 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_542 = ";" + NL + "    \t                    ";
  protected final String TEXT_543 = NL + "    \t                    System.err.print(e.getMessage());" + NL + "    \t                    ";
  protected final String TEXT_544 = NL + "    \t\t\t}" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_545 = NL + "                        ";
  protected final String TEXT_546 = NL + "                            query_";
  protected final String TEXT_547 = " = ";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_550 = ".";
  protected final String TEXT_551 = ", pstmtInsert_";
  protected final String TEXT_552 = ", ";
  protected final String TEXT_553 = ", \"";
  protected final String TEXT_554 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_555 = NL + "                    globalMap.put(\"";
  protected final String TEXT_556 = "_QUERY\", query_";
  protected final String TEXT_557 = ".toString().trim());";
  protected final String TEXT_558 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_559 = " = insertedCount_";
  protected final String TEXT_560 = " + pstmtInsert_";
  protected final String TEXT_561 = ".executeUpdate();" + NL + "    \t\t\t} catch(Exception e) {" + NL + "    \t\t\t    whetherReject_";
  protected final String TEXT_562 = " = true;" + NL + "    \t\t\t    ";
  protected final String TEXT_563 = NL + "    \t                throw(e);" + NL + "    \t                ";
  ...
  protected final String TEXT_602 = NL + "                globalMap.put(\"";
  protected final String TEXT_603 = "_QUERY\", query_";
  protected final String TEXT_604 = ".toString().trim());";
  protected final String TEXT_605 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_606 = "=pstmtUpdate_";
  protected final String TEXT_607 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_608 = " = updatedCount_";
  protected final String TEXT_609 = " + updateFlag_";
  protected final String TEXT_610 = ";" + NL + "        \t} catch(Exception e) {" + NL + "        \t    whetherReject_";
  protected final String TEXT_611 = " = true;" + NL + "        \t    ";
  ...
  protected final String TEXT_628 = NL + "        \t}" + NL + "        \tif(updateFlag_";
  protected final String TEXT_629 = " == 0) {" + NL + "        \t\t";
  protected final String TEXT_630 = NL + "\t\t\t\tquery_";
  protected final String TEXT_631 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_645 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_646 = " = insertedCount_";
  protected final String TEXT_647 = " + pstmtInsert_";
  protected final String TEXT_648 = ".executeUpdate();" + NL + "        \t\t} catch(Exception e) {" + NL + "        \t\t    whetherReject_";
  protected final String TEXT_649 = " = true;" + NL + "        \t\t    ";
  ...
  protected final String TEXT_665 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_666 = NL + "        \t\t}" + NL + "        \t} " + NL + "        \tnb_line_";
  ...
  protected final String TEXT_682 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_683 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_684 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_685 = "    \t\t    \t\t" + NL + "    \t\t";
  protected final String TEXT_686 = NL + "    \t\t//////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_687 = " = deletedCount_";
  protected final String TEXT_688 = " + pstmt_";
  protected final String TEXT_689 = ".executeUpdate();" + NL + "    \t\t} catch(Exception e) {" + NL + "    \t\t    whetherReject_";
  protected final String TEXT_690 = " = true;" + NL + "    \t\t    ";
  ...
  protected final String TEXT_706 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_707 = NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_708 = "++;" + NL + "    \t\t//////////////////////////////////////    \t\t" + NL + "    \t\t";
  protected final String TEXT_709 = NL + NL + "    \t";
  protected final String TEXT_710 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_721 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_722 = " <= batchSizeCounter_";
  protected final String TEXT_723 = ") {                ";
  protected final String TEXT_724 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_725 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_726 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_727 = " += pstmt_";
  protected final String TEXT_728 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_729 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_730 = " += pstmt_";
  protected final String TEXT_731 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_732 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_733 = " += pstmt_";
  protected final String TEXT_734 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_735 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_736 = " = 0;             \t                \t                \t" + NL + "                }catch(java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_737 = NL + "\t\t\t\t\tjava.sql.SQLException e2 = e;" + NL + "\t\t\t\t\twhile (e2 != null) {" + NL + "\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t\te2 = e2.getNextException();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_738 = NL + "                \t";
  protected final String TEXT_739 = NL + "                \tboolean isFailure = false;" + NL + "            \t    while(e != null){" + NL + "            \t    \tif(e.getErrorCode() == -2801){" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t\tSystem.out.println();" + NL + "            \t    \t}" + NL + "            \t    \telse if(e.getErrorCode() == 1339){" + NL + "            \t    \t\tisFailure = true;" + NL + "            \t    \t}" + NL + "            \t    \telse{" + NL + " \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "            \t    \t\te.printStackTrace();" + NL + "            \t    \t}" + NL + "            \t    \te = e.getNextException();" + NL + "            \t    }" + NL + "            \t    if(isFailure){" + NL + "\t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t\t\t            e.printStackTrace();" + NL + "            \t    }" + NL + "            \t\t";
  protected final String TEXT_740 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_741 = "  " + NL + "                }";
  protected final String TEXT_742 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_743 = NL + "                commitCounter_";
  protected final String TEXT_744 = "++;" + NL + "                " + NL + "                if(commitEvery_";
  protected final String TEXT_745 = " <= commitCounter_";
  protected final String TEXT_746 = ") {" + NL + "                " + NL + "                \t";
  protected final String TEXT_747 = NL + "\t\t                try {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_748 = NL + "    \t\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_749 = " > 0 ) {" + NL + "    \t\t\t\t\t\t";
  protected final String TEXT_750 = NL + "\t\t                \t\t    pstmt_";
  protected final String TEXT_751 = ".executeBatch();" + NL + "\t\t            \t    \t";
  protected final String TEXT_752 = NL + "\t\t            \t    \t\tinsertedCount_";
  protected final String TEXT_753 = " += pstmt_";
  protected final String TEXT_754 = ".getUpdateCount();" + NL + "\t\t            \t    \t";
  ...
  protected final String TEXT_763 = "\t" + NL + "\t\t\t\t\t\t\t\t                " + NL + "\t\t                \tconn_";
  protected final String TEXT_764 = ".commit();" + NL + "\t\t                \t" + NL + "\t\t                \tcommitCounter_";
  protected final String TEXT_765 = " = 0;" + NL + "\t\t                \t";
  protected final String TEXT_766 = NL + "\t\t                \tbatchSizeCounter_";
  protected final String TEXT_767 = " = 0;  " + NL + "\t\t                \t";
  protected final String TEXT_768 = NL + "\t\t                }catch(java.sql.SQLException e){" + NL + "\t\t                \t";
  protected final String TEXT_769 = NL + "\t\t\t\t\t\t\tjava.sql.SQLException e2 = e;" + NL + "\t\t\t\t\t\t\twhile (e2 != null) {" + NL + "\t\t\t\t\t\t\t\tSystem.out.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t\te2 = e2.getNextException();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_770 = NL + "\t\t                \t";
  protected final String TEXT_771 = NL + "\t\t                \t boolean isFailure = false;" + NL + "\t\t                \t    while(e != null){" + NL + "\t\t                \t    \tif(e.getErrorCode() == -2801){" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \t\te.printStackTrace();" + NL + "\t\t                \t    \t\tSystem.out.println();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse if(e.getErrorCode() == 1339){" + NL + "\t\t                \t    \t\tisFailure = true;" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \telse{" + NL + "\t\t     \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \t\te.printStackTrace();" + NL + "\t\t                \t    \t}" + NL + "\t\t                \t    \te = e.getNextException();" + NL + "\t\t                \t    }" + NL + "\t\t                \t    if(isFailure){" + NL + "\t\t \t\t\t\t            System.out.println(\" Message: \" + e.getMessage());" + NL + "\t\t                \t    \te.printStackTrace();" + NL + "\t\t                \t    }" + NL + "\t\t                \t    " + NL + "\t\t                \t";
  protected final String TEXT_772 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
