...
public class THiveRowBeginJava
{
  ...
  protected final String TEXT_8 = " = \"jdbc:hive://\" + ";
  ...
  protected final String TEXT_15 = ";    " + NL + "\tjava.lang.Class.forName(\"";
  ...
  protected final String TEXT_22 = NL + "        if(conn_";
  protected final String TEXT_23 = ".getAutoCommit()) {" + NL + "            conn_";
  protected final String TEXT_24 = ".setAutoCommit(false);" + NL + "        }        " + NL + "        int commitEvery_";
  protected final String TEXT_25 = " = ";
  protected final String TEXT_26 = ";" + NL + "        int commitCounter_";
