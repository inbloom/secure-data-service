...
public class TFirebirdInputBeginJava
{
  ...
  protected final String TEXT_147 = ".getPrecision(i));" + NL + "                \tdcm_";
  protected final String TEXT_148 = ".setPrecision(rsmd_";
  protected final String TEXT_149 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_150 = ".setNullable(rsmd_";
  protected final String TEXT_151 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_152 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_153 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_154 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_155 = ".metadatas.add(dcm_";
  protected final String TEXT_156 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_157 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_158 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_159 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_160 = "++;" + NL + "\t\t        ";
  protected final String TEXT_161 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_172 = " = (List)rs_";
  protected final String TEXT_173 = ".getObject(";
  protected final String TEXT_174 = ");";
  protected final String TEXT_175 = NL + "\t\t                         ";
  protected final String TEXT_176 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_177 = ".getObject(";
  protected final String TEXT_178 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_179 = NL + "                                    ";
  protected final String TEXT_180 = ".";
  protected final String TEXT_181 = " = new Geometry(wktValue);";
  protected final String TEXT_182 = NL + "                                        ";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = ".setEPSG(";
  protected final String TEXT_185 = ");";
  protected final String TEXT_186 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_187 = NL + "                                  ";
  protected final String TEXT_188 = ".";
  protected final String TEXT_189 = "=dcg_";
  protected final String TEXT_190 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_191 = ".";
  protected final String TEXT_192 = ", rs_";
  protected final String TEXT_193 = ", fixedColumnCount_";
  protected final String TEXT_194 = ");";
  protected final String TEXT_195 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_196 = ".getObject(";
  protected final String TEXT_197 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = " = new Geometry(sb.toString());";
