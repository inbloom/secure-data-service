...
public class TSybaseSPMainJava
{
  ...
  protected final String TEXT_48 = ".getResultSet();";
  protected final String TEXT_49 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_50 = " = statement_";
  protected final String TEXT_51 = ".getString(";
  protected final String TEXT_52 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_53 = " != null && tmpString_";
  protected final String TEXT_54 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_55 = ".";
  protected final String TEXT_56 = " = tmpString_";
  protected final String TEXT_57 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_59 = " = statement_";
  protected final String TEXT_60 = ".getDate(";
  protected final String TEXT_61 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_62 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_63 = ".";
  protected final String TEXT_64 = " = new java.util.Date(tmpDate_";
  ...
  protected final String TEXT_72 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_73 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_86 = NL + "\t\t// No code generated: define a schema for ";
