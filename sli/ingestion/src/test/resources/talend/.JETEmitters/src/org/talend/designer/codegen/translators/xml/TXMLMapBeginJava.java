...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_63 = NL + "// ###############################" + NL + "// # Outputs initialization";
  protected final String TEXT_64 = NL;
  protected final String TEXT_65 = " ";
  protected final String TEXT_66 = "_tmp = new ";
  protected final String TEXT_67 = "();";
  protected final String TEXT_68 = NL;
  protected final String TEXT_69 = " ";
  protected final String TEXT_70 = "_save = null;";
  protected final String TEXT_71 = NL + "// ###############################";
  protected final String TEXT_72 = NL + "\t\t\tTreeNode_API_";
  protected final String TEXT_73 = " treeNodeAPI_";
  protected final String TEXT_74 = " = new TreeNode_API_";
  protected final String TEXT_75 = "();" + NL + "\t\t\tNameSpaceTool_";
  protected final String TEXT_76 = " nsTool_";
  protected final String TEXT_77 = " = new NameSpaceTool_";
  ...
  protected final String TEXT_86 = ".content().size() == 0 " + NL + "\t\t\t&& ";
  protected final String TEXT_87 = ".attributes().size() == 0 " + NL + "\t\t\t&& ";
  protected final String TEXT_88 = ".declaredNamespaces().size() == 0) {";
  protected final String TEXT_89 = NL + "            ";
  protected final String TEXT_90 = ".remove(";
  protected final String TEXT_91 = ");" + NL + "        }";
  protected final String TEXT_92 = NL + "valueMap.put(\"";
  protected final String TEXT_93 = "\",";
  protected final String TEXT_94 = ");" + NL + "if(valueMap.get(\"";
  protected final String TEXT_95 = "\")!=null) {//open if 8080";
  protected final String TEXT_96 = NL;
  protected final String TEXT_97 = ".addNamespace(\"";
  protected final String TEXT_98 = "\", TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_99 = ",";
  protected final String TEXT_100 = ")));";
  protected final String TEXT_101 = NL;
  protected final String TEXT_102 = ".addNamespace(\"";
  protected final String TEXT_103 = "\", TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_104 = "\"));";
  protected final String TEXT_105 = NL + "        \t";
  protected final String TEXT_106 = ".setQName(org.dom4j.DocumentHelper.createQName(";
  protected final String TEXT_107 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  ...
  protected final String TEXT_112 = ".getName()," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_113 = "\"))));";
  protected final String TEXT_114 = NL + "        \t";
  protected final String TEXT_115 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_116 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_117 = "\",TalendString.replaceSpecialCharForXML(FormatterUtils.format(";
  protected final String TEXT_118 = ",";
  protected final String TEXT_119 = ")))));" + NL + "}//close if 8080";
  protected final String TEXT_120 = NL + "        \t";
  protected final String TEXT_121 = ".setQName(org.dom4j.DocumentHelper.createQName(\"";
  protected final String TEXT_122 = "\"," + NL + "        \torg.dom4j.DocumentHelper.createNamespace(\"";
  protected final String TEXT_123 = "\",TalendString.replaceSpecialCharForXML(\"";
  protected final String TEXT_124 = "\"))));";
  protected final String TEXT_125 = NL + "\t\torg.dom4j.Element ";
  ...
  protected final String TEXT_131 = ".addElement(\"";
  protected final String TEXT_132 = "\");" + NL + "        } else {" + NL + "        \t";
  protected final String TEXT_133 = " = ";
  protected final String TEXT_134 = ".addElement(\"";
  protected final String TEXT_135 = "\");" + NL + "        }";
  protected final String TEXT_136 = NL + "\t\t\t\torg.dom4j.Element ";
  protected final String TEXT_137 = " = org.dom4j.DocumentHelper.createElement(\"";
  ...
  protected final String TEXT_202 = NL + "class GenerateDocument_";
  protected final String TEXT_203 = " {" + NL;
  protected final String TEXT_204 = NL + "\t\tTreeNode_API_";
  protected final String TEXT_205 = " treeNodeAPI = null;";
  protected final String TEXT_206 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\tDocumentGenerateOrderHelper orderHelper = new DocumentGenerateOrderHelper(";
  protected final String TEXT_207 = ");" + NL + "\t\t" + NL + "\torg.dom4j.Document doc = null;" + NL + "\t" + NL + "\tNestXMLTool_";
  protected final String TEXT_208 = " nestXMLTool = null;" + NL + "\t" + NL + "\torg.dom4j.Element root4Group = null;" + NL + "\t" + NL + "\torg.dom4j.io.OutputFormat format = null;" + NL + "\t" + NL + "\tjava.util.List<java.util.List<String>> groupbyList = null;" + NL + "\tjava.util.List<org.dom4j.Element> groupElementList = null;" + NL + "\tint order = 0;" + NL + "\t" + NL + "\tboolean isFirst = true;" + NL + "\t" + NL + "\tboolean\tneedRoot = true;";
  protected final String TEXT_209 = NL + "\t" + NL + "    public GenerateDocument_";
  protected final String TEXT_210 = "() {" + NL + "//    \tthis.treeNodeAPI = treeNodeAPI;" + NL + "    \t" + NL + "    \tvalueMap = new java.util.HashMap<String,Object>();" + NL + "    \t" + NL + "    \tnestXMLTool = new NestXMLTool_";
  ...
  protected final String TEXT_212 = NL + "\t\tnestXMLTool.removeEmptyElement(this.doc.getRootElement());";
  protected final String TEXT_213 = NL + "    }" + NL + "\t" + NL + "\t//We generate the TreeNode_API object only if there is a document in the main input table." + NL + "    void generateElements(";
  protected final String TEXT_214 = "TreeNode_API_";
  protected final String TEXT_215 = " treeNodeAPI,";
  protected final String TEXT_216 = "boolean isInnerJoin";
  protected final String TEXT_217 = ", ";
  protected final String TEXT_218 = " ";
  protected final String TEXT_219 = NL + "\t";
  protected final String TEXT_220 = ") {" + NL + "\t" + NL + "\t" + NL + "\t/*if(this.treeNodeAPI==null) {" + NL + "\t\tthis.treeNodeAPI = treeNodeAPI;" + NL + "\t}*/" + NL + "\t" + NL + "\torg.dom4j.Element subTreeRootParent = null;" + NL + "// build root xml tree " + NL + "if (needRoot) {" + NL + "\tneedRoot=false;";
  protected final String TEXT_221 = NL + "\t\troot4Group = subTreeRootParent;" + NL + "\t}else{" + NL + "\t\tsubTreeRootParent=root4Group;" + NL + "\t}" + NL + "\t/* build group xml tree */" + NL + "\tboolean isNewElement = false;";
  protected final String TEXT_222 = NL + "\t\tisNewElement = false;";
  protected final String TEXT_223 = NL + "\t\t\t\tif(true){" + NL + "\t\t\t\t\tthrow new Exception(\"Loop element is missing in the output Table:";
  protected final String TEXT_224 = "!\");" + NL + "\t\t\t\t}";
  protected final String TEXT_225 = NL + "\t\t}" + NL + "    }" + NL;
  protected final String TEXT_226 = NL;
  protected final String TEXT_227 = NL + "\t            class SortableRow_";
  protected final String TEXT_228 = " implements Comparable<SortableRow_";
  protected final String TEXT_229 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_230 = "> { // G_TM_B_001 " + NL + "\t" + NL + "\t\t\t\t\tboolean is__rejectedInnerJoin;" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_239 = NL + "\t\t\t        public void fillFrom(";
  protected final String TEXT_240 = " ";
  protected final String TEXT_241 = "Struct ";
  protected final String TEXT_242 = " ";
  protected final String TEXT_243 = " exprKey_";
  ...
  protected final String TEXT_252 = "this.exprKey_";
  protected final String TEXT_253 = "__";
  protected final String TEXT_254 = " = exprKey_";
  protected final String TEXT_255 = "__";
  protected final String TEXT_256 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_257 = NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        public void copyDataTo(";
  ...
  protected final String TEXT_264 = NL + "\t\t\t        }" + NL + "\t\t\t\t\tpublic String toString() {" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\t\t\t\t\tsb.append(super.toString());" + NL + "\t\t\t\t\t\tsb.append(\"[\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_265 = NL + "\t\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_266 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_268 = "__";
  protected final String TEXT_269 = "\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_270 = "__";
  protected final String TEXT_271 = "));" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_272 = NL + "\t\t\t\t\t\tsb.append(\"]\");" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\treturn sb.toString();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_273 = " other) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            ";
  protected final String TEXT_274 = NL + "\t\t\t            \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_275 = "__";
  protected final String TEXT_276 = ", other.exprKey_";
  protected final String TEXT_277 = "__";
  protected final String TEXT_278 = ");" + NL + "\t\t\t            \tif (returnValue != 0) {" + NL + "\t\t\t                    return returnValue;" + NL + "\t\t\t            \t}" + NL + "\t\t\t            ";
  protected final String TEXT_279 = NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "\t\t\t            int returnValue = 0;" + NL + "\t\t\t            if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "\t\t\t                returnValue = ((Comparable) object1).compareTo(object2);" + NL + "\t\t\t            } else if (object1 != null && object2 != null) {" + NL + "\t\t\t                returnValue = compareStrings(object1.toString(), object2" + NL + "\t\t\t                        .toString());" + NL + "\t\t\t            } else if (object1 == null && object2 != null) {" + NL + "\t\t\t                returnValue = 1;" + NL + "\t\t\t            } else if (object1 != null && object2 == null) {" + NL + "\t\t\t                returnValue = -1;" + NL + "\t\t\t            } else {" + NL + "\t\t\t                returnValue = 0;" + NL + "\t\t\t            }" + NL + "\t\t\t            return returnValue;" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t        private int compareStrings(String string1, String string2) {" + NL + "\t\t\t            return string1.compareTo(string2);" + NL + "\t\t\t        }" + NL + "\t\t\t" + NL + "\t\t\t\t\tpublic void readData(ObjectInputStream dis) {" + NL + "\t\t\t\t\t\tsynchronized(";
  protected final String TEXT_280 = "Struct.commonByteArrayLock) {" + NL + "\t\t\t\t\t\t    try {" + NL + "\t\t\t\t\t\t\t\tint length = 0;" + NL + "\t\t\t\t\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t            this.";
  protected final String TEXT_282 = "__";
  protected final String TEXT_283 = " = dis.read";
  protected final String TEXT_284 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_285 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_286 = "__";
  protected final String TEXT_287 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_288 = "Struct.commonByteArray.length) {" + NL + "\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_289 = "Struct.commonByteArray.length == 0) {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_290 = "Struct.commonByteArray = new byte[1024];" + NL + "\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t           \t\t\t\t\t";
  protected final String TEXT_291 = "Struct.commonByteArray = new byte[2 * length];" + NL + "\t\t\t           \t\t\t\t}" + NL + "\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_292 = "Struct.commonByteArray, 0, length);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_293 = "__";
  protected final String TEXT_294 = " = new String(";
  protected final String TEXT_295 = "Struct.commonByteArray, 0, length);" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_296 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_297 = "__";
  protected final String TEXT_298 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.";
  protected final String TEXT_299 = "__";
  protected final String TEXT_300 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_302 = "__";
  protected final String TEXT_303 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.";
  protected final String TEXT_304 = "__";
  protected final String TEXT_305 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_307 = "__";
  protected final String TEXT_308 = " = (";
  protected final String TEXT_309 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.";
  protected final String TEXT_311 = "__";
  protected final String TEXT_312 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.";
  protected final String TEXT_313 = "__";
  protected final String TEXT_314 = " = dis.read";
  protected final String TEXT_315 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_316 = NL + "\t\t\t            ";
  protected final String TEXT_317 = NL + "\t\t\t\t            this.exprKey_";
  protected final String TEXT_318 = "__";
  protected final String TEXT_319 = " = dis.read";
  protected final String TEXT_320 = "();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_322 = "__";
  protected final String TEXT_323 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tthis.exprKey_";
  protected final String TEXT_324 = "__";
  protected final String TEXT_325 = " = new Date(dis.readLong());" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_326 = NL + "\t\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_327 = "__";
  protected final String TEXT_328 = " = null;" + NL + "\t\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t\t   \t\t\t\t\tif(length > ";
  protected final String TEXT_329 = "Struct.commonByteArray.length) {" + NL + "\t\t\t\t   \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_330 = "Struct.commonByteArray.length == 0) {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_331 = "Struct.commonByteArray = new byte[1024];" + NL + "\t\t\t\t   \t\t\t\t\t\t} else {" + NL + "\t\t\t\t           \t\t\t\t\t";
  protected final String TEXT_332 = "Struct.commonByteArray = new byte[2 * length];" + NL + "\t\t\t\t           \t\t\t\t}" + NL + "\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t       \t\t\t\tdis.readFully(";
  protected final String TEXT_333 = "Struct.commonByteArray, 0, length);" + NL + "\t\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_334 = "__";
  protected final String TEXT_335 = " = new String(";
  protected final String TEXT_336 = "Struct.commonByteArray, 0, length);" + NL + "\t\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\t            length = dis.readInt();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_338 = "__";
  protected final String TEXT_339 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "\t\t\t       \t\t\t\tdis.readFully(byteArray);" + NL + "\t\t\t       \t\t\t\tthis.exprKey_";
  protected final String TEXT_340 = "__";
  protected final String TEXT_341 = " = byteArray;" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_342 = NL + "\t\t\t   \t\t\t\tthis.exprKey_";
  protected final String TEXT_343 = "__";
  protected final String TEXT_344 = " = (";
  protected final String TEXT_345 = ") dis.readObject();" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_346 = NL + "\t\t\t\t            length = dis.readByte();" + NL + "\t\t\t   \t\t\t\tif (length == -1) {" + NL + "\t\t\t   \t    \t\t\tthis.exprKey_";
  protected final String TEXT_347 = "__";
  protected final String TEXT_348 = " = null;" + NL + "\t\t\t   \t\t\t\t} else {" + NL + "\t\t\t   \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_349 = "__";
  protected final String TEXT_350 = " = dis.read";
  protected final String TEXT_351 = "();" + NL + "\t\t\t   \t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_352 = NL + "\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t";
  protected final String TEXT_353 = NL + "\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\t\t    \t}" + NL + "\t\t\t\t\t\t} " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\tpublic void writeData(ObjectOutputStream dos) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t   \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "\t\t\t\t\t";
  protected final String TEXT_356 = NL + "\t\t\t            \tdos.write";
  protected final String TEXT_357 = "(this.";
  protected final String TEXT_358 = "__";
  protected final String TEXT_359 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_360 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_361 = "__";
  protected final String TEXT_362 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_363 = "__";
  protected final String TEXT_364 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_365 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_366 = "__";
  protected final String TEXT_367 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_368 = "__";
  protected final String TEXT_369 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_371 = "__";
  protected final String TEXT_372 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_373 = "__";
  protected final String TEXT_374 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.";
  protected final String TEXT_375 = "__";
  protected final String TEXT_376 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_378 = "__";
  protected final String TEXT_379 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\t\t\t\t\tif(this.";
  protected final String TEXT_381 = "__";
  protected final String TEXT_382 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_383 = "(this.";
  protected final String TEXT_384 = "__";
  protected final String TEXT_385 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t            ";
  protected final String TEXT_387 = NL + "\t\t\t\t            dos.write";
  protected final String TEXT_388 = "(this.exprKey_";
  protected final String TEXT_389 = "__";
  protected final String TEXT_390 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_392 = "__";
  protected final String TEXT_393 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_394 = "__";
  protected final String TEXT_395 = ".getBytes();" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "\t\t\t       \t\t\t\tdos.write(byteArray);" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_396 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_397 = "__";
  protected final String TEXT_398 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_399 = "__";
  protected final String TEXT_400 = ".getTime());" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_402 = "__";
  protected final String TEXT_403 = " == null) {" + NL + "\t\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t   \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_404 = "__";
  protected final String TEXT_405 = ".length);" + NL + "\t\t\t       \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_406 = "__";
  protected final String TEXT_407 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_408 = NL + "\t\t\t\t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_409 = "__";
  protected final String TEXT_410 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_411 = NL + "\t\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_412 = "__";
  protected final String TEXT_413 = " == null) {" + NL + "\t\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t\t} else {" + NL + "\t\t\t       \t\t\t\tdos.writeByte(0);" + NL + "\t\t\t   \t\t\t    \tdos.write";
  protected final String TEXT_414 = "(this.exprKey_";
  protected final String TEXT_415 = "__";
  protected final String TEXT_416 = ");" + NL + "\t\t\t            \t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_417 = NL + "\t\t\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t        throw new RuntimeException(e);" + NL + "\t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t    }" + NL + "\t\t\t}" + NL + "\t     }" + NL + "\t   ";
