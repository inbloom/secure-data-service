...
public class TMysqlSCDELTBeginJava {
  ...
  protected final String TEXT_143 = " + \".NEXTVAL, ";
  protected final String TEXT_144 = "t.";
  protected final String TEXT_145 = ", '\" + " + NL + "        (changeDateTime_";
  ...
  protected final String TEXT_155 = "` = '\" + (changeDateTime_";
  ...
  protected final String TEXT_172 = " + \".NEXTVAL, ";
  protected final String TEXT_173 = "t.";
  protected final String TEXT_174 = "\"";
  protected final String TEXT_175 = " + \", '\" + (changeDateTime_";
