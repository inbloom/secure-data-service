...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_205 = ".getPrecision(i));" + NL + "                \tdcm_";
  protected final String TEXT_206 = ".setPrecision(rsmd_";
  protected final String TEXT_207 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_208 = ".setNullable(rsmd_";
  protected final String TEXT_209 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_210 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_211 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_212 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_213 = ".metadatas.add(dcm_";
  protected final String TEXT_214 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_215 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_216 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_217 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_218 = "++;" + NL + "\t\t        ";
  protected final String TEXT_219 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  protected final String TEXT_220 = " < ";
  protected final String TEXT_221 = ") { \t\t" + NL + "\t\t                        ";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = " = ";
  protected final String TEXT_224 = "; \t\t\t" + NL + "\t\t                    } else {";
  ...
  protected final String TEXT_248 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_249 = ".";
  protected final String TEXT_250 = ", rs_";
  protected final String TEXT_251 = ", fixedColumnCount_";
  protected final String TEXT_252 = ");";
  protected final String TEXT_253 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_254 = ".getObject(";
  protected final String TEXT_255 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_256 = ".";
  protected final String TEXT_257 = " = new Geometry(sb.toString());";
