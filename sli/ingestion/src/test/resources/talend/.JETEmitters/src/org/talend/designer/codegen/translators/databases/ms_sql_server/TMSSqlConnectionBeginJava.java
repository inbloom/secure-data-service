...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_40 = NL + "\t" + NL + "\tString password_";
  ...
  protected final String TEXT_48 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_49 = "\", ";
  protected final String TEXT_50 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_51 = "\",  ";
  protected final String TEXT_52 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_53 = "\",conn_";
  protected final String TEXT_54 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
