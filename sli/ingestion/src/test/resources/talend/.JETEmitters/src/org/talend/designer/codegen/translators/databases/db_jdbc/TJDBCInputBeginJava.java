...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_173 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_184 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_185 = ".next()) {" + NL + "\t\t        nb_line_";
  ...
  protected final String TEXT_216 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_217 = ".";
  protected final String TEXT_218 = ", rs_";
  protected final String TEXT_219 = ", fixedColumnCount_";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_222 = ".getObject(";
  protected final String TEXT_223 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = " = new Geometry(sb.toString());";
