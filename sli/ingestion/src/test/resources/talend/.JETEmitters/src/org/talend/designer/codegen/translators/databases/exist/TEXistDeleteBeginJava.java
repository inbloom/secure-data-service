...
public class TEXistDeleteBeginJava
{
  ...
  protected final String TEXT_18 = " = 0;" + NL + "\torg.xmldb.api.modules.CollectionManagementService mgtService_";
  protected final String TEXT_19 = " = (org.xmldb.api.modules.CollectionManagementService) col_";
  protected final String TEXT_20 = ".getService(\"CollectionManagementService\",\"1.0\");" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_21 = " = new java.util.ArrayList<java.util.Map<String,String>>();";
  ...
  protected final String TEXT_32 = NL + NL + "\t\tfor(java.util.Map<String, String> map_";
