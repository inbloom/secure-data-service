...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_172 = ".getPrecision(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_215 = ";" + NL + "                                  routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_216 = ".";
  protected final String TEXT_217 = ", rs_";
  protected final String TEXT_218 = ", fixedColumnCount_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_221 = ".getObject(";
  protected final String TEXT_222 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_223 = ".";
  protected final String TEXT_224 = " = new Geometry(sb.toString());";
