...
public class ControlFile {
    ...
    public static class FileEntry {
        ...
        public FileEntry(FileFormat fileFormat, FileType fileType, String fileName, String checksum) {
        ...
        try {
            while (scanner.hasNextLine()) {
                ...
                if (fileItemMatcher.matches()) {
                    ...
                    fileEntries.add(new FileEntry(fileFormat, fileType, fileItemMatcher.group(3), fileItemMatcher
                            .group(4)));
                    continue;
                }
     ...
     */
    protected ControlFile(File file, List<FileEntry> fileEntries, Properties configProperties) {
        this.file = file;
