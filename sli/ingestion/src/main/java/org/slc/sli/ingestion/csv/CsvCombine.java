...
public class CsvCombine {
     ...
     */
    private NeutralRecord createNeutralRecord(DBObject dbElement, String entityName, ArrayList<DBCollection> supportingCollections) {
     ...
     */
    private Map<String, Object> parseDbElement(DBObject dbElement, int joinKey, String entityName, ArrayList<DBCollection> supportingCollections) {
        	...
        	for (Iterator<DBCollection> iter = supportingCollections.iterator(); iter.hasNext();) {
        		String collectionName = iter.next().toString();
       			if (collectionName.lastIndexOf("_") == entityName.length()) {
       				...
       				addMapEntry(listName, getListFromCollection(entityName, collectionName, joinKey, supportingCollections), result);
       			}
        	}        
        }
        return result;//
     ...
     */
    private List<Object> getListFromCollection(String entityName, String collectionName, int parentJoinKey, ArrayList<DBCollection> supportingCollections) {
