...
import org.slc.sli.ingestion.landingzone.handler.AbstractIngestionHandler;
...
public class EdFiProcessor implements Processor {
    ...
    private Map<FileFormat, AbstractIngestionHandler<IngestionFileEntry>> fileHandlerMap;
    ...
    public void processFileEntry(IngestionFileEntry fe) {
        ...
        if (fe.getFileType() != null) {
            ...
            AbstractIngestionHandler<IngestionFileEntry> fileHandler = fileHandlerMap.get(fileFormat);
            if (fileHandler != null) {
    ...
    public void setFileHandlerMap(Map<FileFormat, AbstractIngestionHandler<IngestionFileEntry>> fileHandlerMap) {
