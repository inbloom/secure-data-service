...
public class EdFiProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws IOException, SAXException {
        ...
        for (IngestionFileEntry fe : job.getFiles()) {
            ...
            this.processIngestionStream(fe, outputFile);

            fe.setNeutralRecordFile(outputFile);
        }
        ...
        // Log statistics
        log.info("Translated Ingestion files for batch job [{}] in {} ms", job, endTime - startTime);
