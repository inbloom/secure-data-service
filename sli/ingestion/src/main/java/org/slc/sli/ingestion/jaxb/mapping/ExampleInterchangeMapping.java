...
public class ExampleInterchangeMapping {
    ...
    public void testUnmarshal() throws JAXBException, IOException {
        ...
        Unmarshaller u = MappingUtils.createEdFiUnmarshaller();

        // unmarshal file
        /*
        InterchangeAssessmentMetadata interchangeAssessmentMetadata = (InterchangeAssessmentMetadata) u
                .unmarshal(JaxbTest.class.getClassLoader().getResourceAsStream(assessmentInterchangeFile));

        for (org.slc.sli.domain.edfi.ComplexObjectType assessmentComplexObject : interchangeAssessmentMetadata
            ...
            if (assessmentComplexObject instanceof Assessment) {
                ...
                org.slc.sli.domain.sli.StudentAssessmentAssociation sliAssessment = StudentAssessmentAssociationMapping
