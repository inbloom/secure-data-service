...
public class AttendanceTransformerTest {
    ...
    private static final String SESSION_SCHOOL_ID = "EducationOrganizationReference.EducationalOrgIdentity.StateOrganizationId._value";
    ...
    public void testGetSession() throws Throwable {
        ...
        q1.addCriteria(Criteria.where("batchJobId").is(batchJobId));
        q1.addCriteria(Criteria.where("body.StateOrganizationId._value").is("schoolId1"));
    ...
    public void testPerformTransformation() throws IOException {
        //generate attendance
        when(repository.findAllByQuery(Mockito.eq("attendanceEvent"), Mockito.any(Query.class)))
        ...
        q2.addCriteria(Criteria.where("body.StateOrganizationId._value").is("schoolId2"));
        ...
        q.addCriteria(Criteria.where("body.StudentReference.StudentIdentity.StudentUniqueStateId._value" ).is("studentId2"));
        ...
        query1.addCriteria(new NeutralCriteria("SchoolReference.EducationalOrgIdentity.StateOrganizationId._value", NeutralCriteria.OPERATOR_EQUAL, "schoolId1"));
        ...
        queryRh1.addCriteria(new NeutralCriteria("StudentReference.StudentIdentity.StudentUniqueStateId._value", NeutralCriteria.OPERATOR_EQUAL, "studentId1"));
        queryRh1.addCriteria(new NeutralCriteria("SchoolReference.EducationalOrgIdentity.StateOrganizationId._value", NeutralCriteria.OPERATOR_EQUAL, "schoolId1"));

        Mockito.verify(repository, Mockito.times(1))
            .updateFirstForJob(
                Mockito.argThat(new IsCorrectNeutralQuery(query1)),
                Mockito.anyMap(),
                Mockito.eq("attendanceEvent_transformed")
             );
        ...
        query2.addCriteria(new NeutralCriteria("SchoolReference.EducationalOrgIdentity.StateOrganizationId._value", NeutralCriteria.OPERATOR_EQUAL, "schoolId2"));
        ...
        queryRh2.addCriteria(new NeutralCriteria("StudentReference.StudentIdentity.StudentUniqueStateId._value", NeutralCriteria.OPERATOR_EQUAL, "studentId1"));
        queryRh2.addCriteria(new NeutralCriteria("SchoolReference.EducationalOrgIdentity.StateOrganizationId._value", NeutralCriteria.OPERATOR_EQUAL, "schoolId1"));
    ...
    private List<NeutralRecord> buildSchoolRecords() {
        ...
        r.setAttributeField("StateOrganizationId", buildValue("schoolId2"));
    ...
    private List<Entity> buildSchoolEntities() {
        ...
        r.setEntityId("2012mf-ed8c0a46-fc4b-11e1-97f4-ec9a74fc9dff");
        r.setBody(b);
        b.put("StateOrganizationId", buildValue("schoolId2"));
        b.put("NameOfInstitution", buildValue("schoolId2"));
        Entity e = r;
        return Arrays.asList(e);
    }
    ...
    private Entity buildSchoolEntity(String schoolId) {
        ...
        r.setEntityId("2012mf-ed8c0a46-fc4b-11e1-97f4-ec9a74fc9dff");
        r.setBody(b);
        b.put("StateOrganizationId", buildValue(schoolId));
        b.put("NameOfInstitution", buildValue(schoolId));
        Entity e = r;
        return e;
    }
    ...
    private Map<Object, NeutralRecord> buildSchoolSessions(String schoolEntityId) {
        ...
        s1.setAttributeField("EducationOrganizationReference.EducationalOrgIdentity.StateOrganizationId._value", schoolEntityId);
        s1.setAttributeField("SchoolYear", buildValue("2006-2007"));
        s1.setAttributeField("BeginDate", buildValue("2006-08-06"));
        s1.setAttributeField("EndDate", buildValue("2007-06-30"));
        NeutralRecord s2 = new NeutralRecord();
        s2.setRecordType("session");
        s2.setRecordId("recordId2");
        s2.setAttributeField("SchoolYear", buildValue("2007-2008"));
        s2.setAttributeField("BeginDate", buildValue("2007-08-06"));
        s2.setAttributeField("EndDate", buildValue("2008-06-30"));
        NeutralRecord s3 = new NeutralRecord();
        s3.setRecordType("session");
        s3.setRecordId("recordId2");
        s3.setAttributeField("SchoolYear", buildValue("2008-2009"));
        s3.setAttributeField("BeginDate", buildValue("2008-08-06"));
        s3.setAttributeField("EndDate", buildValue("2009-06-30"));
    ...
    private Object buildStudentReference(String studentId) {
        ...
        studentIdentity.put("StudentUniqueStateId", buildValue(studentId));
    ...
    private List<NeutralRecord> buildStudentSchoolAssocRecords() {
        ...
        r2.setAttributeField("StudentId", buildValue("studentId2"));
        r2.setAttributeField("SchoolId", buildValue("schoolId2"));
    ...
    private List<NeutralRecord> buildSessionRecords() {
        ...
        r.setRecordId("recordId");
        r.setAttributeField("SchoolYear", buildValue("2012"));
        r.setAttributeField("BeginDate", buildValue("2012-09-01"));
        r.setAttributeField("EndDate", buildValue("2012-12-31"));
        return Arrays.asList(r);
    }

    private Map<String, Map<String, Object>> buildEdorgIdentity(String stateId){
        Map<String, Object> stateEdorgId = new HashMap<String, Object>();
        stateEdorgId.put("StateOrganizationId", buildValue(stateId));
    ...
    private List<NeutralRecord> buildAttendanceRecords() {
        ...
        r1.setRecordType("attendanceEvent");
        r1.setRecordId("recordId1");
        r1.setAttributeField("StudentReference", buildStudentReference("studentId1"));
        r1.setAttributeField("schoolId", buildValue("schoolId1"));
        r1.setAttributeField("EventDate", buildValue("2012-09-09"));
        r1.setAttributeField("AttendanceEventCategory", buildValue("attendanceEventCategory1"));
        r1.setAttributeField("AttendanceEventReason", buildValue("attendanceEventReason1"));
        ...
        NeutralRecord r2 = new NeutralRecord();
        r2.setRecordType("attendanceEvent");
        r2.setRecordId("recordId2");
        r2.setAttributeField("StudentReference", buildStudentReference("studentId2"));
        r2.setAttributeField("EventDate", buildValue("2012-09-09"));
        r2.setAttributeField("AttendanceEventCategory", buildValue("attendanceEventCategory2"));
        r2.setAttributeField("AttendanceEventReason", buildValue("attendanceEventReason2"));
    ...
    static Map<String, String> buildValue(String value){
