...
public class InterchangeMasterScheduleTest {
    ...
    public void testCourseOffering() throws Throwable {
        ...
        Resource expectedJson = new ClassPathResource("parser/InterchangeMasterSchedule/CourseOffering.expected.json");
    ...
    public void testSection() throws Throwable {
        ...
        Resource expectedJson = new ClassPathResource("parser/InterchangeMasterSchedule/Section.expected.json");
