 ...
 *
 */
public class InterchangeStudentAttendanceTest {

    public static final Logger LOG = LoggerFactory.getLogger(InterchangeStudentAttendanceTest.class);
    ...
    @Test
    public void testAttendanceEvent() throws Throwable {
