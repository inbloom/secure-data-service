...
public class DisciplineIncidentEntityTest {
    ...
    private void checkValidNeutralRecord(NeutralRecord neutralRecord) {
        ...
        assertNotNull("Expected non-null behavior choice", choice);
        assertEquals("Expected different short description of behavior", "Short Description 1",
        ...
        choice = behavior.get(1);
        assertNotNull("Expected non-null behavior choice", choice);
        assertEquals("Expected different short description of behavior", "Short Description 2",
                choice.get("ShortDescription"));
        ...
        assertEquals("Expected different secondaryBehavior category", "School Code of Conduct",
                secondaryBehavior.get("BehaviorCategory"));
        ...
        assertNotNull("Expected non-null secondaryBehavior", secondaryBehavior);
        assertEquals("Expected different secondaryBehavior category", "State Law Crime",
                secondaryBehavior.get("BehaviorCategory"));
        ...
        // school
        @SuppressWarnings("unchecked")
        Map<String, Map<String, Object>> schoolReference = (Map<String, Map<String, Object>>) attributes
                .get("SchoolReference");
        ...
        @SuppressWarnings("unchecked")
        List<Map<String, String>> educationOrgIdentificationCodes = (List<Map<String, String>>) educationalOrgIdentity
                .get("EducationOrgIdentificationCode");
        ...
        assertEquals("Expected different identification system", "Test Contractor",
                educationOrgIdentificationCode.get("IdentificationSystem"));
        ...
        assertNotNull("Expected non-null education org identification code", educationOrgIdentificationCode);
        assertEquals("Expected different identification system", "District",
                educationOrgIdentificationCode.get("IdentificationSystem"));
        ...
        assertEquals("Expected different staff unique state id", "Staff Unique State Id",
                staffIdentity.get("StaffUniqueStateId"));
        
        @SuppressWarnings("unchecked")
        List<Map<String, String>> staffIdentificationCodes = (List<Map<String, String>>) staffIdentity
                .get("StaffIdentificationCode");
        ...
        assertEquals("Expected different identification system", "Canadian SIN",
                staffIdentificationCode.get("IdentificationSystem"));
        assertEquals("Expected different AssigningOrganizationCode", "Assigning Organization Code 1",
                staffIdentificationCode.get("AssigningOrganizationCode"));
        ...
        assertNotNull("Expected non-null staff identification code", staffIdentificationCode);
        assertEquals("Expected different AssigningOrganizationCode", "Assigning Organization Code 2",
                staffIdentificationCode.get("AssigningOrganizationCode"));
        ...
        assertEquals("Expected different hispanic latino ethnicity", false,
                staffIdentity.get("HispanicLatinoEthnicity"));
        ...
        assertEquals("Expected different PrimaryTelephoneNumberIndicator", false,
                telephone.get("PrimaryTelephoneNumberIndicator"));
        ...
        assertEquals("Expected different PrimaryTelephoneNumberIndicator", true,
                telephone.get("PrimaryTelephoneNumberIndicator"));
