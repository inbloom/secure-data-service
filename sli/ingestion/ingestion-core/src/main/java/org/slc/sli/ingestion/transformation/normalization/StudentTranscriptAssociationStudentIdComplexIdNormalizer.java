...
public class StudentTranscriptAssociationStudentIdComplexIdNormalizer implements ComplexIdNormalizer {
     ...
     */
    public List<String> resolveInternalId(Entity entity, NeutralQuery neutralQuery, Repository<Entity> repo) throws IdResolutionException {
        ...
        neutralQuery.addCriteria(new NeutralCriteria("metaData.externalId", "=", externalStudentAcademicRecordId, false));
        ...
        if (studentAcademicRecord == null) {
            throw new IdResolutionException("Unable to resolve complex reference", "studentTranscriptAssociation.studentId", 
                    externalStudentAcademicRecordId);
        }
