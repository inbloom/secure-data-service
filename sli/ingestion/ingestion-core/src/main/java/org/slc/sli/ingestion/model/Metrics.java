...
public class Metrics {
    ...
    private long entityNotPresentCount;
    ...
    public Metrics(String resourceId, long recordCount, long errorCount, long entityNotPresentCount) {
        this.resourceId = resourceId;
        this.recordCount = recordCount;
        this.errorCount = errorCount;
        this.entityNotPresentCount = entityNotPresentCount;
    }
    ...
    public long getEntityNotPresentCount() {
        return entityNotPresentCount;
    }

    public void setEntityNotPresentCount(long entityNotPresentCount) {
        this.entityNotPresentCount = entityNotPresentCount;
    }
