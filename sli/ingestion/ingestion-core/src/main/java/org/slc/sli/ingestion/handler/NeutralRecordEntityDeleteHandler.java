...
public class NeutralRecordEntityDeleteHandler extends AbstractIngestionHandler<NeutralRecordEntity, Entity> implements
    ...
    @Override
    protected NeutralRecordEntity doHandling(NeutralRecordEntity entity, ErrorReport errorReport, FileProcessStatus fileProcessStatus) {
    ...
    /**
     * Delete entity from the data store.
     *
     * @param entity
     ...
     */
    private void delete(Entity entity) throws EntityValidationException {
     ...
     *            Error reporting
     */
    public boolean matchEntity(NeutralRecordEntity entity, ErrorReport errorReport) {
