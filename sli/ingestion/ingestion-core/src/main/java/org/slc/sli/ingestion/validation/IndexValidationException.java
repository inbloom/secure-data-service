...
public class IndexValidationException extends Exception {
     ...
     *            the detail message
     */
    public IndexValidationException(String message) {
        super(message);
    }
     ...
     *            the cause
     */
    public IndexValidationException(Throwable cause) {
        super(cause);
    }
     ...
     *            the cause
     */
    public IndexValidationException(String message, Throwable cause) {
        super(message, cause);
    }
