...
public class SmooksCallable implements Callable<Boolean> {
    ...
    void generateNeutralRecord(IngestionFileEntry ingestionFileEntry, ErrorReport errorReport,
        ...
        File neutralRecordOutFile = createTempFile(resolveLzDirecotry(ingestionFileEntry, landingZone));
    ...
    private String resolveLzDirecotry(IngestionFileEntry ingestionFileEntry, LandingZone landingZone) {
