...
public class SliSmooks extends Smooks
{
     ...
     * {@link #addConfigurations(String)} or {@link #addConfigurations(String,java.io.InputStream)}.
     */
    public SliSmooks(StandaloneApplicationContext context) {
     ...
     */
    public SliSmooks(String resourceURI) throws IOException, SAXException {
        this();
    ...
    public Smooks setExports(Exports exports) {
        return super.setExports(exports);
    }
    ...
    private void _filter(ExecutionContext executionContext, Source source, Result... results) {
        ...
        try {
            ...
            try {
                ...
                this.filter = new SliSmooksSAXFilter(executionContext);
                Filter messageFilter = filter;//deliveryConfig.newFilter(executionContext);
    ...
    private SliSmooksSAXFilter filter;

    public Locator getDocumentLocator() {
        return filter.getDocumentLocator();
    }
