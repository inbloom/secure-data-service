...
public enum EdfiEntity {
    ...
    GRADEBOOK_ENTRY("SLC-GradebookEntry", Arrays.asList(LEARNING_OBJECTIVE, LEARNING_STANDARD, SECTION, GRADING_PERIOD)),
    ...
    STUDENT_GRADEBOOK_ENTRY("SLC-StudentGradebookEntry", Arrays.asList(GRADEBOOK_ENTRY, STUDENT_SECTION_ASSOCIATION,
