...
<#if (DisciplineIncident.SchoolReference.EducationalOrgIdentity.StateOrganizationId[0])??>
    <StateOrganizationId>
        ${DisciplineIncident.SchoolReference.EducationalOrgIdentity.StateOrganizationId}
    </StateOrganizationId>
</#if>
...
<#if (DisciplineIncident.SchoolReference.EducationalOrgIdentity.EducationOrgIdentificationCode[0])??>
    ...
    >
        ...
        ${DisciplineIncident.SchoolReference.EducationalOrgIdentity.EducationOrgIdentificationCode}
