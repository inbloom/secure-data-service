...
<StudentUniqueStateId>${StudentReference.StudentUniqueStateId}</StudentUniqueStateId >
</#if>
...
<StudentIdentificationCode
    ...
    <IdentificationCode>${StudentReference.StudentIdentificationCode.IdentificationCode}</IdentificationCode>
    </#if>
</StudentIdentificationCode>
</#if>
...
<Name
    ...
    <PersonalTitlePrefix>${StudentReference.Name.PersonalTitlePrefix}</PersonalTitlePrefix>
    </#if>
    <#if (StudentReference.Name.FirstName[0])??>
    <FirstName>${StudentReference.Name.FirstName}</FirstName>
    </#if>
    <#if (StudentReference.Name.MiddleName[0])??>
    <MiddleName>${StudentReference.Name.MiddleName}</MiddleName>
    </#if>
    <#if (StudentReference.Name.LastName[0])??>
    <LastName>${StudentReference.Name.LastName}</LastName>
    </#if>
    <#if (StudentReference.Name.GenerationCodeSuffix[0])??>
    <GenerationCodeSuffix>${StudentReference.Name.GenerationCodeSuffix}</GenerationCodeSuffix>
    </#if>
...
<BirthDate>${StudentReference.BirthDate}</BirthDate>
</#if>
<#if (StudentReference.Sex[0])??>
<Sex>${StudentReference.Sex}</Sex>
</#if>
<#if (StudentReference.HispanicLatinoEthnicity[0])??>
<HispanicLatinoEthnicity>${StudentReference.HispanicLatinoEthnicity}</HispanicLatinoEthnicity>
</#if>
<#if (StudentReference.Race[0])??>
<Race>
    <#if (StudentReference.Race.RacialCategory[0])??>
    <RacialCategory>${StudentReference.Race.RacialCategory}</RacialCategory>
   </#if>
</Race>
</#if>
</StudentIdentity>
