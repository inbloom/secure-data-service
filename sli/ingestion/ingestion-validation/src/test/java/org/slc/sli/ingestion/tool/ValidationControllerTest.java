...
public class ValidationControllerTest {
    ...
    public void testValidatorInValid() throws IOException, NoSuchFieldException, IllegalAccessException {
        ...
        Mockito.when(ife.getFileType()).thenReturn(FileType.XML_STUDENT);

        BatchJob job = BatchJob.createDefault("testJob");
        job.addFile(ife);
        ...
        Mockito.verify(log, Mockito.atLeastOnce()).info("Processing of file: {} resulted in errors.", ife.getFileName());
    }
