...
public class ValidationError {
    ...
    public enum ErrorType {
        INVALID_DATE_FORMAT, REQUIRED_FIELD_MISSING, UNKNOWN_FIELD, ENUMERATION_MISMATCH, INVALID_DATATYPE, REFERENTIAL_INFO_MISSING, INVALID_VALUE, INVALID_CHOICE_VALUE, TOO_MANY_CHOICES, TOO_FEW_CHOICES, MISSING_CHOICE_TYPE, MISSING_CHOICE_VALUE, INVALID_CHOICE_TYPE, INVALID_VALUE_FOR_CHOICE, INVALID_TYPE_FOR_CHOICE, SELF_REFERENCING_DATA
    }
