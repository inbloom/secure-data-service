...
public enum Right implements GrantedAuthority {
    ANONYMOUS_ACCESS, WRITE_PUBLIC, READ_GENERAL, WRITE_GENERAL, READ_RESTRICTED, WRITE_RESTRICTED, AGGREGATE_READ, AGGREGATE_WRITE, STAFF_CONTEXT, TEACHER_CONTEXT,
    ADMIN_ACCESS, FULL_ACCESS, CRUD_REALM, CRUD_ROLE, SLC_APP_APPROVE, EDORG_APP_AUTHZ, APP_AUTHORIZE, EDORG_DELEGATE, DEV_APP_CRUD, 
    ...
    WRITE_STUDENT_OWNED, READ_STUDENT_RESTRICTED, WRITE_STUDENT_RESTRICTED, INGESTION_LOG_VIEW;
