...
public enum Right implements GrantedAuthority {
    ...
    SECURITY_EVENT_VIEW, PRODUCTION_LOGIN, ACCOUNT_APPROVAL, BULK_EXTRACT, READ_STUDENT_DATA, WRITE_STUDENT_DATA, READ_GENERIC, WRITE_GENERIC, READ_PROTECTED, WRITE_PROTECTED;
