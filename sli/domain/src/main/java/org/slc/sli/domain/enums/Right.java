...
public enum Right implements GrantedAuthority {
    ...
    SECURITY_EVENT_VIEW, PRODUCTION_LOGIN, ACCOUNT_APPROVAL, BULK_EXTRACT, READ_STUDENT_GENERAL, WRITE_STUDENT_GENERAL, READ_STUDENT_OWNED, WRITE_STUDENT_OWNED, READ_STUDENT_RESTRICTED, WRITE_STUDENT_RESTRICTED;
