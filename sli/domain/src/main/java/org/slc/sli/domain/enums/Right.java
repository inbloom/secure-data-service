...
public enum Right implements GrantedAuthority {
    ...
    ADMIN_ACCESS, ADMIN_APPS, FULL_ACCESS, CRUD_REALM, CRUD_ROLE, SLC_APP_APPROVE, EDORG_APP_AUTHZ, EDORG_DELEGATE, DEV_APP_CRUD,
    INGEST_DATA, CRUD_SLC_OPERATOR, CRUD_SANDBOX_SLC_OPERATOR, CRUD_SANDBOX_ADMIN, CRUD_SEA_ADMIN, CRUD_LEA_ADMIN, READ_PUBLIC, TENANT_PURGE;
