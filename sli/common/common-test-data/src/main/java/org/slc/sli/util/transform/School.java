...
public class School implements MongoDataEmitter 
{
	...
	public School(String name, String id, String street, String city, String state, String zip, String county, String phone, String gradesOffered, String categories)
	{
		this.name = name;
		this.id = id;
		this.street = street;
	...
	public String emitXml()
	{
		...
		for(int i = gradesOfferedStart; i <= gradesOfferedEnd; i++){
			...
			switch(i){
				case 0: answer.append("Kindergarten");	break;
				case 1: answer.append("First grade");	break;
				case 2: answer.append("Second grade");	break;
				case 3: answer.append("Third grade");	break;
				case 4: answer.append("Fourth grade");	break;
				case 5: answer.append("Fifth grade");	break;
				case 6: answer.append("Sixth grade");	break;
				case 7: answer.append("Seventh grade");	break;
				case 8: answer.append("Eighth grade");	break;
				case 9: answer.append("Ninth grade");	break;
				case 10: answer.append("Tenth grade");	break;
				case 11: answer.append("Eleventh grade");	break;
				case 12: answer.append("Twelfth grade");	break;
			}
			answer.append("</GradeLevel>\n");
		}
		answer.append("   </GradesOffered>\n");
		...
		if(educationalOrganization != null){
			...
			answer.append("         <StateOrganizationId>").append(educationalOrganization.getStateId()).append("</StateOrganizationId>\n");
			answer.append("      </EducationalOrgIdentity>\n");
			answer.append("   </LocalEducationAgencyReference>\n");
		}
		answer.append("</School>\n");
	...
	public String emitEdOrgAssociation()
	{
		...
		StringBuffer answer = new StringBuffer();
		answer.append("{\"_id\":{\"$binary\":\"").append(generatedEdOrgAssociationId).append("\",\"$type\":\"03\"},\"type\":\"educationOrganizationSchoolAssociation\",\"body\":").
			append("{\"schoolId\":\"").append(generatedUuid).append("\",\"educationOrganizationId\":\"").append(educationalOrganization.getId()).
			append("\"},\"metadata\":{}}\n");
	...
	private class SessionAssociation
	{
		...
		public String emit()
		{
			...
			StringBuffer answer = new StringBuffer();
			answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"schoolSessionAssociation\",\"body\":{\"sessionId\":\"").
				append(session.getUuid()).append("\",\"gradingPeriod\":{\"name\":\"").append(gradingPeriodName).append("\",\"beginDate\":\"").append(beginDate).
				append("\",\"endDate\":\"").append(endDate).append("\",\"totalInstructionalDays\":").append(instructionDays).append("},\"schoolId\":\"").
