...
public class AssessmentBody implements MongoDataEmitter, Cloneable
{
	...
	public AssessmentBody(String title, ArrayList<AssessmentCode> codes, String subject, String category, String grade, String standard, String version)
	{
	...
	{
		AssessmentBody clone = new AssessmentBody(assessmentTitle, assessmentIdentificationCodes, academicSubject, assessmentCategory, gradeLevelAssessed, 
	...
	public String emit()
	{
		...
		answer.append("\"body\":{\"assessmentTitle\":\"").append(assessmentTitle).append("\",\"assessmentIdentificationCode\":[");
		...
		answer.append("],\"academicSubject\":\"").append(academicSubject).append("\",\"assessmentCategory\":\"").append(assessmentCategory).
			append("\",\"gradeLevelAssessed\":\"").append(gradeLevelAssessed).append("\",\"contentStandard\":\"").append(contentStandard).append("\",");
		if(thePeriod != null){
