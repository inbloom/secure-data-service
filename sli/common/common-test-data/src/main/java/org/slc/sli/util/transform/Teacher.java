...
public class Teacher implements MongoDataEmitter
{
	...
	public Teacher(String staffUniqueStateId, String firstName, String lastSurname, String sex, String highestLevelOfEducationCompleted)
	{
		...
		this.credentials.add(new TeacherCredential("LICENSURE", "Mathematics", highestLevelOfEducationCompleted, "Professional", "1998-01-01"));
	...
	public String emitSectionAssociation()
	{
		...
		while(iter.hasNext()){
			...
			answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(tsaUuid)).append("\",\"$type\":\"03\"},\"type\":\"teacherSectionAssociation\",").
				append("\"body\":{\"sectionId\":\"").append(sectionId).append("\",\"classroomPosition\":\"Teacher of Record\",\"teacherId\":\"").
				append(generatedUuid).append("\"},\"metadata\":{},\"tenantId\":\"Zork\"}\n");
		}
	...
	public String emitXml()
	{
		...
		answer.append("   <HighestLevelOfEducationCompleted>").append(edLevel).append("</HighestLevelOfEducationCompleted>\n");
		answer.append("   <YearsOfPriorProfessionalExperience>").append(priorYears).append("</YearsOfPriorProfessionalExperience>\n");
		answer.append("</Teacher>\n");
		/*
	<Teacher>
	...
	public String emit()
	{
		...
		StringBuffer answer = new StringBuffer();
		answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"teacher\",\"stateId\":\"dc=slidev,dc=net\",").
		...
		answer.append("\"hispanicLatinoEthnicity\":false,\"highestLevelOfEducationCompleted\":\"").append(edLevel).append("\",\"yearsOfPriorProfessionalExperience\":").
			append(years).append(",\"yearsOfPriorTeachingExperience\":").append(priorYears).append(",");
		...
		answer.append("\"staffUniqueStateId\":\"").append(uniqueStateId).append("\",\"highlyQualifiedTeacher\":false},\"tenantId\":\"Zork\"}\n");
	...
	private class TeacherAddress implements MongoDataEmitter
	{
		...
		public TeacherAddress(String type, String street, String suite, String site, String city, String state, String postalCode, String county)
		{
			this.type = type;
			this.street = street;
			this.suite = suite;
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"addressType\":\"").append(type).append("\",\"streetNumberName\":\"").append(street).append("\",\"apartmentRoomSuiteNumber\":\"").
				append(suite).append("\",\"buildingSiteNumber\":\"").append(site).append("\",\"city\":\"").append(city).append("\",\"stateAbbreviation\":\"").
				append(state).append("\",\"postalCode\":\"").append(postalCode).append("\",\"nameOfCounty\":\"").append(county).append("\"}");
	...
	private class TeacherEmail implements MongoDataEmitter
	{
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"emailAddressType\":\"").append(type).append("\",\"emailAddress\":\"").append(email).append("\"}");
	...
	private class TeacherPhone implements MongoDataEmitter
	{
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"telephoneNumberType\":\"").append(type).append("\",\"telephoneNumber\":\"").append(number).
				append("\",\"primaryTelephoneNumberIndicator\":").append(isPrimary).append("}");
	...
	private class TeacherCredential implements MongoDataEmitter
	{
		...
		public TeacherCredential(String credentialType, String field, String level, String teachingCredentialType, String credentialIssuanceDate)
		{
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"credentialType\":\"").append(credentialType).append("\",\"field\":\"").append(field).append("\",\"level\":\"").append(level).
				append("\",\"teachingCredentialType\":\"").append(teachingCredentialType).append("\",\"credentialIssuanceDate\":\"").append(credentialIssuanceDate).append("\"}");
	...
	private class TeacherName implements MongoDataEmitter
	{
		...
		public TeacherName(String prefix, String first, String middle, String last, String generationCode, String maidenName)
		{
			this.prefix = prefix;
		...
		public String emit()
		{
			...
			answer.append("{\"personalTitlePrefix\":").append(prefix == null ? "null" : "\"" + prefix + "\"").
				append(",\"firstName\":\"").append(firstName).append("\",\"middleName\":\"").append(middleName == null ? "" : middleName).append("\",\"lastSurname\":\"").
				append(lastName).append("\",\"generationCodeSuffix\":").append(generationCode == null ? "null" : "\"" + generationCode + "\"").append(",\"maidenName\":\"").
				append(maidenName == null ? "" : maidenName).append("\"}");
	...
	private class TeacherOtherName extends TeacherName
	{
		...
		public TeacherOtherName(String prefix, String first, String middle, String last, String generationCode, String maidenName, String otherType)
		{
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"otherNameType\":\"").append(otherType).append("\",\"personalTitlePrefix\":").append(prefix == null ? "null" : "\"" + prefix + "\"").
				append(",\"firstName\":\"").append(firstName).append("\",\"middleName\":\"").append(middleName == null ? "" : middleName).append("\",\"lastSurname\":\"").
				append(lastName).append("\",\"generationCodeSuffix\":").append(generationCode == null ? "null" : "\"" + generationCode + "\"").append("\"}");
