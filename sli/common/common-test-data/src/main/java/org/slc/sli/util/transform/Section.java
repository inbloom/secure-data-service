...
public class Section implements MongoDataEmitter {
    ...
    public String emit() {
        ...
        answer.append("{\"_id\":{\"$binary\":\"")
                ...
                .append("\",\"$type\":\"03\"},\"type\":\"section\",")
                .append("\"body\":{\"educationalEnvironment\":\"Classroom\",\"populationServed\":\"Regular Students\",\"sequenceOfCourse\":")
                .append(sequenceOfCourse).append(",\"uniqueSectionCode\":\"").append(uniqueSectionCode)
                .append("\",\"sessionId\":\"").append(session.getUuid()).append("\",\"courseId\":\"")
                .append(course.getUuid()).append("\",\"schoolId\":\"").append(school.getUuid())
    ...
    public String emitAssessmentAssociation() {
        ...
        StringBuffer answer = new StringBuffer();
        answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(Base64.nextUuid("aaad")))
                .append("\",\"$type\":\"03\"},\"type\":\"sectionAssessmentAssociation\",")
                .append("\"body\":{\"sectionId\":\"").append(generatedUuid).append("\",\"assessmentId\":\"")
                .append(assessment.getUuid()).append("\"},\"metadata\":{}}\n");
        return answer.toString();
    }
    ...
    public String emitSchoolAssociation() {
        ...
        StringBuffer answer = new StringBuffer();
        answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(Base64.nextUuid("aada")))
                .append("\",\"$type\":\"03\"},\"type\":\"sectionSchoolAssociation\",")
                .append("\"body\":{\"sectionId\":\"").append(generatedUuid).append("\",\"schoolId\":\"")
                .append(school.getUuid()).append("\"},\"metadata\":{}}\n");
        return answer.toString();
    }
