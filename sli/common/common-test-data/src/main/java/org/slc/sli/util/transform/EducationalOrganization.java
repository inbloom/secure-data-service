...
public class EducationalOrganization implements MongoDataEmitter 
{
	...
	public EducationalOrganization(String edOrgName, String street, String suite, String city, String state, String postalCode, String stateOrgId)
	{
		this.name = edOrgName;
		this.street = street;
		this.suite = suite;
		...
		if(edOrgName.equals("Greater Smallville K-12 School District")){ // SkDUiGE8MB3FSzLMxdcTug==
			generatedUuid = "1d303c61-88d4-404a-ba13-d7c5cc324bc5";	// hack to deal with an id that was created manually, that we don't want to change
		}else{
	...
	public void updateFrom(EducationalOrganization newEdOrg)
	{
		...
		this.stateOrganizationId = (newEdOrg.stateOrganizationId != null) ? newEdOrg.stateOrganizationId : this.stateOrganizationId;
	...
	public String emit() 
	{
		...
		StringBuffer answer = new StringBuffer();
		answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"educationOrganization\",\"body\":{\"organizationCategories\":[\"").
			append(type).append("\"],\"address\":[{\"addressType\":\"Physical\",\"streetNumberName\":\"").append(street).append("\",\"apartmentRoomSuiteNumber\":\"").
			append(suite).append("\",\"buildingSiteNumber\":\"\",\"city\":\"").append(city).append("\",\"stateAbbreviation\":\"").append(state).
			append("\",\"postalCode\":\"").append(postalCode).append("\",\"nameOfCounty\":\"\"}],\"stateOrganizationId\":\"").append(stateOrganizationId).
			append("\",\"nameOfInstitution\":\"").append(name).append("\"},\"metadata\":{},\"tenantId\":\"Zork\"}\n");
	...
	public String emitParentEdOrgAssociation()
	{
		...
		StringBuffer answer = new StringBuffer();
		answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(parentAssociationUuid)).append("\",\"$type\":\"03\"},\"type\":\"educationOrganizationAssociation\",").
			append("\"body\":{\"educationOrganizationParentId\":\"").append(parentEdOrg.getId()).append("\",\"educationOrganizationChildId\":\"").
			append(this.getId()).append("\"},\"tenantId\":\"Zork\"}\n");
