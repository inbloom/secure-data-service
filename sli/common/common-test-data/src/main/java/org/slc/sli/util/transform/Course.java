...
public class Course implements MongoDataEmitter 
{
	...
	public Course(String courseDefinedBy, String adoptionDate, String description, String characteristics, boolean required, String code, String gpaAppl,
			String idSystem, int minCredit, int maxCredit, String subject, String level, String title, int parts, String orgCode, String careerPath)
	{
	...
	public String emit() 
	{
		...
		StringBuffer answer = new StringBuffer();
		answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"course\",\"body\":{\"courseDefinedBy\":\"").
			append(courseDef).append("\",\"dateCourseAdopted\":\"").append(adoptionDate).append("\",\"courseDescription\":\"").append(courseDesc).
			append("\",\"courseLevelCharacteristics\":\"").append(courseChar).append("\",\"highSchoolCourseRequirement\":").append(required).append(",\"courseCode.id\":\"").
			append(courseCode).append("\",\"courseGpaApplicability\":\"").append(gpaApplicability).append("\",\"gradesOffered\":[");
		...
		answer.append("],\"courseCode.identificationSystem\":\"").append(idSystem).append("\",\"maximumAvailableCredit\":").append(maxCredit).append(",\"subjectArea\":\"").
			append(subject).append("\",\"courseLevel\":\"").append(level).append("\",\"minimumAvailableCredit\":").append(minCredit).append(",\"courseTitle\":\"").
			append(courseTitle).append("\",\"numberOfParts\":").append(parts).append(",\"courseCode.assigningOrganizationCode\":\"").append(orgCode).
	...
	private class SessionAssociation
	{
		...
		public String emit()
		{
			...
			StringBuffer answer = new StringBuffer();
			answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"sessionCourseAssociation\",\"body\":{\"localCourseCode\":\"").
				append(localCourseCode).append("\",\"sessionId\":\"").append(session.getUuid()).append("\",\"localCourseTitle\":\"").append(localCourseTitle).
				append("\",\"courseId\":\"").append(Course.this.generatedUuid).append("\"},\"tenantId\":\"Zork\"}\n");
	...
	private class SectionAssociation
	{
		...
		public String emit()
		{
			...
			StringBuffer answer = new StringBuffer();
			answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"sectionCourseAssociation\",\"body\":{\"courseId\":\"").
				append(Course.this.generatedUuid).append("\",\"sectionId\":\"").append(section.getUuid()).append("\"},\"tenantId\":\"Zork\"}\n");
