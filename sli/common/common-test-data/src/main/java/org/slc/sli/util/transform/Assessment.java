...
public class Assessment implements MongoDataEmitter 
{
	...
	public String emit()
	{
		...
		answer.append("{\"_id\":{\"$binary\":\"").append(Base64.toBase64(generatedUuid)).append("\",\"$type\":\"03\"},\"type\":\"assessment\",").
			append(body.emit()).append("}\n");
	...
	public class Period
	{
		...
		{
			StringBuffer answer = new StringBuffer();
			answer.append("{\"codeValue\":\"").append(name).append("\",\"beginDate\":\"").append(start).append("\",\"endDate\":\"").append(end).append("\"}");			
			return answer.toString();
		}
	}
