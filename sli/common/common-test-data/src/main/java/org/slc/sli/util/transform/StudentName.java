...
public class StudentName implements MongoDataEmitter 
{
	...
	public String emit()
	{
		...
		answer.append("\"name\":{\"firstName\":\"").append(firstName).append("\",\"middleName\":\"").append(middleName == null ? "" : middleName).
			append("\",\"verification\":\"").append(nameVerification == null ? "" : nameVerification).
			append("\",\"lastSurname\":\"").append(lastSurname).append("\",\"generationCodeSuffix\":\"").append(suffix == null ? "" : suffix).append("\"}");
